<%-- 
    Document   : sub_configurar_emails
    Created on : 25/05/2016, 12:19:59
    Author     : Mateus
--%>
...
<head>
	...
	<title>GW Sistemas - Configurar E-mails</title>
...
<header role="banner" class="header-top">
	...
	<div class="start-secion-page-mobile">
		...
		<a href="configuracoes.jsp" class="voltar"><</a>
		<h1 class="mobile-title-page">Configurar E-mails</h1>
	...
	<div class="content-mobile">
		...
		<nav class="btn-menu-mobile">
			...
			<% if (user != null && user.getAcesso("cademails") > NivelAcessoUsuario.SEM_ACESSO.getNivel()) {%>
                            <li> <a class="openWindow" href="./EmailControlador?acao=listar" id="email_listar">E-mails 
                                    <% if (user != null && user.getAcesso("cademails") > NivelAcessoUsuario.LER_ALTERAR.getNivel()) {%>
                                    <span id="email_cadastro" class="more" data-href="./EmailControlador?acao=novoCadastro"></span>
                                    <%}%>
                                </a>
                            </li>
                            ...
                            <li style=" cursor: pointer;" title="Você não tem privilégios suficientes para executar essa ação." class="showTitle">
                                 <a style="background-color: silver;color: black;" class="openWindow" href="" id="" onclick="javascript: semPrivilegio('<%= permissoes.get("cademails")%>')">E-mails
                                </a>
                            </li>
                        <%}%>
                    </ul>
