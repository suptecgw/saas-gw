...
<head>
	...
	<title>GW Sistemas - Downloads</title>
...
<header role="banner" class="header-top">
	...
	<div class="start-secion-page-mobile">
		...
		<h1 class="mobile-title-page">Downloads</h1>
	...
	<div class="content-mobile">
		...
		<nav class="btn-menu-mobile">
			...
			<li><a class="openWindow" href="https://s3-sa-east-1.amazonaws.com/utilitariosgw/PrinterModule.zip" id="printModule_download">PrinterModule</a></li>
                        <li><a class="openWindow" href="http://www.teamviewer.com/pt/download/" id="teamViewer_download">TeamViewer</a></li>
                        <li><a class="openWindow" href="http://www.beanywhere.com/" id="beAnyWhere_download">BeAnyWhere</a></li>
                    </ul>
		</nav>
