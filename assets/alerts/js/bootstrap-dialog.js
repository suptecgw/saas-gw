...
(function($) {
    ...
    BootstrapDialog.TYPE_DEFAULT = 'type-primary';
...
//            }
        ...
        createButton: function(button) {
            ...
            // HotkeyTwo
            if (typeof button.hotkeyTwo !== undefined) {
                this.registeredButtonHotkeysTwo[button.hotkeyTwo] = $button;
            }
        ...
        handleModalEvents: function() {
            ...
            this.getModal().on('keyup', {dialog: this}, function(event) {
                ...
                if (typeof dialog.registeredButtonHotkeysTwo[event.which] !== 'undefined') {
                    var $button = $(dialog.registeredButtonHotkeysTwo[event.which]);
                    !$button.prop('disabled') && $button.focus().trigger('click');
                }
     ...
     * @returns the created dialog instance
     */
    BootstrapDialog.confirm = function(message, title, callback, labelCancel, labelOk) {
