<%-- 
    Document   : sub_cadastrais
    Created on : 25/05/2016, 11:08:36
    Author     : Mateus
--%>
...
<head>
	...
	<title>GW Sistemas - Cadastrais</title>
...
<header role="banner" class="header-top">
	...
	<div class="start-secion-page-mobile">
		...
		<h1 class="mobile-title-page">Cadastrais</h1>
	...
	<div class="content-mobile">
		...
		<nav class="btn-menu-mobile">
			...
			<li class="inside"> <a href="sub_rel_cad_financeiro.jsp">Financeiro </a>
			<li class="inside"> <a href="sub_rel_cad_operacional.jsp">Operacional </a>
			<!--USUARIO-->
                        <% if (user != null && user.getAcesso("cadusuario") >= NivelAcessoUsuario.LER.getNivel()) {%>
                        <li><a class="openWindow" href="./relusuario.jsp?acao=iniciar&modulo=webtrans" id="usuario_relatorio">Usuários</a></li>
                        ...
                        <li style=" cursor: pointer;" title="Você não tem privilégios suficientes para executar essa ação." class="showTitle">
                             <a style="background-color: silver;color: black;" class="openWindow" href="" id="" onclick="javascript: semPrivilegio('<%= permissoes.get("cadusuario")%>')">Usuários
                            </a>
                        </li>
                        <%}%>
                        <!--GRUPO DE USUARIOS-->
                        <% if (user != null && user.getAcesso("cadgrupousuario") >= NivelAcessoUsuario.LER.getNivel()) {%>
                        <li><a class="openWindow" href="./relgrupousuario.jsp?acao=iniciar&modulo=webtrans" id="grupoUsuario_relatorio">Grupo de usuários</a></li>
                            <%} else if (user != null && !user.isIsOcultarMenuSemPermissao()) {%>
                        <li style=" cursor: pointer;" title="Você não tem privilégios suficientes para executar essa ação." class="showTitle">
                             <a style="background-color: silver;color: black;" class="openWindow" href="" id="" onclick="javascript: semPrivilegio('<%= permissoes.get("cadgrupousuario")%>')">Grupo de usuários
                            </a>
                        </li>
                        <%}%>
                        <!--FILIAIS-->
                        <% if (user != null && user.getAcesso("cadfilial") >= NivelAcessoUsuario.LER.getNivel()) {%>
                        <li><a class="openWindow" href="./relfilial.jsp?acao=iniciar&modulo=webtrans" id="filial_relatorio">Filiais</a></li>
                            <%} else if (user != null && !user.isIsOcultarMenuSemPermissao()) {%>
                        <li style=" cursor: pointer;" title="Você não tem privilégios suficientes para executar essa ação." class="showTitle">
                             <a style="background-color: silver;color: black;" class="openWindow" href="" id="" onclick="javascript: semPrivilegio('<%= permissoes.get("cadfilial")%>')">Filiais
                            </a>
                        </li>
                        <%}%>
                    </ul>
