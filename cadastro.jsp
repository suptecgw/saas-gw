...
<header role="banner" class="header-top">
	...
	<div class="start-secion-page-mobile">
		...
		<h1 class="mobile-title-page">Cadastros</h1>
	...
	<div class="content-mobile">
		...
		<nav class="btn-menu-mobile">
			<ul class="btn-menu-mobile-list-top">
                                <li><a href="sub_cad_financeiro.jsp">Financeiro </a></li>
                                <li><a href="sub_operacional.jsp">Operacional </a></li>
                                
                                <% if(user != null && user.getAcesso("cadbairro") > 0){ %>
                                    <li><a href="BairroControlador?acao=listar" class="openWindow" id="bairro_listar">Bairros </a></li>
                                <% }else if(user != null && !user.isIsOcultarMenuSemPermissao()) { %>
                                    <li onclick="semPrivilegio('<%= permissoes.get("cadbairro")%>')" ><a style="background-color: silver; color: black">Bairros </a></li>
                                <% } %>
                                 <!-- CIDADE-->   
                                <% if(user != null && user.getAcesso("cadcidade") > NivelAcessoUsuario.SEM_ACESSO.getNivel()){ %>
				<li><a href="./consultacidade?acao=iniciar" class="openWindow" id="cidade_listar">Cidades </a></li>
                                <% }else if(user != null && !user.isIsOcultarMenuSemPermissao()) { %>
                                    <li onclick="semPrivilegio('<%= permissoes.get("cadcidade")%>')" ><a style="background-color: silver; color: black">Cidades </a></li>
                                <% } %>
                                 <!--USUARIO-->   
                                 <% if(user != null && user.getAcesso("cadusuario") > NivelAcessoUsuario.SEM_ACESSO.getNivel()){ %>
				<li><a href="./UsuarioControlador?acao=listar" class="openWindow" id="usuario_listar">Usuários </a></li>
                                <% }else if(user != null && !user.isIsOcultarMenuSemPermissao()) { %>
                                    <li onclick="semPrivilegio('<%= permissoes.get("cadusuario")%>')" ><a style="background-color: silver; color: black">Usuários </a></li>
                                <% } %>
                                <!--GRUPO_DE_USUARIOS-->
                                <% if(user != null && user.getAcesso("cadgrupousuario") > NivelAcessoUsuario.SEM_ACESSO.getNivel()){ %>
				<li><a href="./consulta_grupousuario.jsp?acao=iniciar" class="openWindow" id="grupoUsuario_listar">Grupos de usuários </a></li>
                                <% }else if(user != null && !user.isIsOcultarMenuSemPermissao()) { %>
                                    <li onclick="semPrivilegio('<%= permissoes.get("cadgrupousuario")%>')" ><a style="background-color: silver; color: black">Grupos de usuários </a></li>
                                <% } %>
                                <!--AGÊNCIAS_DE_APOIO-->
                                <%if (user != null && user.getAcesso("cadagencia") > NivelAcessoUsuario.SEM_ACESSO.getNivel()) {%>
				<li><a href="./consulta_agencia.jsp?acao=iniciar" class="openWindow" id="agenciaApoio_listar">Agênciais de apoio </a></li>
                                <% }else if(user != null && !user.isIsOcultarMenuSemPermissao()) { %>
                                    <li onclick="semPrivilegio('<%= permissoes.get("cadagencia")%>')" ><a style="background-color: silver; color: black">Agênciais de apoio </a></li>
                                <% } %>
                                <!--FILIAL-->
                                <% if(user != null && user.getAcesso("cadfilial") > NivelAcessoUsuario.SEM_ACESSO.getNivel()){ %>
				<li><a href="./consultafilial?acao=iniciar" class="openWindow" id="filial_listar">Filiais </a></li>
                                <% }else if(user != null && !user.isIsOcultarMenuSemPermissao()) { %>
                                    <li onclick="semPrivilegio('<%= permissoes.get("cadfilial")%>')" ><a style="background-color: silver; color: black">Filiais </a></li>
                                <% } %>
			</ul>
		</nav>
