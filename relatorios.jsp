<%-- 
    Document   : relatorios
    Created on : 25/05/2016, 11:03:12
    Author     : Mateus
--%>
...
<head>
	...
	<title>GW Sistemas - Relatórios</title>
...
<header role="banner" class="header-top">
	...
	<div class="start-secion-page-mobile">
		...
		<h1 class="mobile-title-page">Relatórios</h1>
	...
	<div class="content-mobile">
		...
		<nav class="btn-menu-mobile">
			<ul class="btn-menu-mobile-list-top">
                            <li class="inside"> <a href="sub_cadastrais.jsp">Cadastrais </a>
                            </li>
                            <li class="inside"><a href="sub_rel_financeiro.jsp">Financeiro </a><!-- Inicio da parte de financeiro -->
                            </li>
                            <!-- Fim da parte de financeiro -->

                            <!-- Inicio da parte de operacional -->
                            <li class="inside"><a href="sub_rel_operacional.jsp">Operacional</a>
                            </li>
                            <!-- Fim da parte de operacional -->
                            <li class="inside"><a href="sub_rel_gerencial.jsp">Gerencial</a>
                            </li>
                            <li class="inside"><a href="sub_rel_comercial.jsp">Comercial</a>
                            </li>
                            <li class="inside"><a href="sub_rel_impostos.jsp">Impostos</a>
                            </li>
                            <li> <a class="openWindow"  href="./reletiqueta.jsp" id="etiqueta_relatorio">Etiquetas</a></li>
