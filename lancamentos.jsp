<%-- 
    ...
    Created on : 25/05/2016, 10:19:49
    Author     : Mateus
--%>
...
<head>
	...
	<title>GW Sistemas - Lançamentos</title>
...
<header role="banner" class="header-top">
	...
	<div class="start-secion-page-mobile">
		...
		<h1 class="mobile-title-page">Lançamentos</h1>
	...
	<div class="content-mobile">
		...
		<nav class="btn-menu-mobile">
			<ul class="btn-menu-mobile-list-top">
                            ...
                            <li class="inside"><a href="sub_lan_financeiro.jsp">Financeiro </a><!-- itens da parte financeiro -->
                                <ul class="sub-menu">
                                    <li><a class="openWindow" href="./consultadespesa?acao=iniciar" id="despesa_listar">Despesas <span id="despesa_cadastro" class="more" data-href="./caddespesa?acao=iniciar"></span></a></li>
                                    <li><a class="openWindow" href="./consulta_pagamento_comissao.jsp?acao=iniciar" id="comissao_listar">Comissão <span id="comissao_cadastro" class="more" data-href="./cadpagamento_comissao.jsp?acao=iniciar"></span></a></li>
                                    <li><a class="openWindow" href="./consultafatura?acao=iniciar" id="faturaBoleto_listar">Faturas / Boletos <span id="faturaBoleto_cadastro" class="more" data-href="./fatura_cliente?acao=iniciar"></span></a></li>
                                    <li><a class="openWindow" href="./jspconsulta_factoring.jsp?acao=iniciar" id="descontaDuplicata_listar">Descontar duplicatas <span id="descontaDuplicata_cadastro" class="more" data-href="./cadmovimentacao_factoring.jsp?acao=iniciar"></span></a></li>
                                    <li><a class="openWindow" href="./ContratoFreteControlador?acao=visualizarFechamentoAgregado" id="fechamentoAgregado_listar">Fechamento agregado </a></li>
                                </ul>
                            </li><!-- fim itens da parte financeiro -->

                            <li><a class="openWindow" href="./consulta_orcamento.jsp?acao=iniciar" id="orcamento_listar" >Orçamento <span id="orcamento_cadastro" class="more" data-href="./cadorcamento.jsp?acao=iniciar"></span></a></li>
                            <li><a class="openWindow" href="./NotaFiscalControlador?acao=listar" id="notaFiscal_listar">Notas fiscais (DANFE) <span id="notaFiscal_cadastro" class="more" data-href="./NotaFiscalControlador?acao=novoCadastro"></span></a></li>
                            <li><a class="openWindow" href="./consultacoleta?acao=iniciar" id="coleta_listar">Coletas/O.S <span id="coleta_cadastro" class="more" data-href="./cadcoleta?acao=iniciar"></span></a></li>
                            <li><a class="openWindow" href="./consultaconhecimento?acao=iniciar" id="conhecimento_listar">Conhecimentos <span id="conhecimento_cadastro" class="more" data-href="./frameset_conhecimento?acao=iniciar"></span></a></li>
                            <li><a class="openWindow" href="./consultamanifesto?acao=iniciar" id="manifesto_listar">Manifestos <span id="manifesto_cadastro" class="more" data-href="./cadmanifesto?acao=iniciar"></span></a></li>
                            <li><a class="openWindow" href="./consulta_viagem.jsp?acao=iniciar" id="advViagem_listar">ADV (Viagem) <span id="advViagem_cadastro" class="more" data-href="./cadviagem.jsp?acao=iniciar"></span></a></li>
                            <li><a class="openWindow" href="./ContratoFreteControlador?acao=listar" id="contratoFrete_listar">Contratos de fretes <span id="contratoFrete_cadastro" class="more" data-href="./ContratoFreteControlador?acao=novoCadastro"></span></a></li>
                            <li><a class="openWindow" href="./consultaromaneio?acao=iniciar" id="romaneio_listar">Romaneios <span id="romaneio_cadastro" class="more" data-href="./cadromaneio?acao=iniciar"></span></a></li>

                            <% if (user != null && user.getAcesso("cadvenda") > NivelAcessoUsuario.SEM_ACESSO.getNivel()) {%>
                            <li><a class="openWindow" href="ConsultaControlador?codTela=75" id="notaServico_listar">
                                    Notas de serviços 
                                    <% if (user != null && user.getAcesso("cadvenda") > NivelAcessoUsuario.LER_ALTERAR.getNivel()) { %>
                                    <span id="notaServico_cadastro" class="more" data-href="./cadvenda.jsp?acao=iniciar"></span>
                                    <% } %>
                                </a></li>
                                <%} else if (user != null && !user.isIsOcultarMenuSemPermissao()) {%>
                            <li style=" cursor: pointer;" title="Você não tem privilégios suficientes para executar essa ação." class="showTitle"> <a style="background-color: silver;color: black;" class="openWindow" href="" id="" onclick="javascript: semPrivilegio('<%= permissoes.get("cadvenda")%>')" >
                                    Notas de serviços 
                                </a></li>
                                <%}%>

                            <% if (user != null && user.getAcesso("lancamentomovimentacaopallets") > NivelAcessoUsuario.SEM_ACESSO.getNivel()) {%>
                            <li><a class="openWindow" href="./MovimentacaoPalletsControlador?acao=listar" id="movimentacaoPallet_listar">Movimentação de Pallets 
                                    <% if (user != null && user.getAcesso("lancamentomovimentacaopallets") > NivelAcessoUsuario.LER_ALTERAR.getNivel()) { %>
                                    <span id="movimentacaoPallet_cadastro" class="more" data-href="./MovimentacaoPalletsControlador?acao=novocadastro"></span>
                                    <% } %>
                                </a></li>
                                <%} else if (user != null && !user.isIsOcultarMenuSemPermissao()) {%>
                            <li style=" cursor: pointer;" title="Você não tem privilégios suficientes para executar essa ação." class="showTitle"> <a style="background-color: silver;color: black;" class="openWindow" href="" id="" onclick="javascript: semPrivilegio('<%= permissoes.get("lancamentomovimentacaopallets")%>')" >
