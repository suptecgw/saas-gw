...
(function($) {
    ...
    var str_opt_dom = "";
    for (var i = 1; i < 32; i++) {
        if (i == 1 || i == 21 || i == 31) { var suffix = "º"; }
        else if (i == 2 || i == 22) { var suffix = "º"; }
        else if (i == 3 || i == 23) { var suffix = "º"; }
        else { var suffix = "º"; }
    ...
    // options for months
    var str_opt_month = "";
    var months = ["Janeiro", "Fevereiro", "Março", "Abril",
    ...
    var str_opt_dow = "";
    var days = ["Domingo", "Segunda", "Terça", "Quarta", "Quinta",
                "Sexta", "Sabado"];
    ...
    // options for period
    var str_opt_period = "";
    var periods = ["minuto", "hora", "dia", "semana", "mês", "ano"];
    ...
    function getCronType(cron_str, opts) {
        ...
        //            mm, hh, DD, MM, DOW
        var minval = [ 0,  0,  1,  1,  1]; // semana do CRON no quartz (JAVA) deve ser 1 - 7
    ...
    var methods = {
        init : function(opts) {
            ...
            block["period"] = $("<span class='cron-period'>"
                    + "A cada <select class='inputtexto' name='cron-period'>" + custom_periods
            ...
            block["dom"] = $("<span class='cron-block cron-block-dom'>"
                    + " no(a) <select class='inputtexto' name='cron-dom'>" + str_opt_dom
                    + "</select> dia </span>")
                .appendTo(this)
                .data("root", this);
            ...
            block["month"] = $("<span class='cron-block cron-block-month'>"
                    + " de <select class='inputtexto' name='cron-month'>" + str_opt_month
                    + "</select> </span>")
                .appendTo(this)
                .data("root", this);
            ...
            block["mins"] = $("<span class='cron-block cron-block-mins'>"
                    + " no <select class='inputtexto' name='cron-mins'>" + str_opt_mih
                    + "</select> minuto de cada hora </span>")
                .appendTo(this)
                .data("root", this);
            ...
            block["dow"] = $("<span class='cron-block cron-block-dow'>"
                    + " do(a) <select class='inputtexto' name='cron-dow'>" + str_opt_dow
                    + "</select> </span>")
                .appendTo(this)
                .data("root", this);
            ...
            block["time"] = $("<span class='cron-block cron-block-time'>"
                    + " às <select name='cron-time-hour' class='cron-time-hour inputtexto'>" + str_opt_hid
                    + "</select>:<select name='cron-time-min' class='cron-time-min inputtexto'>" + str_opt_mih
                    + " </span>")
                .appendTo(this)
                .data("root", this);
