<%-- 
    Document   : sub_rel_financeiro
    Created on : 25/05/2016, 12:03:28
    Author     : Mateus
--%>
...
<head>
	...
	<title>GW Sistemas - Relatórios Financeiro</title>
...
<header role="banner" class="header-top">
	...
	<div class="start-secion-page-mobile">
		...
		<a href="relatorios.jsp" class="voltar"><</a>
		<h1 class="mobile-title-page">Relatórios Financeiro</h1>
	...
	<div class="content-mobile">
		...
		<nav class="btn-menu-mobile">
			...
			<!--CONTAS A RECEBER-->
                        <% if (user != null && user.getAcesso("relcontasreceber") > NivelAcessoUsuario.SEM_ACESSO.getNivel()) {%>
                        <li><a class="openWindow" href="./relcontasreceber?acao=iniciar&modulo=webtrans" id="contaReceber_relatorio">Contas a receber</a></li>        
                        ...
                        <li style=" cursor: pointer;" title="Você não tem privilégios suficientes para executar essa ação." class="showTitle">
                             <a style="background-color: silver;color: black;" class="openWindow" href="" id="" onclick="javascript: semPrivilegio('<%= permissoes.get("relcontasreceber")%>')">Contas a receber
                            </a>
                        </li>
                        <%}%>
                        <!--CONTAS RECEBIDAS-->
                        <% if (user != null && user.getAcesso("relcontasreceber") > NivelAcessoUsuario.SEM_ACESSO.getNivel()) {%>
                        <li><a class="openWindow" href="./relcontasrecebidas?acao=iniciar&modulo=webtrans" id="contaRecebida_relatorio">Contas recebidas</a></li>        
                            <%} else if (user != null && !user.isIsOcultarMenuSemPermissao()) {%>
                        <li style=" cursor: pointer;" title="Você não tem privilégios suficientes para executar essa ação." class="showTitle">
                             <a style="background-color: silver;color: black;" class="openWindow" href="" id="" onclick="javascript: semPrivilegio('<%= permissoes.get("relcontasreceber")%>')">Contas recebidas
                            </a>
                        </li>
                        <%}%>
                        <!--FATUAS DE CLIENTES-->
                        <% if (user != null && user.getAcesso("lanfatura") > NivelAcessoUsuario.SEM_ACESSO.getNivel()) {%>
                        <li><a class="openWindow" href="./relfaturas.jsp?acao=iniciar&modulo=webtrans" id="faturaCliente_relatorio">Faturas de clientes</a></li>        
                            <%} else if (user != null && !user.isIsOcultarMenuSemPermissao()) {%>
                        <li style=" cursor: pointer;" title="Você não tem privilégios suficientes para executar essa ação." class="showTitle">
                             <a style="background-color: silver;color: black;" class="openWindow" href="" id="" onclick="javascript: semPrivilegio('<%= permissoes.get("lanfatura")%>')">Faturas de clientes
                            </a>
                        </li>
                        <%}%>
                        <!--CONTAS A PAGAR-->
                        <% if (user != null && user.getAcesso("relcontaspagar") > NivelAcessoUsuario.SEM_ACESSO.getNivel()) {%>
                        <li><a class="openWindow" href="./relcontaspagar?acao=iniciar&modulo=webtrans" id="contaPagar_relatorio">Contas a pagar</a></li>
                            <%} else if (user != null && !user.isIsOcultarMenuSemPermissao()) {%>
                        <li style=" cursor: pointer;" title="Você não tem privilégios suficientes para executar essa ação." class="showTitle">
                             <a style="background-color: silver;color: black;" class="openWindow" href="" id="" onclick="javascript: semPrivilegio('<%= permissoes.get("relcontaspagar")%>')">Contas a pagar
                            </a>
                        </li>
                        <%}%>
                        <!--CONTAS PAGAS-->
                        <% if (user != null && user.getAcesso("relcontaspagar") > NivelAcessoUsuario.SEM_ACESSO.getNivel()) {%>
                        <li><a class="openWindow" href="./relcontaspagas?acao=iniciar&modulo=webtrans" id="contaPaga_relatorio">Contas pagas</a></li>        
                            <%} else if (user != null && !user.isIsOcultarMenuSemPermissao()) {%>
                        <li style=" cursor: pointer;" title="Você não tem privilégios suficientes para executar essa ação." class="showTitle">
                             <a style="background-color: silver;color: black;" class="openWindow" href="" id="" onclick="javascript: semPrivilegio('<%= permissoes.get("relcontaspagar")%>')">Contas pagas
                            </a>
                        </li>
                        <%}%>
                        <!--DESPESAS-->
                        <% if (user != null && user.getAcesso("relcontaspagar") > NivelAcessoUsuario.SEM_ACESSO.getNivel()) {%>
                        <li><a class="openWindow" href="./reldespesa?acao=iniciar&modulo=webtrans" id="despesa_relatorio">Despesas</a></li>        
                            <%} else if (user != null && !user.isIsOcultarMenuSemPermissao()) {%>
                        <li style=" cursor: pointer;" title="Você não tem privilégios suficientes para executar essa ação." class="showTitle">
                             <a style="background-color: silver;color: black;" class="openWindow" href="" id="" onclick="javascript: semPrivilegio('<%= permissoes.get("relcontaspagar")%>')">Despesas
                            </a>
                        </li>
                        <%}%>
                        <!--MOVIMENTAÇÃO BANCÁRIA-->
                        <% if (user != null && user.getAcesso("relmovbanco") > NivelAcessoUsuario.SEM_ACESSO.getNivel()) {%>
                        <li><a class="openWindow" href="./relmovbanco?acao=iniciar&modulo=webtrans" id="movimentacaoBancaria_relatorio">Movimentação bancária</a></li>        
                            <%} else if (user != null && !user.isIsOcultarMenuSemPermissao()) {%>
                        <li style=" cursor: pointer;" title="Você não tem privilégios suficientes para executar essa ação." class="showTitle">
                             <a style="background-color: silver;color: black;" class="openWindow" href="" id="" onclick="javascript: semPrivilegio('<%= permissoes.get("relmovbanco")%>')">Movimentação bancária
                            </a>
                        </li>
                        <%}%>
                        <!--CHEQUE DE CLIENTES-->
                        <% if (user != null && user.getAcesso("chequecliente") > NivelAcessoUsuario.SEM_ACESSO.getNivel()) {%>
                        <li><a class="openWindow" href="./relcheques?acao=iniciar&modulo=webtrans" id="chequeCliente_relatorio">Cheque de clientes</a></li>        
                            <%} else if (user != null && !user.isIsOcultarMenuSemPermissao()) {%>
                        <li style=" cursor: pointer;" title="Você não tem privilégios suficientes para executar essa ação." class="showTitle">
                             <a style="background-color: silver;color: black;" class="openWindow" href="" id="" onclick="javascript: semPrivilegio('<%= permissoes.get("chequecliente")%>')">Cheque de clientes
                            </a>
                        </li>
                        <%}%>
                        <!--COMISSAO-->
                        <% if (user != null && user.getAcesso("relvendedor") > NivelAcessoUsuario.SEM_ACESSO.getNivel()) {%>
                        <li><a class="openWindow" href="./relvendedor?acao=iniciar&modulo=webtrans" id="comissao_relatorio">Comissões</a></li>        
                            <%} else if (user != null && !user.isIsOcultarMenuSemPermissao()) {%>
                        <li style=" cursor: pointer;" title="Você não tem privilégios suficientes para executar essa ação." class="showTitle">
                             <a style="background-color: silver;color: black;" class="openWindow" href="" id="" onclick="javascript: semPrivilegio('<%= permissoes.get("relvendedor")%>')">Comissões
                            </a>
                        </li>
                        <%}%>
                        <!--FECHAMENTO AGREGADO-->
                        <% if (user != null && user.getAcesso("fecamentocontratofreteagregado") > NivelAcessoUsuario.SEM_ACESSO.getNivel()) {%>
                        <li><a class="openWindow" href="./ContratoFreteControlador?acao=iniciarImprimirFechamentoAgregado&modulo=webtrans" id="fechamentoAgregado_relatorio">Fechamento agregado</a></li>  
                            <%} else if (user != null && !user.isIsOcultarMenuSemPermissao()) {%>
                        <li style=" cursor: pointer;" title="Você não tem privilégios suficientes para executar essa ação." class="showTitle">
                             <a style="background-color: silver;color: black;" class="openWindow" href="" id="" onclick="javascript: semPrivilegio('<%= permissoes.get("fecamentocontratofreteagregado")%>')">Fechamento agregado
                            </a>
                        </li>
                        <%}%>
                        <!--DESCONTAR DUPLICATAS-->
                        <% if (user != null && user.getAcesso("lancamentofactoring") > NivelAcessoUsuario.SEM_ACESSO.getNivel()) {%>
                        <li><a class="openWindow" href="./reldescontaduplicata.jsp?acao=iniciar&modulo=webtrans" id="fechamentoAgregado_relatorio">Relatorio Descontar duplicata</a></li>  
                            <%} else if (user != null && !user.isIsOcultarMenuSemPermissao()) {%>
                        <li style=" cursor: pointer;" title="Você não tem privilégios suficientes para executar essa ação." class="showTitle">
                             <a style="background-color: silver;color: black;" class="openWindow" href="" id="" onclick="javascript: semPrivilegio('<%= permissoes.get("lancamentofactoring")%>')">Relatorio Descontar duplicata
                            </a>
                        </li>
                        <%}%>
                    </ul>
