<%-- 
    Document   : lan_financeiro
    Created on : 25/05/2016, 10:26:15
    Author     : Mateus
--%>
...
<head>
	...
	<title>GW Sistemas - Lançamentos Financeiro</title>
...
<header role="banner" class="header-top">
	...
	<div class="start-secion-page-mobile">
		...
		<a href="lancamentos.jsp" class="voltar"><</a>
		<h1 class="mobile-title-page">Lançamentos Financeiro</h1>
	...
	<div class="content-mobile">
		...
		<nav class="btn-menu-mobile">
			 ...
			 <!--DESPESAS-->
                        <%if (user != null && user.getAcesso("caddespesa") > NivelAcessoUsuario.SEM_ACESSO.getNivel()) {%>
                        <li><a class="openWindow" href="./consultadespesa?acao=iniciar" id="despesa_listar">Despesas 
                                <%if (user != null && user.getAcesso("caddespesa") > NivelAcessoUsuario.LER_ALTERAR.getNivel()) {%>
                                <span id="despesa_cadastro" class="more" data-href="./caddespesa?acao=iniciar"></span>
                                <%}%>
                            </a>
                        </li>
                        ...
                        <li style=" cursor: pointer;" title="Você não tem privilégios suficientes para executar essa ação." class="showTitle">
                             <a style="background-color: silver;color: black;" class="openWindow" href="" id="" onclick="javascript: semPrivilegio('<%= permissoes.get("caddespesa")%>')" >
                                Despesas
                            </a>
                        </li> 
                        <%}%>
                        ...
                        <!--COMISSÃO-->
                        <%if (user != null && user.getAcesso("cadpgtocomissao") > NivelAcessoUsuario.SEM_ACESSO.getNivel()) {%>
                        <li>
                            <a class="openWindow" href="./consulta_pagamento_comissao.jsp?acao=iniciar" id="comissao_listar">Comissão 
                                <%if (user != null && user.getAcesso("cadpgtocomissao") > NivelAcessoUsuario.LER_ALTERAR.getNivel()) {%>
                                <span id="comissao_cadastro" class="more" data-href="./cadpagamento_comissao.jsp?acao=iniciar"></span>
                                <%}%>
                            </a>
                        </li>
                        <%} else if (user != null && !user.isIsOcultarMenuSemPermissao()) {%>
                        <li style=" cursor: pointer;" title="Você não tem privilégios suficientes para executar essa ação." class="showTitle">
                             <a style="background-color: silver;color: black;" class="openWindow" href="" id="" onclick="javascript: semPrivilegio('<%= permissoes.get("cadpgtocomissao")%>')" >
                                Comissão
                            </a>
                        </li> 
                        <%}%>
                        ...
                        <li>
                            <a class="openWindow" href="./consultafatura?acao=iniciar" id="faturaBoleto_listar">Faturas / Boletos 
                                <%if (user != null && user.getAcesso("lanfatura") > NivelAcessoUsuario.LER_ALTERAR.getNivel()) {%>
                                <span id="faturaBoleto_cadastro" class="more" data-href="./fatura_cliente?acao=iniciar"></span>
                                <%}%>
                            </a>
                        </li>
                        <%} else if (user != null && !user.isIsOcultarMenuSemPermissao()) {%>
                        <li style=" cursor: pointer;" title="Você não tem privilégios suficientes para executar essa ação." class="showTitle">
                             <a style="background-color: silver;color: black;" class="openWindow" href="" id="" onclick="javascript: semPrivilegio('<%= permissoes.get("lanfatura")%>')" >
                                Faturas / Boletos 
                            </a>
                        </li> 
                        <%}%>
                        ...
                        <li><a class="openWindow" href="./jspconsulta_factoring.jsp?acao=iniciar" id="descontaDuplicata_listar">Descontar duplicatas 
                                <%if (user != null && user.getAcesso("lancamentofactoring") > NivelAcessoUsuario.LER_ALTERAR.getNivel()) {%>
                                <span id="descontaDuplicata_cadastro" class="more" data-href="./cadmovimentacao_factoring.jsp?acao=iniciar"></span>
                                <%}%>
                            </a>
                        </li>
                        <%} else if (user != null && !user.isIsOcultarMenuSemPermissao()) {%>
                        <li style=" cursor: pointer;" title="Você não tem privilégios suficientes para executar essa ação." class="showTitle">
                             <a style="background-color: silver;color: black;" class="openWindow" href="" id="" onclick="javascript: semPrivilegio('<%= permissoes.get("lancamentofactoring")%>')" >
                                Descontar duplicatas 
                            </a>
                        </li> 
                        <%}%>
                        ...
                        <%if (user != null && user.getAcesso("lancamentofactoring") > NivelAcessoUsuario.SEM_ACESSO.getNivel()) {%>
                        <li>
                            <a class="openWindow" href="./ContratoFreteControlador?acao=visualizarFechamentoAgregado" id="fechamentoAgregado_listar">Fechamento agregado </a>
                        </li>
                        <%} else if (user != null && !user.isIsOcultarMenuSemPermissao()) {%>
                        <li style=" cursor: pointer;" title="Você não tem privilégios suficientes para executar essa ação." class="showTitle">
                             <a style="background-color: silver;color: black;" class="openWindow" href="" id="" onclick="javascript: semPrivilegio('<%= permissoes.get("fecamentocontratofreteagregado")%>')" >
                                Fechamento agregado 
                            </a>
                        </li> 
                        <%}%>
