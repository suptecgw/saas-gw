<%-- 
    Document   : financeiro
    Created on : 25/05/2016, 09:51:53
    Author     : Mateus
--%>
...
<head>
	...
	<title>GW Sistemas - Financeiro</title>
...
<header role="banner" class="header-top">
	...
	<div class="start-secion-page-mobile">
		...
		<h1 class="mobile-title-page">Financeiro</h1>
	...
	<div class="content-mobile">
		...
		<nav class="btn-menu-mobile">
			<ul class="btn-menu-mobile-list-top">
                                <!-- HISTÓRICOS -->
                                    <% if (user != null && user.getAcesso("cadhist") > NivelAcessoUsuario.SEM_ACESSO.getNivel()) { %>
                                    <li>
                                        <a class="openWindow" href="./consultahistorico?acao=iniciar" id="historico_listar">Históricos
                                            <%if (user != null && user.getAcesso("cadhist") > NivelAcessoUsuario.LER_ALTERAR.getNivel()) { %>
                                            <span id="historico_cadastro" class="more" data-href="./cadhistorico?acao=iniciar"></span>
                                            <%} %>
                                        </a>
                                    </li>
                                    ...
                                    <li style=" cursor: pointer;" title="Você não tem privilégios suficientes para executar essa ação." class="showTitle">
                                         <a style="background-color: silver;color: black;" class="openWindow" href="" id="" onclick="javascript: semPrivilegio('<%= permissoes.get("cadhist")%>')" >
                                            Históricos
                                        </a>
                                    </li>
                                    <% } %>
                                    ...
                                    <!--FORNECEDORES-->        
                                    <% if (user != null && user.getAcesso("cadfornecedor") > NivelAcessoUsuario.SEM_ACESSO.getNivel()) { %>
                                    <li>
                                        <a class="openWindow" href="./consultafornecedor?acao=iniciar" id="fornecedores_listar">Fornecedores 
                                            <% if (user != null && user.getAcesso("cadfornecedor") > NivelAcessoUsuario.LER_ALTERAR.getNivel()) { %>
                                            <span id="fornecedores_cadastro" class="more" data-href="./cadfornecedor?acao=iniciar"></span>
                                            <% } %>
                                        </a>
                                    </li>
                                    <% } else if (user != null && !user.isIsOcultarMenuSemPermissao()) {%>
                                    ...
                                    <li style=" cursor: pointer;" title="Você não tem privilégios suficientes para executar essa ação." class="showTitle">
                                         <a style="background-color: silver;color: black;" class="openWindow" href="" id="" onclick="javascript: semPrivilegio('<%= permissoes.get("cadfornecedor")%>')" >
                                            Fornecedores
                                        </a>
                                    </li>
                                    <% } %>

                                    <!--GRUPO CLIENTE/FORNEC-->        
                                    <% if (user != null && user.getAcesso("cadgrupo_cli_for") > NivelAcessoUsuario.SEM_ACESSO.getNivel()) {%>
                                    <li>
                                        <a class="openWindow" href="./consulta_grupo_cli_for.jsp?acao=iniciar" id="grupoClienteFornc_listar">Grupo cliente/fornec. 
                                            <% if (user != null && user.getAcesso("") > NivelAcessoUsuario.LER_ALTERAR.getNivel()) { %>
                                            <span id="grupoClienteFornc_cadastro" class="more" data-href="./cadgrupo_cli_for.jsp?acao=iniciar"></span>
                                            <% }%>
                                        </a>
                                    </li>
                                    <%} else if (user != null && !user.isIsOcultarMenuSemPermissao()) {%>
                                    ...
                                    <!--CONTA BANCÁRIA/CAIXAS-->        
                                    <%if (user != null && user.getAcesso("cadconta") > NivelAcessoUsuario.SEM_ACESSO.getNivel()) {%>

                                    <li>
                                        <a class="openWindow" href="./consultaconta?acao=iniciar" id="contaBancaria_listar">Conta bancárias/caixas 
                                            <% if (user != null && user.getAcesso("") > NivelAcessoUsuario.LER_ALTERAR.getNivel()) {%>
                                            <span id="contaBancaria_cadastro" class="more" data-href="./cadconta?acao=iniciar"></span>
                                            <%}%>
                                        </a>
                                    </li>
                                    ...
                                    <li style=" cursor: pointer;" title="Você não tem privilégios suficientes para executar essa ação." class="showTitle">
                                         <a style="background-color: silver;color: black;" class="openWindow" href="" id="" onclick="javascript: semPrivilegio('<%= permissoes.get("cadconta")%>')" >
                                            Conta bancárias/caixas
                                        </a>
                                    </li> 
                                    <%}%>

                                    <!--PLANO CENTRO DE CUSTO-->
                                    <% if (user != null && user.getAcesso("cadplanocusto") > NivelAcessoUsuario.SEM_ACESSO.getNivel()) {%>

                                    <li>
                                        <a class="openWindow" href="./consultaplano?acao=iniciar" id="planoCusto_listar">Plano centro de custo 
                                            <% if (user != null && user.getAcesso("cadplanocusto") > NivelAcessoUsuario.LER_ALTERAR.getNivel()) {%>
                                            <span id="planoCusto_cadastro" class="more" data-href="./cadplanocusto?acao=iniciar"></span>
                                            <% }%>
                                        </a>
                                    </li>
                                    ...
                                    <li style=" cursor: pointer;" title="Você não tem privilégios suficientes para executar essa ação." class="showTitle">
                                         <a style="background-color: silver;color: black;" class="openWindow" href="" id="" onclick="javascript: semPrivilegio('<%= permissoes.get("cadplanocusto")%>')" >
                                            Plano centro de custo 
                                        </a>
                                    </li> 
                                    <%}%>
                                    ...
                                    <!--UNIDADE DE CUSTO-->
                                    <%if (user != null && user.getAcesso("cadundcusto") > NivelAcessoUsuario.SEM_ACESSO.getNivel()) {%>

                                    <li>
                                        <a class="openWindow" href="./consulta_unidade_custo.jsp?acao=iniciar" id="unidadeCusto_listar">Unidade Custo 
                                            <% if (user != null && user.getAcesso("cadundcusto") > NivelAcessoUsuario.LER_ALTERAR.getNivel()) {%>
                                            <span id="unidadeCusto_cadastro" class="more" data-href="./cadunidade_custo.jsp?acao=iniciar"></span>
                                            <%}%>
                                        </a>
                                    </li>
                                    ...
                                    <li style=" cursor: pointer;" title="Você não tem privilégios suficientes para executar essa ação." class="showTitle">
                                         <a style="background-color: silver;color: black;" class="openWindow" href="" id="" onclick="javascript: semPrivilegio('<%= permissoes.get("cadundcusto")%>')" >
                                            Unidade Custo  
                                        </a>
                                    </li> 
                                    <%}%>
                                    ...
                                    <!--RATEIOS-->
                                    <% if (user != null && user.getAcesso("cadrateio") > NivelAcessoUsuario.SEM_ACESSO.getNivel()) {%>
                                    <li>
                                        <a class="openWindow" href="RateioControlador?acao=listar" id="rateio_listar">Rateios 
                                            <% if (user != null && user.getAcesso("cadrateio") > NivelAcessoUsuario.LER_ALTERAR.getNivel()) {%>
                                            <span id="rateio_cadastro" class="more" data-href="RateioControlador?acao=novoCadastro"></span>
                                            <%}%>
                                        </a>
                                    </li>
                                    <%} else if (user != null && !user.isIsOcultarMenuSemPermissao()) {%>
                                    <li style=" cursor: pointer;" title="Você não tem privilégios suficientes para executar essa ação." class="showTitle">
                                         <a style="background-color: silver;color: black;" class="openWindow" href="" id="" onclick="javascript: semPrivilegio('<%= permissoes.get("cadrateio")%>')" >
                                            Rateios  
                                        </a>
                                    </li> 
                                    <%}%>
                                    ...
                                    <!--Plano de Contas-->
                                    <%if (user != null && user.getAcesso("cadplanocontas") > NivelAcessoUsuario.SEM_ACESSO.getNivel()) {%>
                                    <li>
                                        <a class="openWindow" href="./consulta_plano_contas.jsp?acao=iniciar" id="planoContas_listar">Plano de contas 
                                            <%if (user != null && user.getAcesso("cadplanocontas") > NivelAcessoUsuario.LER_ALTERAR.getNivel()) {%>
                                            <span id="planoContas_cadastro" class="more" data-href="./cadplano_contas.jsp?acao=iniciar"></span>
                                            <%}%>
                                        </a>
                                    </li>
                                    <%} else if (user != null && !user.isIsOcultarMenuSemPermissao()) {%>
                                    <li style=" cursor: pointer;" title="Você não tem privilégios suficientes para executar essa ação." class="showTitle">
                                         <a style="background-color: silver;color: black;" class="openWindow" href="" id="" onclick="javascript: semPrivilegio('<%= permissoes.get("cadplanocontas")%>')" >
                                            Plano de contas  
                                        </a>
                                    </li> 
                                    <%}%>
                                    ...
                                    <!--Espécies (Despesas)-->
                                    <%if (user != null && user.getAcesso("cadespecie") > NivelAcessoUsuario.SEM_ACESSO.getNivel()) {%>
                                    <li>
                                        <a class="openWindow" href="./consulta_especie.jsp?acao=iniciar" id="especies_listar">Espécies (Despesas) 
                                            <%if (user != null && user.getAcesso("cadespecie") > NivelAcessoUsuario.LER_ALTERAR.getNivel()) {%>
                                            <span id="especies_cadastro" class="more" data-href="./cadespecie.jsp?acao=iniciar"></span>
                                            <%}%>
                                        </a>
                                    </li>
                                    <%} else if (user != null && !user.isIsOcultarMenuSemPermissao()) {%>
                                    <li style=" cursor: pointer;" title="Você não tem privilégios suficientes para executar essa ação." class="showTitle">
                                         <a style="background-color: silver;color: black;" class="openWindow" href="" id="" onclick="javascript: semPrivilegio('<%= permissoes.get("cadespecie")%>')" >
                                            Espécies (Despesas) 
                                        </a>
                                    </li> 
                                    <%}%>
                                    ...
                                    <!--Forma de Pagamento-->
                                    <%if (user != null && user.getAcesso("cadformapagamento") > NivelAcessoUsuario.SEM_ACESSO.getNivel()) {%>
                                    <li>
                                        <a class="openWindow" href="./cadFormaPagamento.jsp?acao=iniciarEditar" id="formaPagamento_listar">Forma de pagamento </a>
                                    </li>
                                    <%} else if (user != null && !user.isIsOcultarMenuSemPermissao()) {%>
                                    <li style=" cursor: pointer;" title="Você não tem privilégios suficientes para executar essa ação." class="showTitle">
                                         <a style="background-color: silver;color: black;" class="openWindow" href="" id="" onclick="javascript: semPrivilegio('<%= permissoes.get("cadformapagamento")%>')" >
                                            Forma de pagamento 
                                        </a>
                                    </li> 
                                    <%}%>
