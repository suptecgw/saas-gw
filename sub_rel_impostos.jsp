<%-- 
    Document   : sub_rel_impostos
    Created on : 25/05/2016, 12:14:17
    Author     : Mateus
--%>
...
<head>
	...
	<title>GW Sistemas - Relatórios Impostos</title>
...
<header role="banner" class="header-top">
	...
	<div class="start-secion-page-mobile">
		...
		<h1 class="mobile-title-page">Relatórios Impostos</h1>
	...
	<div class="content-mobile">
		...
		<nav class="btn-menu-mobile">
			...
			<!-- INSS/IR -->
                        <% if (user != null && user.getAcesso("relimpostos") > NivelAcessoUsuario.SEM_ACESSO.getNivel()) {%>
                        <li><a class="openWindow" href="./relinss" id="inssIr_relatorio">INSS/IR</a></li>
                        ...
                        <li style=" cursor: pointer;" title="Você não tem privilégios suficientes para executar essa ação." class="showTitle">
                             <a style="background-color: silver;color: black;" class="openWindow" href="" id="" onclick="javascript: semPrivilegio('<%= permissoes.get("relimpostos")%>')">INSS/IR
                            </a>
                        </li>
                        <%}%>
                    </ul>
