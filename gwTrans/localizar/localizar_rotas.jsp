...
<html>
    <head>
        ...
        <link href="${homePath}/gwTrans/localizar/css/estilo_localizar_rotas.css?v=${random.nextInt()}" rel="stylesheet" type="text/css"/>
        <!-- JS -->
        <script>
        ...
        <script src="${homePath}/gwTrans/localizar/js/funcoes_localizar_rotas.js?v=${random.nextInt()}" type="text/javascript"></script>
    </head>
    <body>
        <div class="geral-localizar">
            <div class="topo-localizar">
                ...
                <center>
                    <label>Localizar Rotas</label>
                </center>
                <c:if test="${param.cadrota >= 3}">
                    <img src="${homePath}/assets/img/icones/novo-cadastro-tag.png" class="novo-cadastro" title="Novo Cadastro" onclick="javascript:window.open('./cadrota.jsp?acao=iniciar', '', 'top=80,resizable=yes,status=1,scrollbars=1');">
                </c:if>
                ...
                <div class="regra">
                    <div class="regra-div-select">
                        <select id="select-campo">
                            ...
                            <option value="cidade_origem">Cidade Origem</option>
                            <option value="uf_origem">UF Origem</option>
                    ...
                    <div style="width: 100%;float: left;">
                        <center><input type="button" value="Localizar Rotas" class="searchButton" id="searchRota" onclick="localizarRotas(jQuery('#inpt-filtrar-por').val(), jQuery('#select-campo').val(), jQuery('#chkDiferenciar').prop('checked'), jQuery('#chkIgual').prop('checked'));"></center>
                    </div>
                </div>
            </div>
                ...
                <div class="coluna-pesquisa">
                    <div class="resultados">
                        <div class="envolve-topo">
                            <div class="topo-resultados-col1">Descrição</div><div class="topo-resultados-col2">Cidade Origem</div><div class="topo-resultados-col3">UF Origem</div><div class="topo-resultados-col4">Cidade Destino</div><div class="topo-resultados-col5">UF Destino</div>
                        </div>
            ...
            <div class="footer-localizar">
                <center><input type="button" value="Selecionar rotas escolhidos" class="okButton" id="searchRota" style="margin-top: 0 !important;" onclick="enviarRotasSelecionadas();"></center>
            </div>
            <div class="paginacao">
