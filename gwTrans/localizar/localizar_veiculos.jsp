    ...
    <body>
        <div class="geral-localizar">
            <div class="topo-localizar">
                ...
                <center>
                    <label id="titulo-tela">Localizar Veículos</label>
                </center>
                ...
                <div class="regra">
                    <div class="regra-div-select">
                        <select id="select-campo">
                            ...
                            <option value="num_frota">Nº Frota</option>
                            <option value="tipofrota">Tipo Frota</option>
                            <option value="tipo">Tipo Veículo</option>
                ...
                <div class="coluna-pesquisa">
                    <div class="resultados">
                        <div class="envolve-topo">
                            <div class="topo-resultados-col1">Placa</div><div class="topo-resultados-col2">Nº Frota</div><div class="topo-resultados-col3">Tipo Frota</div><div class="topo-resultados-col4">Tipo Veículo</div><div class="topo-resultados-col5">Marca</div><div class="topo-resultados-col6">Proprietário</div>
                        </div>
            ...
            <div class="footer-localizar">
                <center><input type="button" value="Selecionar veículos escolhidos" class="okButton" id="searchVeiculo" style="margin-top: 0 !important;" onclick="enviarVeiculosSelecionados();"></center>
            </div>
            <div class="paginacao">
