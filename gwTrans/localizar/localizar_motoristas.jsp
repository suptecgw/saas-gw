...
<html>
    <head>
        ...
        <link href="${homePath}/gwTrans/localizar/css/estilo_localizar_motoristas.css?v=${random.nextInt()}" rel="stylesheet" type="text/css"/>
        <!-- JS -->
        <script>
        ...
        <script src="${homePath}/gwTrans/localizar/js/funcoes_localizar_motoristas.js?v=${random.nextInt()}" type="text/javascript"></script>
    </head>
    <body>
        <div class="geral-localizar">
            <div class="topo-localizar">
                ...
                <center>
                    <label>Localizar Motoristas</label>
                </center>
                <c:if test="${param.cadmotorista >= 3}">
                    <img src="${homePath}/assets/img/icones/novo-cadastro-tag.png" class="novo-cadastro" title="Novo Cadastro" onclick="javascript:window.open('./cadmotorista?acao=iniciar', '', 'top=80,resizable=yes,status=1,scrollbars=1');">
                </c:if>
                ...
                <div class="regra">
                    <div class="regra-div-select">
                        <select id="select-campo">
                            ...
                            <option value="cnh">Nº CNH</option>
                            <option value="veiculo">Veículo</option>
                            <option value="carreta">Carreta</option>
                            <option value="bitrem">Bi-Trem</option>
                            <option value="carreta3">3º Reboque</option>
                        </select>
                    </div>
                    ...
                    <div style="width: 100%;float: left;">
                        <center><input type="button" value="Localizar Motoristas" class="searchButton" id="searchMotorista" onclick="localizarMotoristas(jQuery('#inpt-filtrar-por').val(), jQuery('#select-campo').val(), jQuery('#chkDiferenciar').prop('checked'), jQuery('#chkIgual').prop('checked'));"></center>
                    </div>
                </div>
            </div>
                ...
                <div class="coluna-pesquisa">
                    <div class="resultados">
                        <div class="envolve-topo">
                            <div class="topo-resultados-col1">Código</div><div class="topo-resultados-col2">Nome</div><div class="topo-resultados-col3">CPF</div><div class="topo-resultados-col4">Veículo</div><div class="topo-resultados-col5">Venc. CNH</div>
                        </div>
            ...
            <div class="footer-localizar">
                <center><input type="button" value="Selecionar motoristas escolhidos" class="okButton" id="searchMotorista" style="margin-top: 0 !important;" onclick="enviarMotoristasSelecionados();"></center>
            </div>
            <div class="paginacao">
