...
<html>
    <head>
        ...
        <link href="${homePath}/gwTrans/localizar/css/estilo_localizar_aeroportos.css?v=${random.nextInt()}" rel="stylesheet" type="text/css"/>
        <!-- JS -->
        <script>
        ...
        <script src="${homePath}/gwTrans/localizar/js/funcoes_localizar_aeroportos.js?v=${random.nextInt()}" type="text/javascript"></script>
    </head>
    <body>
        <div class="geral-localizar">
            <div class="topo-localizar">
                ...
                <center>
                    <label>Localizar Aeroporto</label>
                </center>
                <c:if test="${param.cadaeroporto >= 3}">
                    <img src="${homePath}/assets/img/icones/novo-cadastro-tag.png" class="novo-cadastro" title="Novo Cadastro" onclick="javascript:window.open('AeroportoControlador?acao=novoCadastro', '', 'top=80,resizable=yes,status=1,scrollbars=1');">
                </c:if>
            ...
            <div class="corpo-localizar">
                <div class="regra">
                    ...
                    <div style="width: 100%;float: left;">
                        <center><input type="button" value="Localizar" class="searchButton" id="searchAeroporto" onclick="localizarAeroportos(jQuery('#inpt-filtrar-por').val(), jQuery('#select-campo').val(), jQuery('#chkDiferenciar').prop('checked'), jQuery('#chkIgual').prop('checked'));"></center>
                    </div>
                </div>
            </div>
                ...
                <div class="coluna-pesquisa">
                    <div class="resultados">
                        <div class="envolve-topo">
                            <div class="topo-resultados-col1">Nome</div><div class="topo-resultados-col2">IATA</div><div class="topo-resultados-col3">Cidade</div><div class="topo-resultados-col4">UF</div>
                        </div>
            ...
            <div class="footer-localizar">
                <center><input type="button" value="Selecionar aeroportos escolhidos" class="okButton" id="searchAeroporto" style="margin-top: 0 !important;" onclick="enviarAeroportosSelecionados();"></center>
            </div>
            <div class="paginacao">
    ...
    <script>
        ...
        if (tipoLocalizar == 'aeroOrigem') {
            controleLocalizar = 'controleLocalizarAeroOrigem';
        } else if (tipoLocalizar == 'aeroDestino') {
            controleLocalizar = 'controleLocalizarAeroDestino';
        }
