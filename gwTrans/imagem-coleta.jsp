...
<html>
    <head>
        ...
        <title>GW Trans - Visualização de Documentos da Coleta</title>
        ...
        <script>
            var idColeta = '${param.idPedidoColeta}';
            ...
            function visualizaImagem(imagem) {
                window.open("${homePath}/ImagemControlador?acao=imgpdf&imagem=" + imagem.trim() + "&idPedidoColeta=" + idColeta, "visualizaImagem", 'top=80,left=70,height=500,width=800,resizable=yes,status=1,scrollbars=1');
            }
            ...
            function createFormAndSubmit() {
                ...
                var action = '${homePath}/ImagemControlador?acao=cadastrar&idPedidoColeta=' + idColeta + '&descricao=' + descricao;
            ...
            function excluir() {
                location.replace("${homePath}/ImagemControlador?acao=excluir&idImagem=" + getValueCheckMarcados() + "&idPedidoColeta=" + idColeta);
            }
    ...
    <body>
        <div class="gw-img-geral">
            <div class="gw-img-geral-A">
                ...
                <div class="gw-img-geral-A-titulo">Visualização de Documentos da Coleta</div>
                ...
                <div class="container-descricao">
                    ...
                    <center>
                        <div class="mdl-textfield mdl-js-textfield" style="width: 90%;padding: 5px 0;font-size: 13px;">
                            <textarea class="mdl-textfield__input" type="text" rows= "3" id="descricao" name="descricao" style="font-size: 15px;resize: none;" ></textarea>
                                            ...
                                            <td>
                                                <c:choose>
                                                    <c:when test="${imagem.getExtensao().trim().equalsIgnoreCase('jpg') || imagem.getExtensao().trim().equalsIgnoreCase('png') || imagem.getExtensao().trim().equalsIgnoreCase('gif')}">
                                                        <img width="50px" height="50px" src="${homePath}/img/coleta/${imagem.getPedidoId()}_${imagem.getId()}.${imagem.getExtensao().trim()}" class="imagemLink2"
                                                             onclick="visualizaImagem('/img/coleta/${imagem.getPedidoId()}_${imagem.getId()}.${imagem.getExtensao().trim()}');" style="cursor: pointer" alt="Documento">
                                                    </c:when>
                                                    ...
                                                    <c:when test="${imagem.getExtensao().trim().equalsIgnoreCase('doc')}">
                                                            <img width="50px" height="50px" src="${homePath}/assets/img/doc-icon.png" class="imagemLink2" 
                                                                 onclick="visualizaImagem('/img/coleta/${imagem.getPedidoId()}_${imagem.getId()}.${imagem.getExtensao().trim()}');" style="cursor: pointer" alt="Documento">
                                                    </c:when>
