...
<html>
    <head>
        ...
        <title>GW Trans - Visualização de Documentos do Cliente</title>
        ...
        <link href="${homePath}/assets/css/consulta-imagem.css?v=${random.nextInt()}" rel="stylesheet" type="text/css"/>
        <script>
            var idCliente = '${param.idCliente}';
            var razaosocial = '${param.razaosocial}';
            ...
            function visualizaImagem(imagem) {
                window.open("${homePath}/ImagemControlador?acao=imgpdf&imagem=" + imagem.trim() + "&idcliente=" + idCliente, "visualizaImagem", 'top=80,left=70,height=500,width=800,resizable=yes,status=1,scrollbars=1');
            }
            ...
            function createFormAndSubmit() {
                ...
                var action = '${homePath}/ImagemControlador?acao=cadastrar&idcliente=' + idCliente + '&razaosocial=' + razaosocial + '&descricao=' + descricao;
            ...
            function excluir() {
                location.replace("${homePath}/ImagemControlador?acao=excluir&idImagem=" + getValueCheckMarcados() + "&idcliente=" + idCliente);
            }
    ...
    <body>
        <div class="gw-img-geral">
            <div class="gw-img-geral-A">
                ...
                <div class="gw-img-geral-A-titulo">Visualização de Documentos do Cliente</div>
            ...
            <div class="gw-img-geral-B">
                ...
                <div class="container-descricao">
                    <label style="width: 100%;float: left;margin-top: 16px;color: #777;font-size: 15px;font-weight: bold;margin-left: 15px;">Descrição do documento</label>
                    <center>
                        ...
                        <tbody style="overflow-y: scroll;">
                            ...
                            <center>
                                <c:if test="${imagem.getExtensao().trim().equalsIgnoreCase('jpg')}">
                                    <img width="50px" height="50px" src="${homePath}/img/cliente/${imagem.getClienteId()}_${imagem.getId()}.${imagem.getExtensao().trim()}" class="imagemLink2" onclick="visualizaImagem('/img/cliente/${imagem.getClienteId()}_${imagem.getId()}.${imagem.getExtensao().trim()}');" style="cursor: pointer" alt="Documento">
                                </c:if>
                                ...
                                <c:if test="${imagem.getExtensao().trim().equalsIgnoreCase('pdf')}">
                                    <img width="50px" height="50px" src="${homePath}/assets/img/pdf-icon.png" class="imagemLink2" onclick="visualizaImagem('/img/cliente/${imagem.getClienteId()}_${imagem.getId()}.${imagem.getExtensao().trim()}');" style="cursor: pointer" alt="Documento">
                                </c:if>
                                <c:if test="${imagem.getExtensao().trim().equalsIgnoreCase('doc') || imagem.getExtensao().trim().equals('docx')}">
                                    <img width="50px" height="50px" src="${homePath}/assets/img/doc-icon.png" class="imagemLink2" onclick="visualizaImagem('/img/cliente/${imagem.getClienteId()}_${imagem.getId()}.${imagem.getExtensao().trim()}');" style="cursor: pointer" alt="Documento">
                                </c:if>                            
                                <c:if test="${imagem.getExtensao().trim().equalsIgnoreCase('xml')}">
                                    <img width="50px" height="50px" src="${homePath}/assets/img/xml-icon.png" class="imagemLink2" onclick="visualizaImagem('/img/cliente/${imagem.getClienteId()}_${imagem.getId()}.${imagem.getExtensao().trim()}');" style="cursor: pointer" alt="Documento">
                                </c:if>
