...
<html>
    ...
    <head>
        ...
        <title>GW Trans - Consulta de E-mails</title>
        ...
        <link href="${homePath}/gwTrans/consultas/css/consulta-emails.css?v=${random.nextInt()}" rel="stylesheet" type="text/css"/>
        <script defer src="${homePath}/script/validarSessao.js?v=${random.nextInt()}" type="text/javascript"></script>
        <script defer>
            var codigoTela = 'T00067';
            var codigo_tela = '67';
            var idPreferencia = 0;
    ...
    <body>
        ...
        <div id="topo">
            <div id="logo">
                <h3>Consulta de E-mails <img src="${homePath}/assets/img/trans_white.png"></h3>
            </div>
            <div id="actions">
                    ...
                    <c:if test="${nivelUser >= 2}">
                        <li>
                            <span class="bt bt-cadastro" onclick="checkSession(function () {
                                        btnCadastrar('EmailControlador?acao=novoCadastro');
                                    }, false);">Novo E-mail</span>
                        </li>
                    </c:if>
                </ul>
        ...
        <div id="sidebar" class="heightDoc">
            <div class="columnLeft" id="columnLeft">
                ...
                <div class="content">
                    <form action="ConsultaControlador?codTela=67" method="POST" id="formConsulta" name="formConsulta">
                        <div class="item_form">
            ...
            <input type="hidden" name="inp-auditoria" data-exclusao="true" data-rotina-auditoria="config_emails">
        </div>
        ...
        <script src="${homePath}/gwTrans/consultas/js/consulta-emails.js?v=${random.nextInt()}"></script>
