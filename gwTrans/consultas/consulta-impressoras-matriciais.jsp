<%-- 
    Document   : consulta-Impressoras-Matriciais
    Created on : 18/06/2018, 11:00:00
...
<html>
    ...
    <head>
        ...
        <title>GW Trans - Consulta de Impressoras Matriciais</title>
        ...
        <link href="${homePath}/gwTrans/consultas/css/consulta-impressoras-matriciais.css?v=${random.nextInt()}" rel="stylesheet" type="text/css"/>
        <script defer src="${homePath}/script/validarSessao.js?v=${random.nextInt()}" type="text/javascript"></script>
        <script defer>
            var codigoTela = 'T000100';
            var codigo_tela = 100;
            var codigo_tela_cadastro = 101;
            var idPreferencia = 0;
    ...
    <body>
        <div class="load-preferencias">
            <div class="container-progress">
                <img class="caminhao" id="caminhao" src="${homePath}/img/loading.gif?v=${random.nextInt()}">
                <div class="cs-loader">
        ...
        <img class="gif-bloq-tela-left" src="${homePath}/img/espere_new.gif?v=${random.nextInt()}" alt=""/>
        <div class="container-salvar-filtros">
            <iframe id="iframeSalvarFiltros" name="iframeSalvarFiltros" src="${homePath}/gwTrans/consultas/salvar_filtros.jsp?v=${random.nextInt()}" frameborder="0" marginheight="0" marginwidth="0" scrolling="no" ></iframe>
            <span class="seta-baixo"></span>
        </div>
        <div id="topo">
            <div id="logo">
                <h3>Consulta de Impressoras Matriciais<img src="${homePath}/assets/img/trans_white.png?v=${random.nextInt()}"></h3>
            </div>
            <div id="actions">
                ...
                <ul>
                    <c:if test="${nivelUser >= 3}">
                        <li>
                            <div class="bt bt-cadastro" onclick="javascript:checkSession(function(){cadastrarImpressora();},false);">Novo Cadastro</div>
                        </li>
                    </c:if>
                </ul>
        ...
        <div id="sidebar" class="heightDoc">
            <div class="columnLeft" id="columnLeft">
                ...
                <div class="content">
                    <form action="ConsultaControlador?codTela=100" method="POST" id="formConsulta" name="formConsulta">
                        <div class="item_form">
            ...
            <input type="hidden" name="inp-auditoria" data-exclusao="true" data-rotina-auditoria="printers">
        </div>
        ...
        <script src="${homePath}/gwTrans/consultas/js/consulta-impressoras-matriciais.js?v=${random.nextInt()}"></script>
