<%-- 
    Document   : consulta-embalagens
    Created on : 27/01/2017, 08:50:52
...
<html>
    ...
    <head>
        ...
        <title>GW Trans - Consulta de Embalagens</title>
        ...
        <link href="${homePath}/gwTrans/consultas/css/consulta-embalagens.css?v=${random.nextInt()}" rel="stylesheet" type="text/css"/>
        <script defer src="${homePath}/script/validarSessao.js?v=${random.nextInt()}" type="text/javascript"></script>
        <script defer>
            var codigoTela = 'T00037';
            var codigo_tela = 37;
            var idPreferencia = 0;
    ...
    <body>
        ...
        <div id="topo">
            <div id="logo">
                <h3>Consulta de Embalagem<img src="${homePath}/assets/img/trans_white.png"></h3>
            </div>
            <div id="actions">
                ...
                <ul>
                    <c:if test="${nivelUser >= 3}">
                        <li>
                            <div class="bt bt-cadastro"  onclick="javascript:checkSession(function(){cadastrarEmbalagem();},false);">Nova Embalagem</div>
                        </li>
                    </c:if>

                    <li>
                        <div class="bt bt-relatorio"  onclick="javascript:checkSession(function(){relatorioEmbalagem();},false);">Relatório</div>
                    </li>
                </ul>
        ...
        <div id="sidebar" class="heightDoc">
            <div class="columnLeft" id="columnLeft">
                ...
                <div class="content">
                    <form action="ConsultaControlador?codTela=37" method="POST" id="formConsulta" name="formConsulta">
                        <div class="item_form">
            ...
            <input type="hidden" name="inp-auditoria" data-exclusao="true" data-rotina-auditoria="embalagem">
        </div>
        ...
        <script src="${homePath}/gwTrans/consultas/js/consulta-embalagens.js?v=${random.nextInt()}"></script>
