...
<html>
    ...
    <head>
        ...
        <title>GW Trans - Consulta de Contrato Comercial</title>
        ...
        <link href="${homePath}/gwTrans/consultas/css/consulta-contrato-comercial.css?v=${random.nextInt()}" rel="stylesheet" type="text/css"/>
        ...
        <script defer>
            var codigoTela = 'T00079';
            var codigo_tela = '79';
            var codigo_tela_cadastro = 80;
            var idPreferencia = 0;
    ...
    <body>
        ...
        <div id="topo">
            <div id="logo">
                <h3>Consulta de Contrato Comercial <img src="${homePath}/assets/img/trans_white.png"></h3>
            </div>
            <div id="actions">
                ...
                <ul>
                    <c:if test="${nivelUser >= 2}">
                        <li>
                            <span class="bt bt-cadastro">Novo Contrato</span>
                        </li>
                    </c:if>
                </ul>
        ...
        <div id="sidebar" class="heightDoc">
            <div class="columnLeft" id="columnLeft">
                ...
                <div class="content">
                    <form action="ConsultaControlador?codTela=79" method="POST" id="formConsulta" name="formConsulta">
                        <div class="item_form">
                                ...
                                <div class="item_form" style="margin-bottom: 10px;">
                                    ...
                                    <div class="btns">
                                        <a href="javascript:" onclick="checkSession(function () {
                                                    removerValorInput('inptGrupoCli', true);
            ...
            <input type="hidden" name="inp-auditoria" data-exclusao="true" data-rotina-auditoria="contrato_comercial">
        </div>
                ...
                <div class="footerTableImpressao">
                    ...
                    <div class="footer03">
                        ...
                        <div class="footer03-02">
                            <div class="bt bt-impressao" onclick="popContratoComercialGeral();">Imprimir</div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <script src="${homePath}/gwTrans/consultas/js/consulta-contrato-comercial.js?v=${random.nextInt()}"></script>
        ...
        <script type='text/javascript' lang="JavaScript">
            ...
            <c:if test="${filtroEscolhido != null}">
                                    ...
                                    setTimeout(function () {
                                        ...
                                        jQuery(jQuery('.localiza')[1]).html('<iframe id="localizarFilial" input="inptFilial" name="localizarFilial" src="LocalizarControlador?acao=abrirLocalizar&idLocalizar=localizarFilial&tema=${tema}" frameborder="0" marginheight="0" marginwidth="0" scrolling="no" ></iframe>');
                                    }, 1);
