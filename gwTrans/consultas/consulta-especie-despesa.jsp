<%-- 
    Document   : consulta-especie-despesa
    Created on : 18/01/2017, 09:36:23
...
<html>
    ...
    <head>
        ...
        <title>GW Trans - Consulta de Espécie (Despesa)</title>
        ...
        <link href="${homePath}/gwTrans/consultas/css/consulta-especie-despesa.css?v=${random.nextInt()}" rel="stylesheet" type="text/css"/>
        <script defer src="${homePath}/script/validarSessao.js?v=${random.nextInt()}" type="text/javascript"></script>
        <script defer>
            var codigoTela = 'T00023';
            var codigo_tela = 23;
            var idPreferencia = 0;
    ...
    <body>
        ...
        <div id="topo">
            <div id="logo">
                <h3>Consulta de Espécie (Despesa)<img src="${homePath}/assets/img/trans_white.png"></h3>
            </div>
            <div id="actions">
                ...
                <ul>
                    <c:if test="${nivelUser >= 2}">
                        <li>
                            <div class="bt bt-cadastro" onclick="javascript:checkSession(function(){cadastrarEspecie();},false);">Nova Espécie</div>
                        </li>
                    </c:if>

                    <li>
                        <div class="bt bt-relatorio"  onclick="javascript:checkSession(function(){relatorioEspecie();},false);">Relatório</div>
                    </li>
                </ul>
        ...
        <div id="sidebar" class="heightDoc">
            <div class="columnLeft" id="columnLeft">
                ...
                <div class="content">
                    <form action="ConsultaControlador?codTela=23" method="POST" id="formConsulta" name="formConsulta">
                        <div class="item_form">
            ...
            <input type="hidden" name="inp-auditoria" data-exclusao="true" data-rotina-auditoria="species">
        </div>
        ...
        <script src="${homePath}/gwTrans/consultas/js/consulta-especie-despesa.js?v=${random.nextInt()}"></script>
