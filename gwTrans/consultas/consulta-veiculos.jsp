...
<html>
    ...
    <head>
        ...
        <title>GW Trans - Consulta de Veículos</title>
        ...
        <link href="${homePath}/gwTrans/consultas/css/consulta-veiculos.css?v=${random.nextInt()}" rel="stylesheet" type="text/css"/>
    ...
    <body>
        ...
        <div id="topo">
            <div id="logo">
                <h3>Consulta de Veículos <img src="${homePath}/assets/img/trans_white.png"></h3>
            </div>
            <div id="actions">
                    ...
                    <c:if test="${nivelUser >= 3}">
                        <li>
                            <span class="bt bt-cadastro" onclick="checkSession(function () {
                                        btnCadastrar('cadveiculo?acao=iniciar');
                                    }, false);">Novo Veículo</span>
                        </li>
                    </c:if>

                    <li>
                        <span class="bt bt-relatorio" onclick="checkSession(function () {
                                    abrirPopConsulta('./relveiculos.jsp?acao=iniciar&modulo=webtrans');
        ...
        <div id="sidebar" class="heightDoc">
            <div class="columnLeft" id="columnLeft">
                ...
                <div class="content">
                    <form action="ConsultaControlador?codTela=56" method="POST" id="formConsulta" name="formConsulta">
                        <div class="item_form">
                        ...
                        <div id="filtros-adicionais-container" style="display: none;">
                            ...
                            <div class="item_form" style="margin-bottom: 50px;margin-top: 10px;">
                                ...
                                <select id="select-tipo-veiculo" name="select-tipo-veiculo">
                                </select>
                            </div>
                            <div class="item_form" style="margin-bottom: 10px;">
                                ...
                                <div class="btns">
                                    <a href="javascript:" onclick="checkSession(function () {
                                                removerValorInput('inptCidade', false);
                            ...
                            <div class="item_form" style="margin-bottom: 10px;">
                                <select id="select-exceto-apenas-proprietario" name="select-exceto-apenas-proprietario">
                                    <option value="apenas">Apenas os proprietários</option>
                                    <option value="exceto">Exceto os proprietários</option>
                                </select>
                                <div style="width: 70%;float: left;">
                                    <input class="input" type="text" id="inptProprietario" name="inptProprietario" readonly="true" placeholder="">
                                </div>
                                <div class="btns">
                                    <a href="javascript:" onclick="checkSession(function () {
                                                removerValorInput('inptProprietario', false);
                                            }, false);" class="btnDelete" style="margin-top: 2px;"></a>
                                    <a href="javascript:checkSession(function(){controlador.acao('abrirLocalizar','localizarProprietario');},false);" class="btnMore" style="float: right !important;margin-right: 5px;"></a>
                                    <!--<img src="${homePath}/assets/img/pesquisar_por.jpg" class="img-visualizar">-->
                                </div>
                            </div>
                            <div class="item_form" style="margin-bottom: 10px;">
                                <select id="select-exceto-apenas-marca" name="select-exceto-apenas-marca">
                                    <option value="apenas">Apenas as marcas</option>
                                    <option value="exceto">Exceto as marcas</option>
                                </select>
                                <div style="width: 70%;float: left;">
                                    <input class="input" type="text" id="inptMarca" name="inptMarca" readonly="true" placeholder="">
                                </div>
                                <div class="btns">
                                    <a href="javascript:" onclick="checkSession(function () {
                                                removerValorInput('inptMarca', false);
                                            }, false);" class="btnDelete" style="margin-top: 2px;"></a>
                                    <a href="javascript:checkSession(function(){controlador.acao('abrirLocalizar','localizarMarca');},false);" class="btnMore" style="float: right !important;margin-right: 5px;"></a>
                                    <!--<img src="${homePath}/assets/img/pesquisar_por.jpg" class="img-visualizar">-->
                                </div>
                            </div>
                            <div class="item_form" style="margin-bottom: 10px;">
            ...
            <input type="hidden" name="inp-auditoria" data-exclusao="true" data-rotina-auditoria="veiculo">
        </div>
        ...
        <script src="${homePath}/gwTrans/consultas/js/consulta-veiculos.js?v=${random.nextInt()}"></script>
        ...
        <script defer type='text/javascript' lang="JavaScript">
            ...
            var menuDocumentos = {
                ...
                acao: "visualizarDocumentos(this,'${tema}')"
            };
            ...
            <c:if test="${pref != null}">
                ...
                gerenciarMostrarVeiculos('${filtros.colunaNome}', '${filtros.colunaValor}', '${filtros.colunaCondicaoLocalizar}', '${filtros.descricao}');
                gerenciarInpCidade('${filtros.colunaNome}', '${filtros.colunaValor}', '${filtros.descricao}', '${filtros.colunaCondicaoLocalizar}');
                gerenciarInpProprietario('${filtros.colunaNome}', '${filtros.colunaValor}', '${filtros.descricao}', '${filtros.colunaCondicaoLocalizar}');
                gerenciarInpMarca('${filtros.colunaNome}', '${filtros.colunaValor}', '${filtros.descricao}', '${filtros.colunaCondicaoLocalizar}');
            ...
            <c:if test="${filtroEscolhido != null}">
                ...
                setTimeout(function () {
                    ...
                    jQuery(jQuery('.localiza')[1]).html('<iframe id="localizarProprietario" input="inptProprietario" name="localizarProprietario" src="LocalizarControlador?acao=abrirLocalizar&idLocalizar=localizarProprietario&tema=${tema}" frameborder="0" marginheight="0" marginwidth="0" scrolling="no" ></iframe>');
                    jQuery(jQuery('.localiza')[2]).html('<iframe id="localizarMarca" input="inptMarca" name="localizarMarca" src="LocalizarControlador?acao=abrirLocalizar&idLocalizar=localizarMarca&tema=${tema}" frameborder="0" marginheight="0" marginwidth="0" scrolling="no" ></iframe>');
                    jQuery(jQuery('.localiza')[3]).html('<iframe id="localizarTipoVeiculo" input="inptTipoVeiculo" name="localizarTipoVeiculo" src="LocalizarControlador?acao=abrirLocalizar&idLocalizar=localizarTipoVeiculo&tema=${tema}" frameborder="0" marginheight="0" marginwidth="0" scrolling="no" ></iframe>');
                }, 1);
