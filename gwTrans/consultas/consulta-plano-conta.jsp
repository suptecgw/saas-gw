<%-- 
    Document   : consulta-plano-conta
    Created on : 17/01/2017, 08:21:55
...
<html>
    ...
    <head>
        ...
        <title>GW Trans - Consulta de Plano de Conta</title>
        ...
        <link href="${homePath}/gwTrans/consultas/css/consulta-plano-conta.css?v=${random.nextInt()}" rel="stylesheet" type="text/css"/>
        <script defer src="${homePath}/script/validarSessao.js?v=${random.nextInt()}" type="text/javascript"></script>
        <script defer>
            var codigoTela = 'T00022';
            var codigo_tela = 22;
            var idPreferencia = 0;
    ...
    <body>
        ...
        <div id="topo">
            <div id="logo">
                <h3>Consulta de Plano de Conta<img src="${homePath}/assets/img/trans_white.png"></h3>
            </div>
            <div id="actions">
                ...
                <ul>
                    <c:if test="${nivelUser >= 3}">
                        ...
                        <li>
                            <div class="bt bt-cadastro" onclick="checkSession(function(){importarPlanoContas();},false);">Importar Plano de Contas</div>
                        </li>
                    </c:if>
        ...
        <div id="sidebar" class="heightDoc">
            <div class="columnLeft" id="columnLeft">
                ...
                <div class="content">
                    <form action="ConsultaControlador?codTela=22" method="POST" id="formConsulta" name="formConsulta">
                        <div class="item_form">
            ...
            <input type="hidden" name="inp-auditoria" data-exclusao="true" data-rotina-auditoria="plain_accounts">
        </div>
        ...
        <script src="${homePath}/gwTrans/consultas/js/consulta-plano-conta.js?v=${random.nextInt()}"></script>
