<%-- 
    Document   : consulta-ftp
    Created on : 16/04/2018, 11:00:00
...
<html>
    ...
    <head>
        ...
        <title>GW Trans - Consulta de FTP</title>
        ...
        <link href="${homePath}/gwTrans/consultas/css/consulta-ftp.css?v=${random.nextInt()}" rel="stylesheet" type="text/css"/>
        <script defer src="${homePath}/script/validarSessao.js?v=${random.nextInt()}" type="text/javascript"></script>
        <script defer>
            var codigoTela = 'T00071';
            var codigo_tela = 71;
            var codigo_tela_cadastro = 84;
            var idPreferencia = 0;
    ...
    <body>
        ...
        <div id="topo">
            <div id="logo">
                <h3>Consulta de FTP<img src="${homePath}/assets/img/trans_white.png"></h3>
            </div>
            <div id="actions">
                ...
                <ul>
                    <c:if test="${nivelUser >= 3}">
                        <li>
                            <div class="bt bt-cadastro" onclick="javascript:checkSession(function(){cadastrarFTP();},false);">Novo Cadastro</div>
                        </li>
                    </c:if>
                </ul>
        ...
        <div id="sidebar" class="heightDoc">
            <div class="columnLeft" id="columnLeft">
                ...
                <div class="content">
                    <form action="ConsultaControlador?codTela=71" method="POST" id="formConsulta" name="formConsulta">
                        <div class="item_form">
            ...
            <input type="hidden" name="inp-auditoria" data-exclusao="true" data-rotina-auditoria="ftp">
        </div>
        ...
        <script src="${homePath}/gwTrans/consultas/js/consulta-ftp.js?v=${random.nextInt()}"></script>
