...
<html>
    ...
    <head>
        ...
        <title>GW Trans - Consulta de Iscas</title>
        ...
        <link href="${homePath}/gwTrans/consultas/css/consulta-iscas.css?v=${random.nextInt()}" rel="stylesheet" type="text/css"/>
        ...
        <script defer>
            var codigoTela = 'T00138';
            var codigo_tela = '138';
            var codigo_tela_cadastro = '139';
            var idPreferencia = 0;
    ...
    <body>
        ...
        <div id="topo">
            <div id="logo">
                <h3>Consulta de Iscas <img src="${homePath}/assets/img/trans_white.png"></h3>
            </div>
            <div id="actions">
                ...
                <ul>
                    <c:if test="${nivelUser >= 3}">
                        <li>
                            <span class="bt bt-cadastro">Nova Isca</span>
                        </li>
                    </c:if>
                </ul>
            </div>
        ...
        <div id="sidebar" class="heightDoc">
            <div class="columnLeft" id="columnLeft">
                ...
                <div class="content">
                    <form action="ConsultaControlador?codTela=138" method="POST" id="formConsulta" name="formConsulta">
                        <div class="item_form">
                        ...
                        <div class="item_form div-ordenacao">
                            ...
                            <div id="filtros-adicionais-container" style="display: none;">
                                <div class="item_form" style="margin-bottom: 50px;margin-top: 10px;">
                                    <select id="select-exceto-apenas-status-iscas" name="select-exceto-apenas-status-iscas">
                                        <option value="apenas">Apenas os Status</option>
                                        <option value="exceto">Exceto os Status</option>
                                    </select>
                                    <select id="select-status-iscas" name="select-status-iscas">
            ...
            <input type="hidden" name="inp-auditoria" data-exclusao="true" data-rotina-auditoria="iscas">
        </div>
        ...
        <script src="${homePath}/gwTrans/consultas/js/consulta-iscas.js?v=${random.nextInt()}"></script>
            ...
            <c:if test="${pref != null}">
                ...
                <c:forEach var="filtros" items="${pref.filtros}" varStatus="filtrosStatus" >
                    <c:if test="${filtrosStatus.count == 1}">
                                    ...
                                    gerenciarStatusIsca('${filtros.colunaNome}', '${filtros.colunaValor}', '${filtros.descricao}', '${filtros.colunaCondicaoLocalizar}');
