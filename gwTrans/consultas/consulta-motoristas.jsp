...
<html>
    ...
    <head>
        ...
        <title>GW Trans - Consulta de Motoristas</title>
        ...
        <link href="${homePath}/gwTrans/consultas/css/consulta-motoristas.css?v=${random.nextInt()}" rel="stylesheet" type="text/css"/>
    ...
    <body>
        ...
        <div id="topo">
            <div id="logo">
                <h3>Consulta de Motoristas <img src="${homePath}/assets/img/trans_white.png"></h3>
            </div>
            <div id="actions">
                    ...
                    <c:if test="${nivelUser >= 3}">
                        <li>
                            <span class="bt bt-cadastro" onclick="checkSession(function () {
                                        btnCadastrar('cadmotorista?acao=iniciar');
                                    }, false);">Novo Motorista</span>
                        </li>
                    </c:if>

                    <li>
                        <span class="bt bt-relatorio" onclick="checkSession(function () {
                                    abrirPopConsulta('./relmotoristas.jsp?acao=iniciar&modulo=webtrans');
        ...
        <div id="sidebar" class="heightDoc">
            <div class="columnLeft" id="columnLeft">
                ...
                <div class="content">
                    <form action="ConsultaControlador?codTela=60" method="POST" id="formConsulta" name="formConsulta">
                        <div class="item_form">
                        ...
                        <div id="filtros-adicionais-container" style="display: none;">
                            ...
                            <div class="item_form" style="margin-bottom: 50px;margin-top: 10px;">
                                <select id="select-exceto-apenas-tipo-motorista" name="select-exceto-apenas-tipo-motorista">
                                    <option value="apenas">Apenas os Tipos</option>
                                    <option value="exceto">Exceto os Tipos</option>
                                </select>
                                <select id="select-tipo-motorista" name="select-tipo-motorista">
                                </select>
                            </div>
                            <div class="item_form" style="margin-bottom: 10px;">
                                <select id="select-exceto-apenas-cidade" name="select-exceto-apenas-cidade">
                                    <option value="apenas">Apenas cidades</option>
                                    <option value="exceto">Exceto cidades</option>
                                </select>
                            ...
                            <div class="item_form" style="margin-bottom: 10px;">
                                ...
                                <div class="btns">
                                    <a href="javascript:" onclick="checkSession(function () {
                                                removerValorInput('inptVeiculo', false);
                                            }, false);" class="btnDelete" style="margin-top: 2px;"></a>
                                    <a href="javascript:checkSession(function(){controlador.acao('abrirLocalizar','localizarVeiculoGeral');},false);" class="btnMore" style="float: right !important;margin-right: 5px;"></a>
                                    <!--<img src="${homePath}/assets/img/pesquisar_por.jpg" class="img-visualizar">-->
                                </div>
                            </div>
                            <div class="item_form" style="margin-bottom: 10px;">
                                <select id="select-exceto-apenas-tipo-veiculo" name="select-exceto-apenas-tipo-veiculo">
                                    <option value="apenas">Apenas tipos de veículos</option>
                                    <option value="exceto">Exceto tipos de veículos</option>
                                </select>
                                <div style="width: 70%;float: left;">
                                    <input class="input" type="text" id="inptTipoVeiculo" name="inptTipoVeiculo" readonly="true" placeholder="">
                                </div>
                                <div class="btns">
                                    <a href="javascript:" onclick="checkSession(function () {
                                                removerValorInput('inptTipoVeiculo', false);
                                            }, false);" class="btnDelete" style="margin-top: 2px;"></a>
                                    <a href="javascript:checkSession(function(){controlador.acao('abrirLocalizar','localizarTipoVeiculo');},false);" class="btnMore" style="float: right !important;margin-right: 5px;"></a>
                                    <!--<img src="${homePath}/assets/img/pesquisar_por.jpg" class="img-visualizar">-->
                                </div>
                            </div>
                            <div class="item_form" style="margin-bottom: 10px;">
            ...
            <input type="hidden" name="inp-auditoria" data-exclusao="true" data-rotina-auditoria="motorista">
        </div>
                ...
                <div class="footerTableImpressao">
                    ...
                    <div class="footer02">
                        ...
                        <select name="cbmodelo" id="cbmodelo">
                            <option value="2" <c:if test="${cfg.getRelDefaultMotorista() == '2'}">selected</c:if>>Modelo 2</option>
                            <option value="3" <c:if test="${cfg.getRelDefaultMotorista() == '3'}">selected</c:if>>Modelo 3</option>
                            <option value="4" <c:if test="${cfg.getRelDefaultMotorista() == '4'}">selected</c:if>>Modelo 4</option>
                            <option value="5" <c:if test="${cfg.getRelDefaultMotorista() == '5'}">selected</c:if>>Modelo 5</option>


                            <c:forEach items="${relPersonalizadoMotorista}" var="rel">
                                <c:set var="relCompleto" value="doc_motorista_personalizado_${rel}" />
                                <option value="doc_motorista_personalizado_${rel}" <c:if test="${cfg.getRelDefaultMotorista() == relCompleto}">selected</c:if>>Modelo ${rel.toUpperCase()} (Personalizado)</option>
                            </c:forEach>
        ...
        <script src="${homePath}/gwTrans/consultas/js/consulta-motoristas.js?v=${random.nextInt()}"></script>
...
//            nome, src, acao
            var menuImprimir = {
                nome: "Imprimir",
                src: "${homePath}/assets/img/icones/print.png",
                acao: "popRel(this)"
            };
            addItemMenuGrid(menuImprimir);
            ...
            var menuFoto3x4 = {
                nome: "Anexar Foto 3x4",
                src: "${homePath}/assets/img/icones/anexar.png",
                acao: "anexarFoto3x4(this)"
            };
            addItemMenuGrid(menuFoto3x4);
            ...
            jQuery(document).ready(function () {
                jQuery('#select-tipo-motorista').selectGrupoMultiploGw({
                    input: 'select-tipo-motorista',
                    grupos: {
                        Bloqueado: {
                            1: 'Bloqueado!!bloqueado!!Sim!!IGUAL',
                            2: 'Não Bloqueado!!bloqueado!!Não!!IGUAL'
                        },
                        Desligado: {
                            1: 'Desligado!!desligado!!Sim!!IGUAL',
                            2: 'Não Desligado!!desligado!!Não!!IGUAL'
                        },
                        MOPE: {
                            1: 'Com curso MOPE!!curso_mope!!Sim!!IGUAL',
                            2: 'Sem curso MOPE!!curso_mope!!Não!!IGUAL'
                        },
                        Tipo: {
                            1: 'Funcionário!!tipo_motorista!!Funcionário!!IGUAL',
                            2: 'Agregado!!tipo_motorista!!Agregado!!IGUAL',
                            3: 'Carreteiro!!tipo_motorista!!Carreteiro!!IGUAL'
                        }
                    }
                });

                jQuery('#select-exceto-apenas-tipo-motorista').selectExcetoApenasGw({
                    width: '170px'
                });
            ...
            <c:if test="${pref != null}">
                ...
                gerenciarMostrarMotorista('${filtros.colunaNome}', '${filtros.colunaValor}', '${filtros.colunaCondicaoLocalizar}', '${filtros.descricao}');
                gerenciarInpCidade('${filtros.colunaNome}', '${filtros.colunaValor}', '${filtros.descricao}', '${filtros.colunaCondicaoLocalizar}');
                gerenciarInpVeiculos('${filtros.colunaNome}', '${filtros.colunaValor}', '${filtros.descricao}', '${filtros.colunaCondicaoLocalizar}');
                gerenciarInpTipoVeiculo('${filtros.colunaNome}', '${filtros.colunaValor}', '${filtros.descricao}', '${filtros.colunaCondicaoLocalizar}');
            ...
            <c:if test="${filtroEscolhido != null}">
                ...
                setTimeout(function () {
                    ...
                    jQuery(jQuery('.localiza')[1]).html('<iframe id="localizarVeiculoGeral" input="inptVeiculo" name="localizarVeiculoGeral" src="LocalizarControlador?acao=abrirLocalizar&idLocalizar=localizarVeiculoGeral&tema=${tema}" frameborder="0" marginheight="0" marginwidth="0" scrolling="no" ></iframe>');
                    jQuery(jQuery('.localiza')[2]).html('<iframe id="localizarTipoVeiculo" input="inptTipoVeiculo" name="localizarTipoVeiculo" src="LocalizarControlador?acao=abrirLocalizar&idLocalizar=localizarTipoVeiculo&tema=${tema}" frameborder="0" marginheight="0" marginwidth="0" scrolling="no" ></iframe>');
                    jQuery(jQuery('.localiza')[3]).html('<iframe id="localizarCliente" input="inptCliente" name="localizarCliente" src="LocalizarControlador?acao=abrirLocalizar&tipoLocalizar=localizarCliente&idLocalizar=localizarCliente&tema=${tema}" frameborder="0" marginheight="0" marginwidth="0" scrolling="no" ></iframe>');
                }, 1);
