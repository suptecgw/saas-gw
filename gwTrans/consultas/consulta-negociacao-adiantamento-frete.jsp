...
<html>
    ...
    <head>
        ...
        <title>GW Trans - Consulta de Negociação de Adiantamento de Frete</title>
        ...
        <link href="${homePath}/gwTrans/consultas/css/consulta-negociacao-adiantamento-frete.css?v=${random.nextInt()}" rel="stylesheet" type="text/css"/>
        <script defer src="${homePath}/script/validarSessao.js?v=${random.nextInt()}" type="text/javascript"></script>
        <script defer>
            var codigoTela = 'T00046';
            var codigo_tela = 46;
            var idPreferencia = 0;
    ...
    <body>
        ...
        <div id="topo">
            <div id="logo">
                <h3>Consulta de Negociação de Adiantamento de Frete<img src="${homePath}/assets/img/trans_white.png"></h3>
            </div>
            <div id="actions">
                    ...
                    <c:if test="${nivelUser >= 3}">
                        <li>
                            <span class="bt bt-cadastro" onclick="checkSession(function () {
                                        btnCadastrar('NegociacaoAdiantamentoFreteControlador?acao=novoCadastro');
                                    }, false);">Nova Negociação</span>
                        </li>
                    </c:if>
                </ul>
        ...
        <div id="sidebar" class="heightDoc">
            <div class="columnLeft" id="columnLeft">
                ...
                <div class="content">
                    <form action="ConsultaControlador?codTela=46" method="POST" id="formConsulta" name="formConsulta">
                        <div class="item_form">
            ...
            <input type="hidden" name="inp-auditoria" data-exclusao="true" data-rotina-auditoria="negociacaoAdiantamento">
        </div>
        ...
        <script src="${homePath}/gwTrans/consultas/js/consulta-negociacao-adiantamento-frete.js?v=${random.nextInt()}"></script>
