...
<html>
    ...
    <head>
        ...
        <title>GW Trans - Consulta de Cidades</title>
        ...
        <link href="${homePath}/gwTrans/consultas/css/consulta-cidades.css?v=${random.nextInt()}" rel="stylesheet" type="text/css"/>
        ...
        <script defer>
            var codigoTela = 'T00064';
            var codigo_tela = '64';
            var codigo_tela_cadastro = '102';
            var idPreferencia = 0;
    ...
    <body>
        ...
        <div id="topo">
            <div id="logo">
                <h3>Consulta de Cidades <img src="${homePath}/assets/img/trans_white.png"></h3>
            </div>
            <div id="actions">
                ...
                <ul>
                    <c:if test="${nivelUser >= 3}">
                        <li>
                            <div class="bt bt-cadastro"  onclick="javascript:checkSession(function(){cadastrarCidade();},false);">Novo cadastro</div>
                        </li>
                    </c:if>
                </ul>
        ...
        <div id="sidebar" class="heightDoc">
            <div class="columnLeft" id="columnLeft">
                ...
                <div class="content">
                    <form action="ConsultaControlador?codTela=64" method="POST" id="formConsulta" name="formConsulta">
                        <div class="item_form">
                        ...
                        <div id="filtros-adicionais-container" style="display: none;">
                            ...
                            <div class="item_form" style="margin-bottom: 10px;">
                                <select id="select-exceto-apenas-areas" name="select-exceto-apenas-areas">
                                    <option value="apenas">Apenas as areas</option>
                                    <option value="exceto">Exceto as areas</option>
                                </select>
            ...
            <input type="hidden" name="inp-auditoria" data-exclusao="true" data-rotina-auditoria="cidade">
        </div>
                ...
                <div class="footerTable">
                    <div class="item_form">
                        <c:if test="${nivelUser >= 4}">
                            <button id="removeCte" class="removeCteOff" disabled="true" onclick="checkSession(function(){excluir();}, false);">
        ...
        <script src="${homePath}/gwTrans/consultas/js/consulta-cidades.js?v=${random.nextInt()}"></script>
        ...
        <script defer type='text/javascript' lang="JavaScript">
            ...
            <c:if test="${filtroEscolhido != null}">
                                    ...
                                    setTimeout(function () {
                                        ...
                                        jQuery(jQuery('.localiza')[0]).html('<iframe id="localizarArea" input="inptArea" name="localizarArea" src="LocalizarControlador?acao=abrirLocalizar&idLocalizar=localizarArea&tema=${tema}" frameborder="0" marginheight="0" marginwidth="0" scrolling="no" ></iframe>');
                                    }, 1);
