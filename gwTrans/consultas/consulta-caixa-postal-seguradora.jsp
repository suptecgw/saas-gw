...
<head>
    ...
    <title>GW Trans - Consulta de Caixas Postais de Seguradoras</title>
    ...
    <link href="${homePath}/gwTrans/consultas/css/consulta-caixa-postal-seguradora.css?v=${random.nextInt()}" rel="stylesheet"
          type="text/css"/>
    <script defer src="${homePath}/script/validarSessao.js?v=${random.nextInt()}" type="text/javascript"></script>
    <script defer>
        var codigoTela = 'T00098';
        var codigo_tela = 98;
        var codigo_tela_cadastro = 99;
        var idPreferencia = 0;
...
<div id="topo">
    <div id="logo">
        <h3>Consulta de Caixas Postais de Seguradoras<img src="${homePath}/assets/img/trans_white.png"></h3>
    </div>
    <div id="actions">
        ...
        <ul>
            <c:if test="${nivelUser >= 3}">
                <li>
                    <span class="bt bt-cadastro">Nova caixa postal de seguradora</span>
                </li>
            </c:if>
        </ul>
    </div>
...
<div id="sidebar" class="heightDoc">
    <div class="columnLeft" id="columnLeft">
        ...
        <div class="content">
            <form action="ConsultaControlador?codTela=98" method="POST" id="formConsulta" name="formConsulta">
                <div class="item_form">
    ...
    <div class="columnLeft column-left-ajuda" id="columnLeftAjuda"
         style="z-index: 999;position: absolute;background-color:#375471;width:0px;">
        <div class="content">
    ...
    <input type="hidden" name="inp-auditoria" data-exclusao="true" data-rotina-auditoria="caixa_postal_seguradora">
</div>
...
<script src="${homePath}/gwTrans/consultas/js/consulta-caixa-postal-seguradora.js?v=${random.nextInt()}"></script>
