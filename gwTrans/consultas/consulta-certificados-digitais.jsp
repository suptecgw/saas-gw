...
<head>
    ...
    <title>GW Trans - Consulta de Certificados Digitais</title>
    ...
    <script defer src="${homePath}/gwTrans/localizar/js/LocalizarControladorJS.js?v=${random.nextInt()}"
            type="text/javascript"></script>
    <link href="${homePath}/gwTrans/consultas/css/consulta-certificados-digitais.css?v=${random.nextInt()}"
          rel="stylesheet" type="text/css"/>
    <script defer src="${homePath}/script/validarSessao.js?v=${random.nextInt()}" type="text/javascript"></script>
    <script defer>
        var codigoTela = 'T00129';
        var codigo_tela = '129';
        var codigo_tela_cadastro = '130';
        var idPreferencia = 0;
        var nivelUser = ${nivelUser};
        var homePath = '${homePath}';
        let certificadoAtualizado = '${certificadoAtualizado}';
...
<div id="topo">
    <div id="logo">
        <h3>Consulta de Certificados Digitais <img src="${homePath}/assets/img/trans_white.png"></h3>
    </div>
    <div id="actions">
        ...
        <ul>
            <c:if test="${nivelUser >= 3}">
                <li>
                    <span class="bt bt-cadastro">Novo Certificado Digital</span>
                </li>
            </c:if>
        </ul>
    </div>
...
<div id="sidebar" class="heightDoc">
    <div class="columnLeft" id="columnLeft">
        ...
        <div class="content">
            <form action="ConsultaControlador?codTela=129" method="POST" id="formConsulta" name="formConsulta">
                <div class="item_form">
                ...
                <div class="item_form container-data">
                    <div class="item_form_half1">
                        <input class="easyui-datebox" id="dataDe" name="dataDe" value="${dataAtual}"
                               style="width:100%;height:32px">
                    </div>
                    <div class="item_form_half2">
                        <input class="easyui-datebox" id="dataAte" name="dataAte" value="${dataAtual}"
                               style="width:100%;height:32px">
                    </div>
                </div>
    ...
    <input type="hidden" name="inp-auditoria" data-exclusao="true" data-rotina-auditoria="certificados_digitais">
</div>
            ...
            <div class="item_form">
                <c:if test="${nivelUser >= 4}">
                    <button id="removeCte" class="removeCteOff" disabled="true" onclick="checkSession(function () {
                        ...
                        <img src="${homePath}/assets/img/icon-remove-off.png">Excluir selecionados
                    </button>
                </c:if>
            </div>
        </div>
...
<script src="${homePath}/gwTrans/consultas/js/consulta-certificados-digitais.js?v=${random.nextInt()}"></script>
