...
function excluir(item) {
    ...
    var texto = "";
    if (index > 1) {
        texto = "Deseja excluir os Inventários abaixo?";
    } else {
        texto = "Deseja excluir o Inventário abaixo?";
    }
...
function mostrarImprimirInventario(index) {
    ...
    chamarConfirm('Deseja imprimir o relatório para o inventário ' + numeroInventario + "?", 'imprimir(' + idInventario + ')');
}
...
function imprimirInventarios() {
    ...
    if (ids == undefined || ids == "") {
        chamarAlert("Selecione pelo menos um Inventário!");
        return null;
    }
    imprimir(ids);
}
