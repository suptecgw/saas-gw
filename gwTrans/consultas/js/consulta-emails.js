...
function editar(position) {
        ...
        location.replace("EmailControlador?acao=carregar&id=" + id);
}
...
function excluir(item) {
    ...
    var nomes = '';
        ...
        chamarConfirm(texto, 'aceitouExcluirEmail("' + ids + '")', '', 1, '<ul class="square">' + nomes + '</ul>');
    
}

function aceitouExcluirEmail(ids) {
    jQuery.ajax({
        url: 'EmailControlador?acao=excluir&ids=' + ids,
