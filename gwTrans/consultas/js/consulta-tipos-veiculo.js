...
function editar(position) {
    ...
    location.replace("cadtipo_veiculos.jsp?acao=editar&id=" + id);
}
...
function excluir(item) {
    ...
    var texto = "";
    if (index > 1) {
        texto = "Deseja excluir os tipos de veículo abaixo?";
    } else {
        texto = "Deseja excluir o tipo de veículo abaixo?";
    }
...
function aceitouExcluirTipo(ids) {
    jQuery.ajax({
        url: 'TipoVeiculoControlador?acao=excluir&ids=' + ids,
