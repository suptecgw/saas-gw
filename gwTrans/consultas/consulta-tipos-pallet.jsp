<%-- 
    Document   : consulta-tipos-pallet
    Created on : 26/01/2017, 09:11:45
...
<html>
    ...
    <head>
        ...
        <title>GW Trans - Consulta de Tipos de Pallet</title>
        ...
        <link href="${homePath}/gwTrans/consultas/css/consulta-tipos-pallet.css?v=${random.nextInt()}" rel="stylesheet" type="text/css"/>
        <script defer src="${homePath}/script/validarSessao.js?v=${random.nextInt()}" type="text/javascript"></script>
        <script defer>
            var codigoTela = 'T00035';
            var codigo_tela = 35;
            var idPreferencia = 0;
    ...
    <body>
        ...
        <div id="topo">
            <div id="logo">
                <h3>Consulta de Tipos de Pallet<img src="${homePath}/assets/img/trans_white.png"></h3>
            </div>
            <div id="actions">
                    ...
                    <c:if test="${nivelUser >= 3}">
                        <li>
                            <span class="bt bt-cadastro" onclick="checkSession(function () {
                                        btnCadastrar('TipoPalletControlador?acao=novoCadastro');
                                    }, false);">Novo Tipo</span>
                        </li>
                    </c:if>
                    <li>
                        <span class="bt bt-relatorio" onclick="checkSession(function () {
                                    abrirPopConsulta('./reltipopallet.jsp?acao=iniciar&modulo=webtrans');
        ...
        <div id="sidebar" class="heightDoc">
            <div class="columnLeft" id="columnLeft">
                ...
                <div class="content">
                    <form action="ConsultaControlador?codTela=35" method="POST" id="formConsulta" name="formConsulta">
                        <div class="item_form">
            ...
            <input type="hidden" name="inp-auditoria" data-exclusao="true" data-rotina-auditoria="tipo_pallet">
        </div>
        ...
        <script src="${homePath}/gwTrans/consultas/js/consulta-tipos-pallet.js?v=${random.nextInt()}"></script>
