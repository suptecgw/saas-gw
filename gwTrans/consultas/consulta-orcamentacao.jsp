...
<html>
    ...
    <head>
        ...
        <title>GW Trans - Consulta de Orçamentação</title>
        ...
        <link href="${homePath}/gwTrans/consultas/css/consulta-orcamentacao.css?v=${random.nextInt()}" rel="stylesheet" type="text/css"/>
        ...
        <script defer>
            var codigoTela = 'T00124';
            var codigo_tela = '124';
            var codigo_tela_cadastro = 125;
            var idPreferencia = 0;
    ...
    <body>
        ...
        <div id="topo">
            <div id="logo">
                <h3>Consulta de Orçamentação <img src="${homePath}/assets/img/trans_white.png"></h3>
            </div>
            <div id="actions">
                ...
                <ul>
                    <c:if test="${nivelUser > 2}">
                        <li>
                            <span class="bt bt-cadastro">Nova Orçamentação</span>
                        </li>
                    </c:if>
                </ul>
            </div>
        ...
        <div id="sidebar" class="heightDoc">
            <div class="columnLeft" id="columnLeft">
                ...
                <div class="content">
                    <form action="ConsultaControlador?codTela=124" method="POST" id="formConsulta" name="formConsulta">
                        <div class="item_form">
                        ...
                        <div class="item_form container-data" style="">
                            <div class="item_form_half1">
                                <input class="input" id="competenciaDe" name="competenciaDe" value="${dataAtual}" style="width:80%;height:16px">
                            </div>
                            <div class="item_form_half2">
                                <input class="input" id="competenciaAte" name="competenciaAte" value="${dataAtual}" style="width:80%;height:16px">
                            </div>
                        </div>
                    ...
                    <div class="centerContent">
                        <input type="button" value="Pesquisar" class="searchButton" id="searchOrcamento" onclick="checkSession(function () {
                                        consulta();
                                    }, false);">
                    </div>
            ...
            <input type="hidden" name="inp-auditoria" data-exclusao="true" data-rotina-auditoria="orcamentacao">
        </div>
        ...
        <script src="${homePath}/gwTrans/consultas/js/consulta-orcamentacao.js?v=${random.nextInt()}"></script>
        ...
        <script defer type='text/javascript' lang="JavaScript">
                            ...
                            var tema = '${tema}';
                                ...
                                jQuery(document).ready(function () {
                                    ...
                                    jQuery('#competenciaDe').bind('focusout', function (e) {
                                        completarCompetencia(this, e);
                                    });
                                    jQuery('#competenciaAte').bind('focusout', function (e) {
                                        completarCompetencia(this, e);
                                    });                                    
                                    jQuery('#competenciaDe').bind('keypress', function (e) {
                                        mascaraCompetencia(this);
                                    });
                                    jQuery('#competenciaAte').bind('keypress', function (e) {
                                        mascaraCompetencia(this);
                                    });
