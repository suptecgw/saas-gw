<%-- 
    Document   : consulta-layout-edi
    Created on : 30/04/2018, 08:36:00
    Author     : jomp16
--%>
...
<head>
    ...
    <title>GW Trans - Consulta de Layouts EDI</title>
    ...
    <link href="${homePath}/gwTrans/consultas/css/consulta-layout-edi.css?v=${random.nextInt()}" rel="stylesheet"
          type="text/css"/>
    <script defer src="${homePath}/script/validarSessao.js?v=${random.nextInt()}" type="text/javascript"></script>
    <script defer>
        var codigoTela = 'T00094';
        var codigo_tela = 94;
        var codigo_tela_cadastro = 95;
        var idPreferencia = 0;
...
<div id="topo">
    <div id="logo">
        <h3>Consulta de Layouts EDI<img src="${homePath}/assets/img/trans_white.png"></h3>
    </div>
    <div id="actions">
        ...
        <ul>
            <c:if test="${nivelUser >= 3}">
                <li>
                    <span class="bt bt-cadastro">Novo layout EDI</span>
                </li>
            </c:if>
        </ul>
    </div>
...
<div id="sidebar" class="heightDoc">
    <div class="columnLeft" id="columnLeft">
        ...
        <div class="content">
            <form action="ConsultaControlador?codTela=94" method="POST" id="formConsulta" name="formConsulta">
                <div class="item_form">
                    ...
                    <select class="input" id="select-pesquisa" name="select-pesquisa" onchange="">
                        ...
                        <c:forEach var="listPrefPerso" items="${listaPreferenciasPersonalizadas}"
                                   varStatus="filtrosStatus">
                ...
                <div class="item_form div-ordenacao">
                    ...
                    <div id="filtros-adicionais-container" style="display: none;">
                        ...
                        <div class="item_form">
                            <label style="margin-left: 5px;font-weight: bold;">Mostrar Layouts</label>
                            <label for="todos" class="radio" style="width: auto;margin-right: 5px;font-weight: normal;color: #fff;"><input type="radio" name="mostrarLayoutsEDI" value="todos" id="todos" checked> Todos</label>
                            <label for="conemb" class="radio" style="width: auto;margin-right: 5px;font-weight: normal;color: #fff;"><input type="radio" name="mostrarLayoutsEDI" value="c" id="conemb"> CONEMB</label>
                            <label for="doccob" class="radio" style="width: auto;margin-right: 5px;font-weight: normal;color: #fff;"><input type="radio" name="mostrarLayoutsEDI" value="f" id="doccob"> DOCCOB</label>
                            <label for="ocoren" class="radio" style="width: auto;margin-right: 5px;font-weight: normal;color: #fff;"><input type="radio" name="mostrarLayoutsEDI" value="o" id="ocoren"> OCOREN</label>
                        </div>
                    </div>
                </div>
                <div class="item_form" id="filtros-adicionais">
                    <span class="seta-exibir-filtros-adicionais"></span>
                    <a href="#" id="toogle_options_details">Exibir filtros adicionais</a>
                </div>
            </form>
    ...
    <div class="columnRight">
        ...
        <button type="button" data-name="show" id="toggle" name="toggleAuditoria"
                style="margin-top: 115px !important;min-width: 170px !important;width:170px !important;border-radius: 5px !important;margin-left: -82px !important;"
                class="toggle">Exibir Auditoria
        </button>
    </div>
    <style>#columnLeftAjuda::-webkit-scrollbar {
        display: none;
    ...
    <div class="columnLeft column-left-ajuda " id="columnLeftAjuda"
         style="z-index: 999;position: absolute;width:0px;">
        <div class="content">
            <form action="${homePath}/InventarioControlador?acao=listarInventario">
    ...
    <input type="hidden" name="inp-auditoria" data-exclusao="true" data-rotina-auditoria="layout_edi">
</div>
        ...
        <div class="footerTable">
            <div class="item_form">
                <c:if test="${nivelUser >= 4}">
                    <button id="removeCte" class="removeCteOff" disabled="true"
                            onclick="checkSession(function(){excluir();}, false);">
                        <img src="${homePath}/assets/img/icon-remove-off.png">Excluir selecionadas
                    </button>
                </c:if>
            </div>
        </div>
    ...
    jQuery(document).ready(function () {
        ...
        <c:if test="${pref != null}">
            ...
            <c:forEach var="filtros" items="${pref.filtros}" varStatus="filtrosStatus" >
                ...
                gerenciarRadioTipoLayoutEDI('${filtros.colunaNome}', '${filtros.colunaValor}');
            </c:forEach>
        </c:if>
...
<script src="${homePath}/gwTrans/consultas/js/consulta-layout-edi.js?v=${random.nextInt()}"></script>
