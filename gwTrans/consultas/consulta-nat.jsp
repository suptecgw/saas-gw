<%-- 
    Document   : consulta-nat
    Created on : 19/04/2018, 12:00:00
...
<html>
    ...
    <head>
        ...
        <title>GW Trans - Consulta de NAT</title>
        ...
        <link href="${homePath}/gwTrans/consultas/css/consulta-nat.css?v=${random.nextInt()}" rel="stylesheet" type="text/css"/>
        <script defer src="${homePath}/script/validarSessao.js?v=${random.nextInt()}" type="text/javascript"></script>
        <script defer>
            var codigoTela = 'T00082';
            var codigo_tela = 82;
            var codigo_tela_cadastro = 83;
            var idPreferencia = 0;
    ...
    <body>
        ...
        <div id="topo">
            <div id="logo">
                <h3>Consulta de NAT<img src="${homePath}/assets/img/trans_white.png"></h3>
            </div>
            <div id="actions">
                ...
                <ul>
                    <c:if test="${nivelUser >= 3}">
                        <li>
                            <div class="bt bt-cadastro" onclick="javascript:checkSession(function(){cadastrarNAT();},false);">Novo Cadastro</div>
                        </li>
                    </c:if>
                </ul>
        ...
        <div id="sidebar" class="heightDoc">
            <div class="columnLeft" id="columnLeft">
                ...
                <div class="content">
                    <form action="ConsultaControlador?codTela=82" method="POST" id="formConsulta" name="formConsulta">
                        <div class="item_form">
            ...
            <div class="columnLeft column-left-ajuda" id="columnLeftAjuda" style="z-index: 999;position: absolute;width:0px;">
                <div class="content">
                    <form action="${homePath}/NATControlador?acao=listarNAT">
            ...
            <input type="hidden" name="inp-auditoria" data-exclusao="true" data-rotina-auditoria="Nat">
        </div>
        ...
        <script src="${homePath}/gwTrans/consultas/js/consulta-nat.js?v=${random.nextInt()}"></script>
