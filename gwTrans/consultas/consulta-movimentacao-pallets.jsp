...
<html>
    ...
    <head>
        ...
        <title>GW Trans - Consulta Movimentação Pallets</title>
        ...
        <link href="${homePath}/gwTrans/consultas/css/consulta-movimentacao-pallets.css?v=${random.nextInt()}" rel="stylesheet" type="text/css"/>
        <script defer src="${homePath}/script/validarSessao.js?v=${random.nextInt()}" type="text/javascript"></script>
        <script defer>
            var codigoTela = 'T00126';
            var codigo_tela = '126';
            var codigo_tela_cadastro = '128';
            var idPreferencia = 0;
    ...
    <body>
        ...
        <div id="topo">
            <div id="logo">
                <h3>Consulta Movimentação Pallets <img src="${homePath}/assets/img/trans_white.png"></h3>
            </div>
            <div id="actions">
                ...
                <ul>
                    <c:if test="${nivelUser >= 3}">
                        <li>
                            <div class="bt bt-cadastro"  onclick="javascript:checkSession(function () {
                                        cadastrarMovimentacaoPallets();
                                    }, false);">Novo cadastro</div>
                        </li>
                    </c:if>
                </ul>
            </div>
        ...
        <div id="sidebar" class="heightDoc">
            <div class="columnLeft" id="columnLeft">
                ...
                <div class="content">
                    <form action="ConsultaControlador?codTela=126" method="POST" id="formConsulta" name="formConsulta">
                        <div class="item_form">
                        ...
                        <div class="item_form div-ordenacao">
                            ...
                            <div id="filtros-adicionais-container" style="display: none;">    
                                ...
                                <div class="item_form" style="margin-bottom: 50px;margin-top: 10px;">
                                    <select id="select-exceto-apenas-tipo" name="select-exceto-apenas-tipo">
                                ...
                                <div class="item_form" style="margin-bottom: 50px;margin-top: 10px;">
                                    <select id="select-exceto-apenas-confirmados" name="select-exceto-apenas-confirmados">
                                        <option value="apenas">Apenas os Confirmados</option>
                                        <option value="exceto">Exceto os Confirmados</option>
                                    </select>
                                    <select id="select-confirmados" name="select-confirmados">
                                    </select>
                                </div>
                                ...
                                <div class="item_form filtroCliente" style="margin-bottom: 10px;">
                                    ...
                                    <div style="width: 70%;float: left;" class="inptCliente">
                                        <input class="input" type="text" id="inptCliente" name="inptCliente" readonly="true" placeholder="">
                                    </div>
                                    <div class="btns">
                                        <a href="javascript:" onclick="checkSession(function () {
                                                    removerValorInput('inptCliente', true);
                                                }, false);" class="btnDelete btnDeleteCliente" style="margin-top: 2px;"></a>
                                        <a href="javascript:checkSession(function(){controlador.acao('abrirLocalizar','localizarCliente');},false);" class="btnMore btnMoreFilial" style="float: right !important;margin-right: 5px;"></a>
                                    </div>
                                </div>

                                <div class="item_form filtroTipoPalete" style="margin-bottom: 10px;">
                                    <select id="select-exceto-apenas-tipo-pallet" name="select-exceto-apenas-tipo-pallet">
                                        <option value="apenas">Apenas os Tipos de Pallet</option>
                                        <option value="exceto">Exceto os Tipos de Pallet</option>
                                    </select>
                                    <div style="width: 70%;float: left;" class="inputTipoPallet">
                                        <input class="input" type="text" id="inputTipoPallet" name="inputTipoPallet" readonly="true" placeholder="">
                                    </div>
                                    <div class="btns">
                                        <a href="javascript:" onclick="checkSession(function () {
                                                    removerValorInput('inputTipoPallet', true);
                                                }, false);" class="btnDelete btnDeleteCliente" style="margin-top: 2px;"></a>
                                        <a href="javascript:checkSession(function(){controlador.acao('abrirLocalizar','localizarTipoPallet');},false);" class="btnMore btnMoreFilial" style="float: right !important;margin-right: 5px;"></a>
                                    </div>
                                </div>
                            </div>
            ...
            <input type="hidden" name="inp-auditoria" data-exclusao="true" data-rotina-auditoria="movimentacao_pallets">
        </div>
        ...
        <div class="localiza">
            <iframe id="localizarFilial" input="inptFilial" name="localizarFilial" src="${homePath}/LocalizarControlador?acao=abrirLocalizar&idLocalizar=localizarFilial&tema=${tema}" frameborder="0" marginheight="0" marginwidth="0" scrolling="no" ></iframe>
        </div>
        <div class="localiza"> 
            <iframe id="localizarCliente" input="inptCliente" name="localizarCliente" src="${homePath}/LocalizarControlador?acao=abrirLocalizar&idLocalizar=localizarCliente&tema=${tema}" frameborder="0" marginheight="0" marginwidth="0" scrolling="no" ></iframe>
        </div>
        <div class="localiza"> 
            <iframe id="localizarTipoPallet" input="inputTipoPallet" name="localizarTipoPallet" src="${homePath}/LocalizarControlador?acao=abrirLocalizar&idLocalizar=localizarTipoPallet&tema=${tema}" frameborder="0" marginheight="0" marginwidth="0" scrolling="no" ></iframe>
        </div>
        ...
        <script src="${homePath}/gwTrans/consultas/js/consulta-movimentacao-pallets.js?v=${random.nextInt()}"></script>
            ...
            <c:if test="${pref != null}">
                ...
                <c:forEach var="filtros" items="${pref.filtros}" varStatus="filtrosStatus" >
                    <c:if test="${filtrosStatus.count == 1}">
                                    ...
                                    gerenciarInpLocalizar('${filtros.colunaNome}', '${filtros.colunaValor}', '${filtros.descricao}', '${filtros.colunaCondicaoLocalizar}');
                                    gerenciarApenasFiltro('${filtros.colunaNome}', '${filtros.colunaValor}', '${filtros.colunaCondicaoLocalizar}', '${filtros.descricao}');
