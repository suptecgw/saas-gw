...
<html>
    ...
    <head>
        ...
        <title>GW Trans - Consulta de Histórico</title>
        ...
        <link href="${homePath}/gwTrans/consultas/css/consulta-historico.css?v=${random.nextInt()}" rel="stylesheet" type="text/css"/>
        <script defer src="${homePath}/script/validarSessao.js?v=${random.nextInt()}" type="text/javascript"></script>
        <script defer>
            var codigoTela = 'T00015';
            var codigo_tela = 15;
            var idPreferencia = 0;
    ...
    <body>
        ...
        <div id="topo">
            <div id="logo">
                <h3>Consulta de Histórico<img src="${homePath}/assets/img/trans_white.png"></h3>
            </div>
            <div id="actions">
                ...
                <ul>
                    <c:if test="${nivelUser >= 3}">
                        <li>
                            <div class="bt bt-cadastro"  onclick="javascript:checkSession(function(){cadastrarHistorico();},false);">Novo Histórico</div>
                        </li>
                    </c:if>

                    <li>
                        <div class="bt bt-relatorio"  onclick="javascript:checkSession(function(){relatorioHistorico();},false);">Relatório</div>
                    </li>
                </ul>
        ...
        <div id="sidebar" class="heightDoc">
            <div class="columnLeft" id="columnLeft">
                ...
                <div class="content">
                    <form action="ConsultaControlador?codTela=15" method="POST" id="formConsulta" name="formConsulta">
                        <div class="item_form">
            ...
            <input type="hidden" name="inp-auditoria" data-exclusao="true" data-rotina-auditoria="historico">
        </div>
...
<!--<script src="${homePath}/script/jquery-1.11.2.min.js" type="text/javascript"></script>-->
        ...
        <script src="${homePath}/gwTrans/consultas/js/consulta-historico.js?v=${random.nextInt()}"></script>
