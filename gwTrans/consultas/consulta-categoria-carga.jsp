<%-- 
    Document   : consulta-categoria-carga
    Created on : 14/09/2017, 14:05:50
...
<html>
    ...
    <head>
        ...
        <link href="${homePath}/gwTrans/consultas/css/consulta-categoria-carga.css?v=${random.nextInt()}" rel="stylesheet" type="text/css"/>
        <script defer src="${homePath}/script/validarSessao.js?v=${random.nextInt()}" type="text/javascript"></script>
        <script defer>
            var codigoTela = 'T00072';
            var codigo_tela = 72;
            var codigo_tela_cadastro = 76;
            var idPreferencia = 0;
    ...
    <body>
        ...
        <div id="topo">
            <div id="logo">
                <h3>Consulta de Categoria de Carga<img src="${homePath}/assets/img/trans_white.png"></h3>
            </div>
            <div id="actions">
                ...
                <ul>
                    <c:if test="${nivelUser >= 3}">
                        <li>
                            <span class="bt bt-cadastro">Nova Categoria de Carga</span>
                        </li>
                    </c:if>
        ...
        <div id="sidebar" class="heightDoc">
            <div class="columnLeft" id="columnLeft">
                ...
                <div class="content">
                    <form action="ConsultaControlador?codTela=72" method="POST" id="formConsulta" name="formConsulta">
                        <div class="item_form">
            ...
            <input type="hidden" name="inp-auditoria" data-exclusao="true" data-rotina-auditoria="categoria_carga">
        </div>
        ...
        <script src="${homePath}/gwTrans/consultas/js/consulta-categoria-carga.js?v=${random.nextInt()}"></script>
