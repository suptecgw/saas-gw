...
<html>
    ...
    <head>
        ...
        <title>GW Trans - Consulta de Caixa de Saída</title>
        ...
        <link href="${homePath}/gwTrans/consultas/css/consulta-caixa-saida.css?v=${random.nextInt()}" rel="stylesheet" type="text/css"/>
    ...
    <body>
        ...
        <div id="topo">
            <div id="logo">
                <h3>Consulta de Caixa de Saída <img src="${homePath}/assets/img/trans_white.png"></h3>
            </div>
            <div id="actions">
        ...
        <div id="sidebar" class="heightDoc">
            <div class="columnLeft" id="columnLeft">
                ...
                <div class="content">
                    <form action="ConsultaControlador?codTela=68" method="POST" id="formConsulta" name="formConsulta">
                        <div class="item_form">
                        ...
                        <div id="filtros-adicionais-container" style="display: none;">
                            ...
                            <div class="item_form" style="margin-bottom: 50px;margin-top: 10px;">
                                <select id="select-exceto-apenas-status-email" name="select-exceto-apenas-status-email">
                                    <option value="apenas">Apenas os Tipos</option>
                                    <option value="exceto">Exceto os Tipos</option>
                                </select>
                                <select id="select-tipo-email" name="select-tipo-email">
                                </select>
                            </div>
                        </div>
        ...
        <div id="map" class="heightDoc">
            <div id="contentMap" style="">
                ...
                <%@ include file="grid-caixa-saida.jsp" %>
                <script>
                    setTimeout(function () {
            ...
            <div id="footerTable">
                <div class="footerTable">
                    <div class="item_form">
                        <button id="removeCte" class="removeCteOff" onclick="checkSession(function () {enviarEmail();}, false);">
                            <img width="25px" height="20px" src="${homePath}/assets/img/email.png">Enviar E-mail</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <script src="${homePath}/gwTrans/consultas/js/consulta-caixa-saida.js?v=${random.nextInt()}"></script>
            ...
            <c:if test="${pref != null}">
                ...
                <c:forEach var="filtros" items="${pref.filtros}" varStatus="filtrosStatus" >
                    <c:if test="${filtrosStatus.count == 1}">
                                ...
                                gerenciarMostrarEmails('${filtros.colunaNome}', '${filtros.colunaValor}', '${filtros.colunaCondicaoLocalizar}', '${filtros.descricao}');
