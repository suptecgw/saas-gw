...
<head>
    ...
    <title>GW Trans - Consulta de CFOP</title>
    ...
    <link href="${homePath}/gwTrans/consultas/css/consulta-cfop.css?v=${random.nextInt()}" rel="stylesheet"
          type="text/css"/>
    <script defer src="${homePath}/script/validarSessao.js?v=${random.nextInt()}" type="text/javascript"></script>
    <script defer>
        var codigoTela = 'T00092';
        var codigo_tela = 92;
        var codigo_tela_cadastro = 91;
        var idPreferencia = 0;
...
<div id="topo">
    <div id="logo">
        <h3>Consulta de CFOP<img src="${homePath}/assets/img/trans_white.png"></h3>
    </div>
    <div id="actions">
        ...
        <ul>
            <c:if test="${nivelUser >= 3}">
                 <li>
                     <div class="bt bt-cadastro" onclick="javascript:checkSession(function(){cadastrarCfop();},false);">Novo Cadastro</div>
                 </li>
            </c:if>
        </ul>
    </div>
...
<div id="sidebar" class="heightDoc">
    <div class="columnLeft" id="columnLeft">
        ...
        <div class="content">
            <form action="ConsultaControlador?codTela=92" method="POST" id="formConsulta" name="formConsulta">
                <div class="item_form">
    ...
    <input type="hidden" name="inp-auditoria" data-exclusao="true" data-rotina-auditoria="cfop">
</div>
...
<script src="${homePath}/gwTrans/consultas/js/consulta-cfop.js?v=${random.nextInt()}"></script>
