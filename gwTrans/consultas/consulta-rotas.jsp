...
<html>
    ...
    <head>
        ...
        <title>GW Trans - Consulta de Rotas</title>
        ...
        <link href="${homePath}/gwTrans/consultas/css/consulta-rotas.css?v=${random.nextInt()}" rel="stylesheet" type="text/css"/>
    ...
    <body>
        ...
        <div id="topo">
            <div id="logo">
                <h3>Consulta de Rotas <img src="${homePath}/assets/img/trans_white.png"></h3>
            </div>
            <div id="actions">
                ...
                <ul>
                    <c:if test="${nivelUser >= 2}">
                        <li>
                            <div class="bt bt-cadastro"  onclick="javascript:checkSession(function(){cadastrarRota();},false);">Novo cadastro</div>
                        </li>
                    </c:if>

                    <li>
                        <div class="bt bt-relatorio"  onclick="javascript:checkSession(function(){relatorioRotas();},false);">Relatório</div>
                    </li>
                </ul>
        ...
        <div id="sidebar" class="heightDoc">
            <div class="columnLeft" id="columnLeft">
                ...
                <div class="content">
                    <form action="ConsultaControlador?codTela=47" method="POST" id="formConsulta" name="formConsulta">
                        <div class="item_form">
                        ...
                        <div id="filtros-adicionais-container" style="display: none;">
                            ...
                            <div class="item_form" style="margin-bottom: 50px;margin-top: 10px;">
                                <select id="select-exceto-apenas-tipo-rota" name="select-exceto-apenas-tipo-rota">
                                    <option value="apenas">Apenas os Tipos</option>
                                    <option value="exceto">Exceto os Tipos</option>
                                </select>
                                <select id="select-tipo-rota" name="select-tipo-rota">
                                </select>
                            </div>
                            <div class="item_form" style="margin-bottom: 10px;">
                                <select id="select-exceto-apenas-cidade" name="select-exceto-apenas-cidade">
                                    <option value="apenas">Apenas cidades de origem</option>
                                    <option value="exceto">Exceto cidades de origem</option>
                                </select>
                            ...
                            <div class="item_form" style="margin-bottom: 10px;">
                                <select id="select-exceto-apenas-areas" name="select-exceto-apenas-areas">
                                    <option value="apenas">Apenas áreas de destino</option>
                                    <option value="exceto">Exceto áreas de destino</option>
                                </select>
                                <div style="width: 70%;float: left;">
                                    <input class="input" type="text" id="inptArea" name="inptArea" readonly="true" placeholder="">
                                </div>
                                <div class="btns">
                                    <a href="javascript:" onclick="checkSession(function () {
                                                removerValorInput('inptArea', false);
                                            }, false);" class="btnDelete" style="margin-top: 2px;"></a>
                                    <a href="javascript:checkSession(function(){controlador.acao('abrirLocalizar','localizarArea');},false);" class="btnMore" style="float: right !important;margin-right: 5px;"></a>
                                    <!--<img src="${homePath}/assets/img/pesquisar_por.jpg" class="img-visualizar">-->
                                </div>
                            </div>
                            <div class="item_form" style="margin-bottom: 10px;">
                            ...
                            <div class="item_form" style="margin-bottom: 10px;">
                                <select id="select-exceto-apenas-tipo-produto" name="select-exceto-apenas-tipo-produto">
                                    <option value="apenas">Apenas os tipos de produtos</option>
                                    <option value="exceto">Exceto os tipos de produtos</option>
                                </select>
                                <div style="width: 70%;float: left;">
                                    <input class="input" type="text" id="inptTipoProduto" name="inptTipoProduto" readonly="true" placeholder="">
                                </div>
                                <div class="btns">
                                    <a href="javascript:" onclick="checkSession(function () {
                                                removerValorInput('inptTipoProduto', true);
                                            }, false);" class="btnDelete" style="margin-top: 2px;"></a>
                                    <a href="javascript:checkSession(function(){controlador.acao('abrirLocalizar','localizarTipoProduto');},false);" class="btnMore" style="float: right !important;margin-right: 5px;"></a>
                                    <!--<img src="${homePath}/assets/img/pesquisar_por.jpg" class="img-visualizar">-->
                                </div>
                            </div>
                        </div>
            ...
            <div class="columnLeft column-left-ajuda" id="columnLeftAjuda" style="z-index: 999;position: absolute;background-color:#375471;width:0px;">
                <div class="content">
            ...
            <input type="hidden" name="inp-auditoria" data-exclusao="true" data-rotina-auditoria="rota">
        </div>
        ...
        <script src="${homePath}/gwTrans/consultas/js/consulta-rotas.js?v=${random.nextInt()}"></script>
        ...
        <script defer type='text/javascript' lang="JavaScript">
            ...
            <c:if test="${pref != null}">
                ...
                gerenciarMostrarRotas('${filtros.colunaNome}', '${filtros.colunaValor}', '${filtros.colunaCondicaoLocalizar}', '${filtros.descricao}');
                gerenciarInpCidade('${filtros.colunaNome}', '${filtros.colunaValor}', '${filtros.descricao}', '${filtros.colunaCondicaoLocalizar}');
                gerenciarInpCidadeDes('${filtros.colunaNome}', '${filtros.colunaValor}', '${filtros.descricao}', '${filtros.colunaCondicaoLocalizar}');
                gerenciarInpArea('${filtros.colunaNome}', '${filtros.colunaValor}', '${filtros.descricao}', '${filtros.colunaCondicaoLocalizar}');
                gerenciarInpCliente('${filtros.colunaNome}', '${filtros.colunaValor}', '${filtros.descricao}', '${filtros.colunaCondicaoLocalizar}');
                gerenciarInpTipoProduto('${filtros.colunaNome}', '${filtros.colunaValor}', '${filtros.descricao}', '${filtros.colunaCondicaoLocalizar}');
            ...
            <c:if test="${filtroEscolhido != null}">
                ...
                setTimeout(function () {
                    ...
                    jQuery(jQuery('.localiza')[1]).html('<iframe id="localizarCidadeDestino" input="inptCidadeDes" name="localizarCidadeDestino" src="LocalizarControlador?acao=abrirLocalizar&idLocalizar=localizarCidadeDestino&tema=${tema}" frameborder="0" marginheight="0" marginwidth="0" scrolling="no" ></iframe>');
                    jQuery(jQuery('.localiza')[2]).html('<iframe id="localizarArea" input="inptArea" name="localizarArea" src="LocalizarControlador?acao=abrirLocalizar&idLocalizar=localizarArea&tema=${tema}" frameborder="0" marginheight="0" marginwidth="0" scrolling="no" ></iframe>');
                    ...
                    jQuery(jQuery('.localiza')[4]).html('<iframe id="localizarTipoProduto" input="inptTipoProduto" name="localizarTipoProduto" src="LocalizarControlador?acao=abrirLocalizar&idLocalizar=localizarTipoProduto&tema=${tema}" frameborder="0" marginheight="0" marginwidth="0" scrolling="no" ></iframe>');
                }, 1);
