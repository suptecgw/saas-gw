<%-- 
    Document   : consulta-funcoes
    Created on : 26/01/2017, 12:04:43
...
<html>
    ...
    <head>
        ...
        <title>GW Trans - Consulta de Ocorrencias</title>
        ...
        <link href="${homePath}/gwTrans/consultas/css/consulta-ocorrencias.css?v=${random.nextInt()}" rel="stylesheet" type="text/css"/>
    ...
    <body>
        ...
        <div id="topo">
            <div id="logo">
                <h3>Consulta de Ocorrencias<img src="${homePath}/assets/img/trans_white.png"></h3>
            </div>
            <div id="actions">
                    ...
                    <c:if test="${nivelUser >= 3}">
                        <li>
                            <span class="bt bt-cadastro" onclick="checkSession(function () {
                                        btnCadastrar('cadocorrencia.jsp?acao=iniciar');
                                    }, false);">Nova Ocorrencia</span>
                        </li>
                    </c:if>

                    <li>
                        <span class="bt bt-relatorio" onclick="checkSession(function () {
                                    abrirPopConsulta('./relocorrencia.jsp?acao=iniciar&modulo=webtrans');
                                }, false);">Relatório</span>
                    </li>

                    <c:if test="${tipoUtilizacaoGWMobile != 'N'}">
                        <li>
                            <span class="bt bt-mobile" onclick="checkSession(function () {
                                        sincronizarGWMobile();
                                    }, false);">Sincronizar Gw Mobile</span>
                        </li>
                    </c:if>
                </ul>
        ...
        <div id="sidebar" class="heightDoc">
            <div class="columnLeft" id="columnLeft">
                ...
                <div class="content">
                    <form action="ConsultaControlador?codTela=44" method="POST" id="formConsulta" name="formConsulta">
                        <div class="item_form">
                        ...
                        <div id="filtros-adicionais-container" style="display: none;">
                            <div class="item_form" style="float: left;box-shadow: 0px 0px 5px 2px rgba(0, 0, 0, 0.22);padding: 5px;margin-bottom: 10px;">
                                <label style="margin-left: 5px;font-weight: bold;">Tipo de Utilização</label>
                                <label for="coleta" style="width: auto;margin-right: 200px"><input type="checkbox" name="coleta" id="coleta">Coleta</label>
                                <label for="conhecimento" style="width: auto;margin-right: 160px"><input type="checkbox" name="conhecimento" id="conhecimento">Conhecimento</label>
                                <label for="contrato_frete" style="width: auto;margin-right: 5px"><input type="checkbox" name="contrato_frete" id="contrato_frete">Contrato de frete</label>
                            </div>
                        </div>
            ...
            <input type="hidden" name="inp-auditoria" data-exclusao="true" data-rotina-auditoria="ocorrencia_ctrcs">
        </div>
            ...
            <c:if test="${pref != null}">
                ...
                <c:forEach var="filtros" items="${pref.filtros}" varStatus="filtrosStatus" >
                    <c:if test="${filtrosStatus.count == 1}">
                                    ...
                                    gerenciarCheckBoxColeta('${filtros.colunaNome}', '${filtros.colunaValor}');
                                    gerenciarCheckBoxConhecimento('${filtros.colunaNome}', '${filtros.colunaValor}');
                                    gerenciarCheckBoxContratoFrete('${filtros.colunaNome}', '${filtros.colunaValor}');
        ...
        <script src="${homePath}/gwTrans/consultas/js/consulta-ocorrencias.js?v=${random.nextInt()}"></script>
