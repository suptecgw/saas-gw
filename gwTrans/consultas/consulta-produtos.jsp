...
<html>
    ...
    <head>
        ...
        <title>GW Trans - Consulta de Produtos</title>
        ...
        <link href="${homePath}/gwTrans/consultas/css/consulta-produtos.css?v=${random.nextInt()}" rel="stylesheet" type="text/css"/>
        <script defer src="${homePath}/script/validarSessao.js?v=${random.nextInt()}" type="text/javascript"></script>
        <script defer>
            var codigoTela = 'T00039';
            var codigo_tela = '39';
            var idPreferencia = 0;
    ...
    <body>
        ...
        <div id="topo">
            <div id="logo">
                <h3>Consulta de Produtos <img src="${homePath}/assets/img/trans_white.png"></h3>
            </div>
            <div id="actions">
                ...
                <ul>
                    <c:if test="${nivelUser >= 3}">
                        <li>
                            <div class="bt bt-cadastro"  onclick="javascript:checkSession(function(){cadastrarProduto();},false);">Novo cadastro</div>
                        </li>
                    </c:if>

                    <li>
                        <div class="bt bt-relatorio"  onclick="javascript:checkSession(function(){relatorioProduto();},false);">Relatório</div>
                    </li>
                </ul>
        ...
        <div id="sidebar" class="heightDoc">
            <div class="columnLeft" id="columnLeft">
                ...
                <div class="content">
                    <form action="ConsultaControlador?codTela=39" method="POST" id="formConsulta" name="formConsulta">
                        <div class="item_form">
            ...
            <input type="hidden" name="inp-auditoria" data-exclusao="true" data-rotina-auditoria="produto">
        </div>
        ...
        <script type='text/javascript' lang="JavaScript">
            ...
            <c:if test="${filtroEscolhido != null}">
                                    ...
                                    setTimeout(function () {
                                        jQuery('.container-salvar-filtros').html('<iframe id="iframeSalvarFiltros" name="iframeSalvarFiltros" src="${homePath}/gwTrans/consultas/salvar_filtros.jsp" frameborder="0" marginheight="0" marginwidth="0" scrolling="no" ></iframe><span class="seta-baixo"></span>');
                                        ...
                                        jQuery(jQuery('.localiza')[0]).html('<iframe id="localizarCliente" input="inptCliente" name="localizarCliente" src="LocalizarControlador?acao=abrirLocalizar&tipoLocalizar=localizarCliente&idLocalizar=localizarCliente&tema=${tema}" frameborder="0" marginheight="0" marginwidth="0" scrolling="no" ></iframe>');
                                        jQuery(jQuery('.localiza')[1]).html('<iframe id="localizarDestinatario" input="inptDestinatario" name="localizarDestinatario" src="LocalizarControlador?acao=abrirLocalizar&tipoLocalizar=localizarDestinatario&idLocalizar=localizarDestinatario&tema=${tema}" frameborder="0" marginheight="0" marginwidth="0" scrolling="no" ></iframe>');
                                    }, 1);
        ...
        <script src="${homePath}/gwTrans/consultas/js/consulta-produtos.js?v=${random.nextInt()}"></script>
