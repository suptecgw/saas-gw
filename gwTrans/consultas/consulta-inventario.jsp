...
<head>
    ...
    <title>GW Trans - Consulta de Inventário</title>
    ...
    <link href="${homePath}/gwTrans/consultas/css/consulta-inventario.css?v=${random.nextInt()}" rel="stylesheet"
          type="text/css"/>
    <script defer src="${homePath}/script/validarSessao.js?v=${random.nextInt()}" type="text/javascript"></script>
    <script defer>
        var codigoTela = 'T00085';
        var codigo_tela = 85;
        var codigo_tela_cadastro = 86;
        var idPreferencia = 0;
...
<div id="topo">
    <div id="logo">
        <h3>Consulta de Inventário<img src="${homePath}/assets/img/trans_white.png"></h3>
    </div>
    <div id="actions">
        ...
        <ul>
            <c:if test="${nivelUser >= 3}">
                <li>
                    <span class="bt bt-cadastro">Novo Inventário</span>
                </li>
            </c:if>
        </ul>
    </div>
...
<div id="sidebar" class="heightDoc">
    <div class="columnLeft" id="columnLeft">
        ...
        <div class="content">
            <form action="ConsultaControlador?codTela=85" method="POST" id="formConsulta" name="formConsulta">
                <div class="item_form">
    ...
    <input type="hidden" name="inp-auditoria" data-exclusao="true" data-rotina-auditoria="inventario">
</div>
<div id="map" class="heightDoc">
    ...
    <div id="footerTable">
        <div class="footerTableImpressao">
            ...
            <div class="footer02">
                <div class="bt bt-impressao" onclick="imprimirInventarios();" style="margin-top: 27px">Imprimir</div>
            </div>
        </div>
    </div>
</div>
...
<script defer type='text/javascript' lang="JavaScript">
    ...
    jQuery(document).ready(function () {
        ...
        var menuImprimir = {
            ...
            acao: "mostrarImprimirInventario(this)"
        };
...
<script src="${homePath}/gwTrans/consultas/js/consulta-inventario.js?v=${random.nextInt()}"></script>
