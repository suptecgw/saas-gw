        ...
        <div id="topo">
            ...
            <div id="actions">
                ...
                <ul>
                    ...
                    <li>
                        <div class="bt bt-relatorio"  onclick="javascript:checkSession(function(){relatorioFornecedor();},false);">Relatório</div>
                    </li>
                </ul>
                        ...
                        <div id="filtros-adicionais-container" style="display: none;">
                            ...
                            <div class="item_form" style="margin-bottom: 50px;margin-top: 10px;">
                                ...
                                <select id="select-tipo-fornecedor" name="select-tipo-fornecedor">
                                    ...
                                    <option value="is_companhia_aerea">Companhia Aérea</option>
                                    <option value="is_fornecedor_combustivel">Fornecedor de Combustível</option>
                                    <option value="is_agente_carga">Agente de carga</option>
                                    <option value="is_proprietario">Proprietário</option>
