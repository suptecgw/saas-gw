...
<html>
    ...
    <head>
        ...
        <title>GW Trans - Consulta de Grupo de Cliente / Fornecedor</title>
        ...
        <link href="${homePath}/gwTrans/consultas/css/consulta-grupo-cliente-fornecedor.css?v=${random.nextInt()}" rel="stylesheet" type="text/css"/>
        <script defer src="${homePath}/script/validarSessao.js?v=${random.nextInt()}" type="text/javascript"></script>
        <script defer>
            var codigoTela = 'T00016';
            var codigo_tela = 16;
            var idPreferencia = 0;
    ...
    <body>
        ...
        <div id="topo">
            <div id="logo">
                <h3>Consulta de Grupo Cliente/Fornecedor<img src="${homePath}/assets/img/trans_white.png"></h3>
            </div>
            <div id="actions">
                ...
                <ul>
                    <c:if test="${nivelUser >= 2}">
                        <li>
                            <div class="bt bt-cadastro"  onclick="javascript:checkSession(function(){cadastrarGrupoCliFor();},false);">Novo Grupo</div>
                        </li>
                    </c:if>

                    <li>
                        <div class="bt bt-relatorio"  onclick="javascript:checkSession(function(){relatorioGrupoCliFor();},false);">Relatório</div>
                    </li>
                </ul>
        ...
        <div id="sidebar" class="heightDoc">
            <div class="columnLeft" id="columnLeft">
                ...
                <div class="content">
                    <form action="ConsultaControlador?codTela=16" method="POST" id="formConsulta" name="formConsulta">
                        <div class="item_form">
                        ...
                        <div class="item_form div-filtro">
                            <label>Filtro</label>
                        ...
                        <div class="item_form container-campos-select div-order-filtro">
                        ...
                        <div class="item_form container-campos-select div-input-boxes">
                            ...
                            <input type="text" class="segundo-input-box" id="t">
                        </div>
                        <div class="item_form container-data">
                            <div class="item_form_half1">
                                <input class="easyui-datebox" id="dataDe" onchange="fmtDate(this, event);" onkeyup="fmtDate(this, event);" onkeydown="fmtDate(this, event);" onkeypress="fmtDate(this, event);" name="dataDe" value="${dataAtual}" style="width:100%;height:32px">
                            </div>
                            <div class="item_form_half2">
                                <input class="easyui-datebox" id="dataAte" onchange="fmtDate(this, event);" onkeyup="fmtDate(this, event);" onkeydown="fmtDate(this, event);" onkeypress="fmtDate(this, event);" name="dataAte" value="${dataAtual}" style="width:100%;height:32px">
                            </div>
                        </div>
            ...
            <input type="hidden" name="inp-auditoria" data-exclusao="true" data-rotina-auditoria="grupo_cli_for">
        </div>
        ...
        <script src="${homePath}/gwTrans/consultas/js/consulta-grupo-cliente-fornecedor.js?v=${random.nextInt()}"></script>
