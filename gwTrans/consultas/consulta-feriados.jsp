...
<html>
    ...
    <head>
        ...
        <title>GW Trans - Consulta de Feriado</title>
        ...
        <link href="${homePath}/gwTrans/consultas/css/consulta-feriados.css?v=${random.nextInt()}" rel="stylesheet" type="text/css"/>
        <script defer src="${homePath}/script/validarSessao.js?v=${random.nextInt()}" type="text/javascript"></script>
        <script defer>
            var codigoTela = 'T00096';
            var codigo_tela = 96;
            var codigo_tela_cadastro = 97;
            var idPreferencia = 0;
    ...
    <body>
        ...
        <div id="topo">
            <div id="logo">
                <h3>Consulta de Feriado<img src="${homePath}/assets/img/trans_white.png"></h3>
            </div>
            <div id="actions">
                ...
                <ul>
                    <c:if test="${nivelUser >= 3}">
                        <li>
                            <div class="bt bt-cadastro" onclick="javascript:checkSession(function(){cadastrarFeriado();},false);">Novo Cadastro</div>
                        </li>
                    </c:if>
                </ul>
        ...
        <div id="sidebar" class="heightDoc">
            <div class="columnLeft" id="columnLeft">
                ...
                <div class="content">
                    <form action="ConsultaControlador?codTela=96" method="POST" id="formConsulta" name="formConsulta">
                        <div class="item_form">
            ...
            <div class="columnLeft column-left-ajuda" id="columnLeftAjuda" style="z-index: 999;position: absolute;width:0px;">
                <div class="content">
                    <form action="${homePath}/FeriadoControlador?acao=listarFeriados">
            ...
            <input type="hidden" name="inp-auditoria" data-exclusao="true" data-rotina-auditoria="feriados">
        </div>
        ...
        <script src="${homePath}/gwTrans/consultas/js/consulta-feriados.js?v=${random.nextInt()}"></script>
