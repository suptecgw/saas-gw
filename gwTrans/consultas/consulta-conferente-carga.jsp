<%-- 
    Document   : consulta-conferente-carga
    Created on : 26/09/2017, 17:26:44
    Author     : estagiario-tarde
--%>
...
<html>
    ...
    <head>
        ...
        <title>GW Trans - Consulta de Categoria de Carga</title>
        ...
        <link href="${homePath}/gwTrans/consultas/css/consulta-conferente-carga.css?v=${random.nextInt()}" rel="stylesheet" type="text/css"/>
        <script defer src="${homePath}/script/validarSessao.js?v=${random.nextInt()}" type="text/javascript"></script>
        <script defer>
            var codigoTela = 'T00073';
            var codigo_tela = 73;
            var codigo_tela_cadastro = 77;
            var idPreferencia = 0;
    ...
    <body>
        ...
        <div id="topo">
            <div id="logo">
                <h3>Consulta de Conferente de Carga<img src="${homePath}/assets/img/trans_white.png"></h3>
            </div>
            <div id="actions">
                ...
                <ul>
                    <c:if test="${nivelUser >= 3}">
                        <li>
                            <span class="bt bt-cadastro">Novo Conferente de Carga</span>
                        </li>
                    </c:if>
        ...
        <div id="sidebar" class="heightDoc">
            <div class="columnLeft" id="columnLeft">
                ...
                <div class="content">
                    <form action="ConsultaControlador?codTela=73" method="POST" id="formConsulta" name="formConsulta">
                        <div class="item_form">
                            ...
                            <div class="item_form_half left">
                                <select class="input" id="select-ordenacao" name="select-ordenacao" onchange="">
                                    ...
                                    <c:forEach var="columnOrdenacaoSelect" items="${tela.targetXml.columnOrdenacaoSelect}" varStatus="rowStatus" >
                                        <option  id="item1" value="${columnOrdenacaoSelect.name}">${columnOrdenacaoSelect.label}</option>
                                    </c:forEach> 
                                </select>
                            </div>
            ...
            <input type="hidden" name="inp-auditoria" data-exclusao="true" data-rotina-auditoria="conferente">
        </div>
        ...
        <script src="${homePath}/gwTrans/consultas/js/consulta-conferente-carga.js?v=${random.nextInt()}"></script>
