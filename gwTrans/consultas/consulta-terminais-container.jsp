...
<html>
    ...
    <head>
        ...
        <title>GW Trans - Consulta de Terminais de Container</title>
        ...
        <link href="${homePath}/gwTrans/consultas/css/consulta-terminais-container.css?v=${random.nextInt()}" rel="stylesheet" type="text/css"/>
    ...
    <body>
        ...
        <div id="topo">
            <div id="logo">
                <h3>Consulta de Terminais de Container <img src="${homePath}/assets/img/trans_white.png"></h3>
            </div>
            <div id="actions">
                ...
                <ul>
                    <c:if test="${nivelUser >= 2}">
                        <li>
                            <div class="bt bt-cadastro"  onclick="javascript:checkSession(function(){cadastrarTerminalContainer();},false);">Novo cadastro</div>
                        </li>
                    </c:if>

                    <li>
                        <div class="bt bt-relatorio"  onclick="javascript:checkSession(function(){relatorioTerminalContainer();},false);">Relatório</div>
                    </li>
                </ul>
        ...
        <div id="sidebar" class="heightDoc">
            <div class="columnLeft" id="columnLeft">
                ...
                <div class="content">
                    <form action="ConsultaControlador?codTela=41" method="POST" id="formConsulta" name="formConsulta">
                        <div class="item_form">
            ...
            <input type="hidden" name="inp-auditoria" data-exclusao="true" data-rotina-auditoria="terminal_container">
        </div>
        ...
        <script defer src="${homePath}/gwTrans/consultas/js/consulta-terminais-container.js?v=${random.nextInt()}"></script>
