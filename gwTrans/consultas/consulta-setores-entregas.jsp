...
<html>
    ...
    <head>
        ...
        <title>GW Trans - Consulta de Setores de Entregas</title>
        ...
        <link href="${homePath}/gwTrans/consultas/css/consulta-setores-entregas.css?v=${random.nextInt()}" rel="stylesheet" type="text/css"/>
    ...
    <body>
        ...
        <div id="topo">
            <div id="logo">
                <h3>Consulta de Setores de Entregas <img src="${homePath}/assets/img/trans_white.png"></h3>
            </div>
            <div id="actions">
                ...
                <ul>
                    <c:if test="${nivelUser >= 3}">
                        <li>
                            <div class="bt bt-cadastro"  onclick="javascript:checkSession(function(){cadastrarSetoresEntregas();},false);">Novo cadastro</div>
                        </li>
                    </c:if>
                    <!--  comentário adicionado devido a esta tela não ter relatório.
                     <li>
                         <a href="javascript:checkSession(function(){relatorioTerminalContainer();},false);">Relatório</a>
                     </li> 
                    -->
                </ul>
        ...
        <div id="sidebar" class="heightDoc">
            <div class="columnLeft" id="columnLeft">
                ...
                <div class="content">
                    <form action="ConsultaControlador?codTela=45" method="POST" id="formConsulta" name="formConsulta">
                        <div class="item_form">
                        ...
                        <div id="filtros-adicionais-container" style="display: none;">
                            ...
                            <div class="item_form" style="margin-bottom: 10px;">
                                <select id="select-exceto-apenas-cidade" name="select-exceto-apenas-cidade">
                                    <option value="apenas">Apenas Setores da Cidade</option>
                                    <option value="exceto">Exceto Setores da Cidade</option>
                                </select>
            ...
            <input type="hidden" name="inp-auditoria" data-exclusao="true" data-rotina-auditoria="setor">
        </div>
        ...
        <script src="${homePath}/gwTrans/consultas/js/consulta-setores-entregas.js?v=${random.nextInt()}"></script>
