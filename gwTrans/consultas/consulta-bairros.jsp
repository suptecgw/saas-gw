...
<html>
    ...
    <head>
        ...
        <title>GW Trans - Consulta de Bairros</title>
        ...
        <link href="${homePath}/gwTrans/consultas/css/consulta-bairros.css?v=${random.nextInt()}" rel="stylesheet" type="text/css"/>
    ...
    <body>
        ...
        <div id="topo">
            <div id="logo">
                <h3>Consulta de Bairros <img src="${homePath}/assets/img/trans_white.png"></h3>
            </div>
            <div id="actions">
                    ...
                    <c:if test="${nivelUser >= 3}">
                        <li>
                            <span class="bt bt-cadastro" onclick="checkSession(function () {
                                        btnCadastrar('BairroControlador?acao=novoCadastro');
                                    }, false);">Novo Bairro</span>
                        </li>
                    </c:if>
                </ul>
        ...
        <div id="sidebar" class="heightDoc">
            <div class="columnLeft" id="columnLeft">
                ...
                <div class="content">
                    <form action="ConsultaControlador?codTela=65" method="POST" id="formConsulta" name="formConsulta">
                        <div class="item_form">
            ...
            <input type="hidden" name="inp-auditoria" data-exclusao="true" data-rotina-auditoria="bairro">
        </div>
        ...
        <script src="${homePath}/gwTrans/consultas/js/consulta-bairros.js?v=${random.nextInt()}"></script>
