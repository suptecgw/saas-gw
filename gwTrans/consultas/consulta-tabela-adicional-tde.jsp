...
<html>
    ...
    <head>
        ...
        <title>GW Trans - Consulta de Tabela Adicional TDE</title>
        ...
        <link href="${homePath}/gwTrans/consultas/css/consulta-tabela-adicional-tde.css?v=${random.nextInt()}" rel="stylesheet" type="text/css"/>
    ...
    <body>
        ...
        <div id="topo">
            <div id="logo">
                <h3>Consulta de Tabela Adicional TDE <img src="${homePath}/assets/img/trans_white.png"></h3>
            </div>
            <div id="actions">
                    ...
                    <c:if test="${nivelUser >= 2}">
                        <li>
                            <span class="bt bt-cadastro" onclick="checkSession(function () {
                                        btnCadastrar('CadastroControlador?codTela=78&modulo=cadastro');
                                    }, false);">Nova Tabela</span>
                        </li>
                    </c:if>
                </ul>
        ...
        <div id="sidebar" class="heightDoc">
            <div class="columnLeft" id="columnLeft">
                ...
                <div class="content">
                    <form action="ConsultaControlador?codTela=70" method="POST" id="formConsulta" name="formConsulta">
                        <div class="item_form">
                            ...
                            <div id="filtros-adicionais-container" style="display: none;">
                                ...
                                <div class="item_form" style="margin-bottom: 10px;">
                                    ...
                                    <div style="width: 70%;float: left;">
                                        <input class="input" type="text" id="inptGrupoCli" name="inptGrupoCli" readonly="true" placeholder="">
                                    </div>
                                    <div class="btns">
            ...
            <input type="hidden" name="inp-auditoria" data-exclusao="true" data-rotina-auditoria="tde">
        </div>
        ...
        <script type='text/javascript' lang="JavaScript">
            ...
            <c:if test="${filtroEscolhido != null}">
                                    ...
                                    setTimeout(function () {
                                        ...
                                        jQuery(jQuery('.localiza')[0]).html('<iframe id="localizarGrupoCliente" input="inptGrupoCli" name="localizarGrupoCliente" src="LocalizarControlador?acao=abrirLocalizar&idLocalizar=localizarGrupoCliente&tema=${tema}" frameborder="0" marginheight="0" marginwidth="0" scrolling="no" ></iframe>');
                                    }, 1);
        ...
        <script src="${homePath}/gwTrans/consultas/js/consulta-tabela-adicional-tde.js?v=${random.nextInt()}"></script>
