...
<html>
    ...
    <head>
        ...
        <title>GW Trans - Consulta de Tipos de Veículo</title>
        ...
        <link href="${homePath}/gwTrans/consultas/css/consulta-tipos-veiculo.css?v=${random.nextInt()}" rel="stylesheet" type="text/css"/>
        <script defer src="${homePath}/script/validarSessao.js?v=${random.nextInt()}" type="text/javascript"></script>
        <script defer>
            var codigoTela = 'T00053';
            var codigo_tela = 53;
            var idPreferencia = 0;
    ...
    <body>
        ...
        <div id="topo">
            <div id="logo">
                <h3>Consulta de Tipos de Veículo<img src="${homePath}/assets/img/trans_white.png"></h3>
            </div>
            <div id="actions">
                ...
                <ul>
                    <c:if test="${nivelUser >= 2}">
                        <li>
                            <span class="bt bt-cadastro" onclick="checkSession(function () {
                                        btnCadastrar('cadtipo_veiculos.jsp?acao=iniciar');
                    ...
                    <li>
                        <span class="bt bt-relatorio" onclick="checkSession(function () {
                                    abrirPopConsulta('./reltipoveiculo.jsp?acao=iniciar&modulo=webtrans');
        ...
        <div id="sidebar" class="heightDoc">
            <div class="columnLeft" id="columnLeft">
                ...
                <div class="content">
                    <form action="ConsultaControlador?codTela=53" method="POST" id="formConsulta" name="formConsulta">
                        <div class="item_form">
            ...
            <input type="hidden" name="inp-auditoria" data-exclusao="true" data-rotina-auditoria="tipo_veiculos">
        </div>
        ...
        <script src="${homePath}/gwTrans/consultas/js/consulta-tipos-veiculo.js?v=${random.nextInt()}"></script>
