<%-- 
    Document   : consulta-plano-custo
    Created on : 13/01/2017, 09:18:26
...
<html>
    ...
    <head>
        ...
        <title>GW Trans - Consulta de Plano de Custo</title>
        ...
        <link href="${homePath}/gwTrans/consultas/css/consulta-plano-custo.css?v=${random.nextInt()}" rel="stylesheet" type="text/css"/>
        <script defer src="${homePath}/script/validarSessao.js?v=${random.nextInt()}" type="text/javascript"></script>
        <script defer>
            var codigoTela = 'T00021';
            var codigo_tela = 21;
            var idPreferencia = 0;
    ...
    <body>
        ...
        <div id="topo">
            <div id="logo">
                <h3>Consulta de Plano de Custo<img src="${homePath}/assets/img/trans_white.png"></h3>
            </div>
            <div id="actions">
                ...
                <ul>
                    <c:if test="${nivelUser >= 2}">
                        <li>
                            <div class="bt bt-cadastro" onclick="javascript:checkSession(function(){cadastrarPlano();},false);">Novo Plano</div>
                        </li>
                    </c:if>

                    <li>
                        <div class="bt bt-relatorio"  onclick="javascript:checkSession(function(){relatorioPlano();},false);">Relatório</div>
                    </li>
                </ul>
        ...
        <div id="sidebar" class="heightDoc">
            <div class="columnLeft" id="columnLeft">
                ...
                <div class="content">
                    <form action="ConsultaControlador?codTela=21" method="POST" id="formConsulta" name="formConsulta">
                        <div class="item_form">
                        ...
                        <div class="item_form div-ordenacao">
                            ...
                            <div id="filtros-adicionais-container" style="display: none;">
                                ...
                                <div class="item_form" style="margin-bottom: 5px;">
                                    ...
                                    <label for="ambosTipos" class="radio" style="width: auto;margin-right: 5px;font-weight: normal;color: #fff;"><input type="radio" name="mostrarTipoPlano" value="0" id="ambosTipos" checked> Ambos</label>
                                    <label for="receitas" class="radio" style="width: auto;margin-right: 5px;font-weight: normal;color: #fff;"><input type="radio" name="mostrarTipoPlano" value="receitas" id="receitas"> Receitas</label>
                                    <label for="despesas" class="radio" style="width: auto;margin-right: 5px;font-weight: normal;color: #fff;"><input type="radio" name="mostrarTipoPlano" value="despesas" id="despesas"> Despesas</label>
                                </div>
                                <div class="item_form" style="margin-bottom: 10px;">
                                    <label for="ambastrans" class="radio" style="width: auto;margin-right: 5px;font-weight: normal;color: #fff;"><input type="radio" name="mostrarContasTrans" value="0" id="ambastrans" checked> Ambas</label>
                                    <label for="transitoria" class="radio" style="width: auto;margin-right: 5px;font-weight: normal;color: #fff;"><input type="radio" name="mostrarContasTrans" value="transitoria" id="transitoria"> Transitórias</label>
                                    <label for="naoTransitoria" class="radio" style="width: auto;margin-right: 5px;font-weight: normal;color: #fff;"><input type="radio" name="mostrarContasTrans" value="naoTransitoria" id="naoTransitoria"> Não Transitórias</label>
                                </div>
                                <div class="item_form" style="margin-bottom: 15px;">
                                    <label for="ambasprov" class="radio" style="width: auto;margin-right: 5px;font-weight: normal;color: #fff;"><input type="radio" name="mostrarContasProv" value="0" id="ambasprov" checked> Ambas</label>
                                    <label for="provisao" class="radio" style="width: auto;margin-right: 5px;font-weight: normal;color: #fff;"><input type="radio" name="mostrarContasProv" value="provisao" id="provisao"> C. Provisão</label>
                                    <label for="naoProvisao" class="radio" style="width: auto;margin-right: 5px;font-weight: normal;color: #fff;"><input type="radio" name="mostrarContasProv" value="naoProvisao" id="naoProvisao"> Não C. Provisão</label>
                                </div>
                                <div class="item_form" style="margin-bottom: 15px;">
                                    <label for="ambasaativo" class="radio" style="width: auto;margin-right: 5px;font-weight: normal;color: #fff;"><input type="radio" name="mostrarPlanosAtivos" value="0" id="ambasaativo" checked> Ambas</label>
                                    <label for="ativos" class="radio" style="width: auto;margin-right: 5px;font-weight: normal;color: #fff;"><input type="radio" name="mostrarPlanosAtivos" value="ativos" id="ativos"> Ativos</label>
                                    <label for="inativos" class="radio" style="width: auto;margin-right: 5px;font-weight: normal;color: #fff;"><input type="radio" name="mostrarPlanosAtivos" value="inativos" id="inativos"> Inativos</label>
                                </div>
                            </div>
                        </div>
            ...
            <input type="hidden" name="inp-auditoria" data-exclusao="true" data-rotina-auditoria="planocusto">
        </div>
...
<!--<script src="${homePath}/script/jquery-1.11.2.min.js" type="text/javascript"></script>-->
        ...
        <script src="${homePath}/gwTrans/consultas/js/consulta-plano-custo.js?v=${random.nextInt()}"></script>
            ...
            <c:if test="${pref != null}">
                ...
                <c:forEach var="filtros" items="${pref.filtros}" varStatus="filtrosStatus" >
                    <c:if test="${filtrosStatus.count == 1}">
                                    ...
                                    gerenciarRadioTipo('${filtros.colunaNome}', '${filtros.colunaValor}');
                                    gerenciarRadioTransitoria('${filtros.colunaNome}', '${filtros.colunaValor}');
                                    gerenciarRadioProvisao('${filtros.colunaNome}', '${filtros.colunaValor}');
