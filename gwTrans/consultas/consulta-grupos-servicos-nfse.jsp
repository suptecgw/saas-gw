...
<html>
    ...
    <head>
        ...
        <title>GW Trans - Consulta de Grupos de Serviços NFSe</title>
        ...
        <link href="${homePath}/gwTrans/consultas/css/consulta-grupos-servicos-nfse.css?v=${random.nextInt()}" rel="stylesheet" type="text/css"/>
        <script defer src="${homePath}/script/validarSessao.js?v=${random.nextInt()}" type="text/javascript"></script>
        <script defer>
            var codigoTela = 'T00050';
            var codigo_tela = 50;
            var idPreferencia = 0;
    ...
    <body>
        ...
        <div id="topo">
            <div id="logo">
                <h3>Consulta de Grupos de Serviços NFSe<img src="${homePath}/assets/img/trans_white.png"></h3>
            </div>
            <div id="actions">
                    ...
                    <c:if test="${nivelUser >= 3}">
                        <li>
                            <span class="bt bt-cadastro" onclick="checkSession(function () {
                                        btnCadastrar('GrupoServicoNfseControladador?acao=novoCadastro');
        ...
        <div id="sidebar" class="heightDoc">
            <div class="columnLeft" id="columnLeft">
                ...
                <div class="content">
                    <form action="ConsultaControlador?codTela=50" method="POST" id="formConsulta" name="formConsulta">
                        <div class="item_form">
            ...
            <input type="hidden" name="inp-auditoria" data-exclusao="true" data-rotina-auditoria="nfse_grupo_servico">
        </div>
        ...
        <script src="${homePath}/gwTrans/consultas/js/consulta-grupos-servicos-nfse.js?v=${random.nextInt()}"></script>
