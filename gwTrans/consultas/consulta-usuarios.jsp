...
<html>
    ...
    <head>
        ...
        <title>GW Trans - Consulta de Usuários</title>
        ...
        <link href="${homePath}/gwTrans/consultas/css/consulta-usuarios.css?v=${random.nextInt()}" rel="stylesheet" type="text/css"/>
    ...
    <body>
        ...
        <div id="topo">
            <div id="logo">
                <h3>Consulta de Usuários <img src="${homePath}/assets/img/trans_white.png"></h3>
            </div>
            <div id="actions">
                    ...
                    <c:if test="${nivelUser >= 3}">
                        <li>
                            <span class="bt bt-cadastro" onclick="checkSession(function () {
                                        btnCadastrar('UsuarioControlador?acao=novoCadastro');
                                    }, false);">Novo Usuário</span>
                        </li>
                    </c:if>

                    <li>
                        <span class="bt bt-relatorio" onclick="checkSession(function () {
                                    abrirPopConsulta('./relusuario.jsp?acao=iniciar&modulo=webtrans');
        ...
        <div id="sidebar" class="heightDoc">
            <div class="columnLeft" id="columnLeft">
                ...
                <div class="content">
                    <form action="ConsultaControlador?codTela=62" method="POST" id="formConsulta" name="formConsulta">
                        <div class="item_form">
                        ...
                        <div id="filtros-adicionais-container" style="display: none;">
                            ...
                            <div class="item_form" style="margin-bottom: 50px;margin-top: 10px;">
                                <select id="select-exceto-apenas-tipo-usuario" name="select-exceto-apenas-tipo-usuario">
                                    <option value="apenas">Apenas os Tipos</option>
                                    <option value="exceto">Exceto os Tipos</option>
                                </select>
                                <select id="select-tipo-usuario" name="select-tipo-usuario">
                                </select>
                            </div>
                            ...
                            <div class="item_form" style="margin-bottom: 10px;">
                                <select id="select-exceto-apenas-grupo-usuario" name="select-exceto-apenas-grupo-usuario">
                                    <option value="apenas">Apenas os grupos</option>
                                    <option value="exceto">Exceto os grupos</option>
                                </select>
                                <div style="width: 70%;float: left;">
                                    <input class="input" type="text" id="inptGrupoUsuario" name="inptGrupoUsuario" readonly="true" placeholder="">
                                </div>
                                <div class="btns">
                                    <a href="javascript:" onclick="checkSession(function () {
                                                removerValorInput('inptGrupoUsuario', false);
                                            }, false);" class="btnDelete" style="margin-top: 2px;"></a>
                                    <a href="javascript:checkSession(function(){controlador.acao('abrirLocalizar','localizarGrupoUsuario');},false);" class="btnMore" style="float: right !important;margin-right: 5px;"></a>
                                    <!--<img src="${homePath}/assets/img/pesquisar_por.jpg" class="img-visualizar">-->
                                </div>
                            </div>
                        </div>
            ...
            <input type="hidden" name="inp-auditoria" data-exclusao="true" data-rotina-auditoria="usuario">
        </div>
            ...
            <div id="footerTable">
                <div class="footerTableImpressao">
                    ...
                    <div class="footer02">
                        ...
                        <label for="impressaoP" class="radio" style="color: #888;"><input type="radio" name="formaImpressao" value="1" id="impressaoP" checked="">Imprimir PDF</label>
                        <label for="impressaoE" class="radio" style="color: #888;"><input type="radio" name="formaImpressao" value="2" id="impressaoE">Imprimir Excel</label>
                        <label for="impressaoW" class="radio" style="color: #888;"><input type="radio" name="formaImpressao" value="3" id="impressaoW">Imprimir Word</label>
                    </div>
                    <div class="footer03">
                        <div class="footer03-02">
                            <div class="bt bt-impressao" onclick="popRel();">Imprimir</div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <script src="${homePath}/gwTrans/consultas/js/consulta-usuarios.js?v=${random.nextInt()}"></script>
        ...
        <script defer type='text/javascript' lang="JavaScript">
            ...
            <c:if test="${pref != null}">
                ...
                <c:forEach var="filtros" items="${pref.filtros}" varStatus="filtrosStatus" >
                    <c:if test="${filtrosStatus.count == 1}">
                                    ...
                                    gerenciarTipoUsuario('${filtros.colunaNome}', '${filtros.colunaValor}', '${filtros.colunaCondicaoLocalizar}', '${filtros.descricao}');
                                    gerenciarInpFilial('${filtros.colunaNome}', '${filtros.colunaValor}', '${filtros.descricao}', '${filtros.colunaCondicaoLocalizar}');
                                    gerenciarInpGrupoUsuario('${filtros.colunaNome}', '${filtros.colunaValor}', '${filtros.descricao}', '${filtros.colunaCondicaoLocalizar}');
            ...
            <c:if test="${filtroEscolhido != null}">
                                    ...
                                    setTimeout(function () {
                                        ...
                                        jQuery(jQuery('.localiza')[1]).html('<iframe id="localizarGrupoUsuario" input="inptGrupoUsuario" name="localizarGrupoUsuario" src="LocalizarControlador?acao=abrirLocalizar&idLocalizar=localizarGrupoUsuario&tema=${tema}" frameborder="0" marginheight="0" marginwidth="0" scrolling="no" ></iframe>');
                                    }, 1);
