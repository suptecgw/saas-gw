<%-- 
    Document   : consulta-porto.jsp
    Created on : 25/01/2017, 09:59:01
...
<html>
    ...
    <head>
        ...
        <title>GW Trans - Consulta de Grupos de Usuários</title>
        ...
        <link href="${homePath}/gwTrans/consultas/css/consulta-grupos-usuarios.css?v=${random.nextInt()}" rel="stylesheet" type="text/css"/>
        <script defer src="${homePath}/script/validarSessao.js?v=${random.nextInt()}" type="text/javascript"></script>
        <script defer>
            var codigoTela = 'T00061';
            var codigo_tela = 61;
            var idPreferencia = 0;
    ...
    <body>
        ...
        <div id="topo">
            <div id="logo">
                <h3>Consulta de Grupos Usuários<img src="${homePath}/assets/img/trans_white.png"></h3>
            </div>
            <div id="actions">
                    ...
                    <c:if test="${nivelUser >= 3}">
                        <li>
                            <span class="bt bt-cadastro" onclick="checkSession(function () {
                                        btnCadastrar('GrupoUsuarioControlador?acao=novoCadastro');
                                    }, false);">Novo Grupo</span>
                        </li>
                    </c:if>

                    <li>
                        <span class="bt bt-relatorio" onclick="checkSession(function () {
                                    abrirPopConsulta('./relgrupousuario.jsp?acao=iniciar&modulo=webtrans');
        ...
        <div id="sidebar" class="heightDoc">
            <div class="columnLeft" id="columnLeft">
                ...
                <div class="content">
                    <form action="ConsultaControlador?codTela=61" method="POST" id="formConsulta" name="formConsulta">
                        <div class="item_form">
            ...
            <input type="hidden" name="inp-auditoria" data-exclusao="true" data-rotina-auditoria="grupo_usuarios">
        </div>
        ...
        <script src="${homePath}/gwTrans/consultas/js/consulta-grupos-usuarios.js?v=${random.nextInt()}"></script>
