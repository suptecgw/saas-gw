...
<script type="text/javascript" language="JavaScript" charset="Iso-8859-1">
    ...
    function abrirCadastro(){
        window.location = "FeriadoControlador?acao=novoCadastro&modulo=gwTrans";
    }          

    function excluir(id){
        if(confirm("Deseja excluir o Feriado?" )){
            if(confirm("Tem certeza?" )){
                window.open("FeriadoControlador?acao=excluir&modulo=gwTrans&idFeriado=" + id,
...
<html>
    ...
    <head>
        ...
        <title>Webtrans - Consulta de Feriados</title>
    ...
    <body onload="desativarBotoes(), setDefault()"  > 
        ...
        <table class="bordaFina" width="68%" align="center">
            <tr>
                <td width="82%" align="left"> <span class="style4">Consulta de Feriados</span></td>
                <td width="18%">
        ...
        <table class="bordaFina" width="68%" align="center">
            <tr>
                <form action="FeriadoControlador?acao=listar&modulo=gwTrans" id="formulario" name="formulario" method="post">
        ...
        <table width="68%" border="0" cellpadding="2" cellspacing="1" class="bordaFina" align="center">
            <tr>                
                ...
                <td class="tabela" width="5%" align="left">DIA</td>
                <td class="tabela" width="15%" align="left">MES</td>
                <td class="tabela" width="15%" align="left">ANO</td>
                <td class="tabela" width="5%" align="left"></td>
            </tr>
            <c:forEach var="feriado" varStatus="status" items="${listaFeriados}">             
                <tr class="${(status.count % 2 == 0 ? 'CelulaZebra1' : 'CelulaZebra2')}" >                    
                    
                    <td><a href="javascript: tryRequestToServer(function(){window.location='FeriadoControlador?acao=carregar&modulo=gwTrans&idFeriado=${feriado.id}';});" 
                           class="linkEditar">${feriado.descricao}</a></td>
                    <td>
                        ${feriado.dia}
                    </td>
                    <td>
                    ...
                    <td>
                        ${(feriado.ano == "" ? "todos os anos" :  feriado.ano)}
                    </td>
                    <td align="center">
                        <c:if test="${param.nivel >= 4}">
                            <a href="javascript: tryRequestToServer(function(){excluir('${feriado.id}');});"> <img class="imagemLink" src="img/lixo.png"/> </a>
                        </c:if>                        
                    </td>
        ...
        <table class="bordaFina" width="68%" align="center" >
            <tr class="CelulaZebra1">
                ...
                <form id="formularioAnt" name="formularioAnt" action="FeriadoControlador?acao=listar&modulo=gwTrans" method="post">
                ...
                <form id="formularioProx" name="formularioProx"  action="FeriadoControlador?acao=listar&modulo=gwTrans" method="post">
                    <td width="15%" align="center">
                        <input type="hidden" name="limiteResultados" value="<c:out value='${param.limiteResultados}'/>">
                        <input type="hidden" name="operadorConsulta" value="<c:out value='${param.operadorConsulta}'/>">
                        <input type="hidden" name="campoConsulta" value="<c:out value='${param.campoConsulta}'/>">
