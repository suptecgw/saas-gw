<%-- 
    ...
    Created on : 25/05/2016, 12:16:05
    Author     : Mateus
--%>
...
<head>
	...
	<title>GW Sistemas - Configurações</title>
...
<header role="banner" class="header-top">
	...
	<div class="start-secion-page-mobile">
		...
		<h1 class="mobile-title-page">Configurações</h1>
	...
	<div class="content-mobile">
		...
		<nav class="btn-menu-mobile">
                    <ul class="btn-menu-mobile-list-top">
                        ...
                        <% if (user != null && user.getAcesso("altconfig") > NivelAcessoUsuario.SEM_ACESSO.getNivel()) {%>
                            <li> <a class="openWindow" href="./config?acao=editar" id="configuracao_cadastro">Alterar Configurações</a></li>
                        <%} else if (user != null && !user.isIsOcultarMenuSemPermissao()) {%>
                            <li style=" cursor: pointer;" title="Você não tem privilégios suficientes para executar essa ação." class="showTitle">
                                 <a style="background-color: silver;color: black;" class="openWindow" href="" id="" onclick="javascript: semPrivilegio('<%= permissoes.get("altconfig")%>')">Alterar Configurações
                                </a>
                            </li>
                        <%}%>

                        <% if (user != null && user.getId() == 1) {%>
                            <li> <a class="openWindow" href="./ConfiguracaoTecnicaControlador?acao=carregar" id="configuracaoTecnica_cadastro">Alterar Configurações Técnicas </a>
                            </li>
                        <%}%>

                        <!--IMPRESSORAS MATRICIAIS-->
                        <% if (user != null && user.getAcesso("cadimpressora") > NivelAcessoUsuario.SEM_ACESSO.getNivel()) {%>
                            <li> <a class="openWindow" href="./consulta_impressora.jsp?acao=iniciar" id="impressoraMatricial_listar">Impressoras Matriciais 
                                    <% if (user != null && user.getAcesso("cadimpressora") > NivelAcessoUsuario.LER_ALTERAR.getNivel()) {%>
                                    <span id="impressoraMatricial_cadastro" class="more" data-href="./cadimpressora.jsp?acao=iniciar"></span>
                                    <%}%>
                                </a>
                            </li>
                        <%} else if (user != null && !user.isIsOcultarMenuSemPermissao()) {%>
                                <li style=" cursor: pointer;" title="Você não tem privilégios suficientes para executar essa ação." class="showTitle">
                                     <a style="background-color: silver;color: black;" class="openWindow" href="" id="" onclick="javascript: semPrivilegio('<%= permissoes.get("cadimpressora")%>')">Impressoras Matriciais
                                    </a>
                                </li>
                                <%}%>
                        <!--ALIQUOTA ICMS-->
                        <% if (user != null && user.getAcesso("altaliquota") > NivelAcessoUsuario.SEM_ACESSO.getNivel()) {%>
                        <li> <a class="openWindow" href="./UfIcmsControlador?acao=listar" id="aliquotaICMS_listar">Alterar Alíquota ICMS</a></li>
                        <%} else if (user != null && !user.isIsOcultarMenuSemPermissao()) {%>
                            <li style=" cursor: pointer;" title="Você não tem privilégios suficientes para executar essa ação." class="showTitle">
                                 <a style="background-color: silver;color: black;" class="openWindow" href="" id="" onclick="javascript: semPrivilegio('<%= permissoes.get("altaliquota")%>')">Alterar Alíquota ICMS
                                </a>
                            </li>
                        <%}%>
                        <!--PAUTA FISCAL DO ICMS-->
                        <% if (user != null && user.getAcesso("configpautafiscal") > NivelAcessoUsuario.SEM_ACESSO.getNivel()) {%>
                        <li> <a class="openWindow" href="./PautaFiscalControlador?acao=carregar" id="pautaFiscalICMS_listar">Alterar Pauta Fiscal de ICMS</a></li>
                        <%} else if (user != null && !user.isIsOcultarMenuSemPermissao()) {%>
                                <li style=" cursor: pointer;" title="Você não tem privilégios suficientes para executar essa ação." class="showTitle">
                                     <a style="background-color: silver;color: black;" class="openWindow" href="" id="" onclick="javascript: semPrivilegio('<%= permissoes.get("configpautafiscal")%>')">Alterar Pauta Fiscal de ICMS
                                    </a>
                                </li>
                                <%}%>
                        <!--TAXAS DE SEGURO-->
                        <% if (user != null && user.getAcesso("alttaxa") > NivelAcessoUsuario.SEM_ACESSO.getNivel()) {%>
                        <li> <a class="openWindow" href="./alterataxa?acao=editar" id="taxaSeguro_listar">Taxas de Seguro</a></li>
                        <%} else if (user != null && !user.isIsOcultarMenuSemPermissao()) {%>
                                <li style=" cursor: pointer;" title="Você não tem privilégios suficientes para executar essa ação." class="showTitle">
                                     <a style="background-color: silver;color: black;" class="openWindow" href="" id="" onclick="javascript: semPrivilegio('<%= permissoes.get("alttaxa")%>')">Taxas de Seguro
                                    </a>
                                </li>
                                <%}%>
                        <!--LAYOUT PARA EDI-->
                        <% if (user != null && user.getAcesso("cadlayoutedi") > NivelAcessoUsuario.SEM_ACESSO.getNivel()) {%>
                        <li> <a class="openWindow" href="./LayoutEDIControlador?acao=listar" id="layoutEdi_listar">Layout para EDI</a></li>
                        <%} else if (user != null && !user.isIsOcultarMenuSemPermissao()) {%>
                                <li style=" cursor: pointer;" title="Você não tem privilégios suficientes para executar essa ação." class="showTitle">
                                     <a style="background-color: silver;color: black;" class="openWindow" href="" id="" onclick="javascript: semPrivilegio('<%= permissoes.get("cadlayoutedi")%>')">Layout para EDI
                                    </a>
                                </li>
                                <%}%>

                        <li class="inside"> <a href="sub_configurar_emails.jsp">Configurar E-mails</a>
                        </li>
                        <!--FERIADOS-->
                        <% if (user != null && user.getAcesso("cadFeriado") > NivelAcessoUsuario.SEM_ACESSO.getNivel()) {%>
                        <li> <a class="openWindow" href="./FeriadoControlador?acao=listar" id="feriado_listar">Feriados</a></li>
                        <%} else if (user != null && !user.isIsOcultarMenuSemPermissao()) {%>
                                <li style=" cursor: pointer;" title="Você não tem privilégios suficientes para executar essa ação." class="showTitle">
                                     <a style="background-color: silver;color: black;" class="openWindow" href="" id="" onclick="javascript: semPrivilegio('<%= permissoes.get("cadFeriado")%>')">Feriados
                                    </a>
                                </li>
                                <%}%>
                        <!--CAIXA DE SAIDA-->
                        <% if (user != null && user.getAcesso("cadEmailsCaixaSaida") > NivelAcessoUsuario.SEM_ACESSO.getNivel()) {%>
                        <li> <a class="openWindow" href="./CaixaSaidaControlador?acao=listar" id="feriado_listar">Caixa de Saída</a></li>
                        <%} else if (user != null && !user.isIsOcultarMenuSemPermissao()) {%>
                                <li style=" cursor: pointer;" title="Você não tem privilégios suficientes para executar essa ação." class="showTitle">
                                     <a style="background-color: silver;color: black;" class="openWindow" href="" id="" onclick="javascript: semPrivilegio('<%= permissoes.get("cadEmailsCaixaSaida")%>')">Caixa de Saída
                                    </a>
                                </li>
                                <%}%>
                        <!--RELATORIO PERSONALIZADO-->
                        <% if (user != null && user.getAcesso("cadRelatorioPersonalizado") > NivelAcessoUsuario.SEM_ACESSO.getNivel()) {%>
                        <li> <a class="openWindow" href="./ReportBuilderControlador?acao=listar&modulo=webtrans" id="relatorioPersonalizado_listar">Relatório Personalizado</a></li>
                        <%} else if (user != null && !user.isIsOcultarMenuSemPermissao()) {%>
                                <li style=" cursor: pointer;" title="Você não tem privilégios suficientes para executar essa ação." class="showTitle">
                                     <a style="background-color: silver;color: black;" class="openWindow" href="" id="" onclick="javascript: semPrivilegio('<%= permissoes.get("cadRelatorioPersonalizado")%>')">Relatório Personalizado
                                    </a>
                                </li>
                                <%}%>

                        <li><a class="openWindow" href="./CaixaPostalSeguradoraControlador?acao=listar" id="caixaPostalSeguradora_listar">Caixa Postal AT&amp;M  <span id="caixaPostalSeguradora_cadastro" class="more" data-href="./CaixaPostalSeguradoraControlador?acao=novoCadastro"></span></a></li>
                    </ul>
		</nav>
