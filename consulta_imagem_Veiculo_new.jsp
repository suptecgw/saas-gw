...
<html>
    <head>
        ...
        <title>GW Trans - Visualização de Documentos de Veículo</title>
        ...
        <script>
            var idVeiculo = '${param.idveiculo}';
            var placa = '${param.placa}';
            ...
            function visualizaImagem(imagem) {
                window.open("${homePath}/ImagemControlador?acao=imgpdf&imagem=" + imagem.trim() + "&idveiculo=" + idVeiculo, "visualizaImagem", 'top=80,left=70,height=500,width=800,resizable=yes,status=1,scrollbars=1');
            }
            ...
            function createFormAndSubmit() {
                ...
                var action = '${homePath}/ImagemControlador?acao=cadastrar&idveiculo=' + idVeiculo + '&placa=' + placa + '&descricao=' + descricao;
            ...
            function excluir() {
                location.replace("${homePath}/ImagemControlador?acao=excluir&idImagem=" + getValueCheckMarcados() + "&idveiculo=" + idVeiculo + "&placa" + placa);
            }
    ...
    <body>
        <div class="gw-img-geral">
            <div class="gw-img-geral-A">
                ...
                <div class="gw-img-geral-A-titulo">Visualização de Documentos de Veículo</div>
                                    ...
                                    <td>
                                        <c:choose>
                                            <c:when test="${imagem.getExtensao().trim().equalsIgnoreCase('jpg') || imagem.getExtensao().trim().equalsIgnoreCase('png') || imagem.getExtensao().trim().equalsIgnoreCase('gif')}">
                                                <img width="50px" height="50px" src="${homePath}/img/veiculo/${imagem.getVeiculo().getIdveiculo()}_${imagem.getId()}.${imagem.getExtensao().trim()}" class="imagemLink2"
                                                     onclick="visualizaImagem('/img/veiculo/${imagem.getVeiculo().getIdveiculo()}_${imagem.getId()}.${imagem.getExtensao().trim()}');" style="cursor: pointer" alt="Documento">
                                            </c:when>
