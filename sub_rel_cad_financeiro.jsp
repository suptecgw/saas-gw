<%-- 
    Document   : sub_rel_cad_financeiro
    Created on : 25/05/2016, 11:24:37
    Author     : Mateus
--%>
	...
	<div class="content-mobile">
		...
		<nav class="btn-menu-mobile">
			...
			<!--HISTORICOS-->
                        ...
                        <li><a class="openWindow" href="./relhistorico.jsp?acao=iniciar&modulo=webtrans" id="historico_relatorio">Históricos </a></li>
                        ...
                        <li><a class="openWindow" href="./relfornecedores.jsp?acao=iniciar&modulo=webtrans" id="fornecedor_relatorio">Fornecedores </a></li>
                            <%} else if (user != null && !user.isIsOcultarMenuSemPermissao()) {%>
                        <li style=" cursor: pointer;" title="Você não tem privilégios suficientes para executar essa ação." class="showTitle"> <a style="background-color: silver;color: black;" class="openWindow" href="" id="" onclick="javascript: semPrivilegio('<%= permissoes.get("cadfornecedor")%>')" >
                                Fornecedores 
                            </a>
                        </li>
                        <%}%>

                        <!--GRUPO CLIENTE/FORNECEDORES-->
                        <% if (user != null && user.getAcesso("cadgrupo_cli_for") > NivelAcessoUsuario.SEM_ACESSO.getNivel()) {%>
                        <li><a class="openWindow" href="./relgrupoclifor.jsp?acao=iniciar&modulo=webtrans" id="grupoClienteFornc_relatorio">Grupo Cliente/Fornecedores </a></li>
                            <%} else if (user != null && !user.isIsOcultarMenuSemPermissao()) {%>
                        <li style=" cursor: pointer;" title="Você não tem privilégios suficientes para executar essa ação." class="showTitle">
                             <a style="background-color: silver;color: black;" class="openWindow" href="" id="" onclick="javascript: semPrivilegio('<%= permissoes.get("cadgrupo_cli_for")%>')">Grupo Cliente/Fornecedores  
                            </a>
                        </li>
                        <%}%>
                        ...
                        <li><a class="openWindow" href="./relcontabancaria.jsp?acao=iniciar&modulo=webtrans" id="contaBancaria_relatorio">Conta Bancária/Caixa</a></li>
                            <%} else if (user != null && !user.isIsOcultarMenuSemPermissao()) {%>
                        <li style=" cursor: pointer;" title="Você não tem privilégios suficientes para executar essa ação." class="showTitle">
                             <a style="background-color: silver;color: black;" class="openWindow" href="" id="" onclick="javascript: semPrivilegio('<%= permissoes.get("cadconta")%>')">Conta Bancária/Caixa  
                            </a>
                        </li>
                        <%}%>
                        ...
                        <li><a class="openWindow" href="./relplanocusto.jsp?acao=iniciar&modulo=webtrans" id="planoCusto_relatorio">Plano Centro de Custo</a></li>
                            <%} else if (user != null && !user.isIsOcultarMenuSemPermissao()) {%>
                        <li style=" cursor: pointer;" title="Você não tem privilégios suficientes para executar essa ação." class="showTitle">
                             <a style="background-color: silver;color: black;" class="openWindow" href="" id="" onclick="javascript: semPrivilegio('<%= permissoes.get("cadplanocusto")%>')">Plano Centro de Custo  
                            </a>
                        </li>
                        <%}%>
                        ...
                        <li><a class="openWindow" href="./relunidadecusto.jsp?acao=iniciar&modulo=webtrans" id="unidadeCusto_relatorio">Unidades de Custo</a></li>
                            <%} else if (user != null && !user.isIsOcultarMenuSemPermissao()) {%>
                        <li style=" cursor: pointer;" title="Você não tem privilégios suficientes para executar essa ação." class="showTitle">
                             <a style="background-color: silver;color: black;" class="openWindow" href="" id="" onclick="javascript: semPrivilegio('<%= permissoes.get("cadundcusto")%>')">Unidades de Custo  
                            </a>
                        </li>
                        <%}%>
                        ...
                        <li><a class="openWindow" href="./relrateio.jsp?acao=iniciar&modulo=webtrans" id="rateio_relatorio">Rateio</a></li>
                            <%} else if (user != null && !user.isIsOcultarMenuSemPermissao()) {%>
                        <li style=" cursor: pointer;" title="Você não tem privilégios suficientes para executar essa ação." class="showTitle">
                             <a style="background-color: silver;color: black;" class="openWindow" href="" id="" onclick="javascript: semPrivilegio('<%= permissoes.get("cadrateio")%>')">Rateio  
                            </a>
                        </li>
                        <%}%>
                        <!--PLANO DE CONTAS-->
                        <% if (user != null && user.getAcesso("cadplanocontas") > NivelAcessoUsuario.SEM_ACESSO.getNivel()) {%>
                        <li><a class="openWindow" href="./relplanoconta.jsp?acao=iniciar&modulo=webtrans" id="planoContas_relatorio">Plano de Contas</a></li>
                            <%} else if (user != null && !user.isIsOcultarMenuSemPermissao()) {%>
                        <li style=" cursor: pointer;" title="Você não tem privilégios suficientes para executar essa ação." class="showTitle">
                             <a style="background-color: silver;color: black;" class="openWindow" href="" id="" onclick="javascript: semPrivilegio('<%= permissoes.get("cadplanocontas")%>')">Plano de Contas  
                            </a>
                        </li>
                        <%}%>
                        <!--ESPECIES (DESPESAS)-->
                        <% if (user != null && user.getAcesso("cadespecie") > NivelAcessoUsuario.SEM_ACESSO.getNivel()) {%>
                        <li><a class="openWindow" href="./relespecie.jsp?acao=iniciar&modulo=webtrans" id="especies_relatorio">Espécies (Despesas)</a></li>
                            <%} else if (user != null && !user.isIsOcultarMenuSemPermissao()) {%>
                        <li style=" cursor: pointer;" title="Você não tem privilégios suficientes para executar essa ação." class="showTitle">
                             <a style="background-color: silver;color: black;" class="openWindow" href="" id="" onclick="javascript: semPrivilegio('<%= permissoes.get("cadespecie")%>')">Espécies (Despesas)  
                            </a>
                        </li>
                        <%}%>
                        <!--FORMA DE PAGAMENTO-->
                        <% if (user != null && user.getAcesso("cadformapagamento") > NivelAcessoUsuario.SEM_ACESSO.getNivel()) {%>
                        <li><a class="openWindow" href="./relformapagamento.jsp?acao=iniciar&modulo=webtrans" id="formaPagamento_relatorio">Forma de Pagamento</a></li>        
                            <%} else if (user != null && !user.isIsOcultarMenuSemPermissao()) {%>
                        <li style=" cursor: pointer;" title="Você não tem privilégios suficientes para executar essa ação." class="showTitle">
                             <a style="background-color: silver;color: black;" class="openWindow" href="" id="" onclick="javascript: semPrivilegio('<%= permissoes.get("cadformapagamento")%>')">Forma de Pagamento  
                            </a>
                        </li>
                        <%}%>
                    </ul>
