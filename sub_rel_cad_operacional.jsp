<%-- 
    Document   : sub_rel_cad_operacional
    Created on : 25/05/2016, 11:30:29
    Author     : Mateus
--%>
...
<head>
	...
	<title>GW Sistemas - Relatórios Operacional</title>
...
<header role="banner" class="header-top">
	...
	<div class="start-secion-page-mobile">
		...
		<a href="sub_cadastrais.jsp" class="voltar"><</a>
		<h1 class="mobile-title-page">Relatórios Operacional</h1>
	...
	<div class="content-mobile">
		...
		<nav class="btn-menu-mobile">
			...
			<!--CLIENTE-->
                        ...
                        <li><a class="openWindow" href="./relcliente.jsp?acao=iniciar&modulo=webtrans" id="cliente_relatorio">Clientes</a></li>        
                        ...
                        <li style=" cursor: pointer;" title="Você não tem privilégios suficientes para executar essa ação." class="showTitle">
                             <a style="background-color: silver;color: black;" class="openWindow" href="" id="" onclick="javascript: semPrivilegio('<%= permissoes.get("cadcliente")%>')">Clientes  
                            </a>
                        </li>
                        <%}%>

                        <li class="inside"><a href="sub_rel_cad_tabela_de_precos.jsp">Tabela de preços</a>
                        </li>        
                        <li class="inside"><a href="sub_rel_cad_servicos.jsp">Serviços</a>
                        </li>   

                        <!--MOTORISTA-->
                        <% if (user != null && user.getAcesso("cadmotorista") > NivelAcessoUsuario.SEM_ACESSO.getNivel()) {%>
                        <li><a class="openWindow" href="./relmotoristas.jsp?acao=iniciar&modulo=webtrans" id="motorista_relatorio">Motoristas</a></li>        
                            <%} else if (user != null && !user.isIsOcultarMenuSemPermissao()) {%>
                        <li style=" cursor: pointer;" title="Você não tem privilégios suficientes para executar essa ação." class="showTitle">
                             <a style="background-color: silver;color: black;" class="openWindow" href="" id="" onclick="javascript: semPrivilegio('<%= permissoes.get("cadmotorista")%>')"> Motoristas
                            </a>
                        </li>
                        <%}%>
                        ...
                        <li><a class="openWindow" href="./relfuncaomaritimo.jsp?acao=iniciar&modulo=webtrans" id="funcaoMaritimo_relatorio">Funções (Marítimo)</a></li>        
                            <%} else if (user != null && !user.isIsOcultarMenuSemPermissao()) {%>
                        <li style=" cursor: pointer;" title="Você não tem privilégios suficientes para executar essa ação." class="showTitle">
                             <a style="background-color: silver;color: black;" class="openWindow" href="" id="" onclick="javascript: semPrivilegio('<%= permissoes.get("cadfuncoes")%>')"> Funções (Marítimo)
                            </a>
                        </li>
                        <%}%>

                        <li class="inside"><a href="sub_rel_cad_veiculos.jsp">Veiculos</a>
                        </li>

                        <!--ORIGEM DE CAPTAÇÃO-->
                        <% if (user != null && user.getAcesso("cadorigemcaptacao") >= NivelAcessoUsuario.LER.getNivel()) {%>
                        <li><a class="openWindow" href="./relorigemcaptacao.jsp?acao=iniciar&modulo=webtrans" id="origemCaptacao_relatorio">Origem de Captação</a></li>        
                            <%} else if (user != null && !user.isIsOcultarMenuSemPermissao()) {%>
                        <li style=" cursor: pointer;" title="Você não tem privilégios suficientes para executar essa ação." class="showTitle">
                             <a style="background-color: silver;color: black;" class="openWindow" href="" id="" onclick="javascript: semPrivilegio('<%= permissoes.get("cadorigemcaptacao")%>')"> Origem de Captação
                            </a>
                        </li>
                        <%}%>
                        <li class="inside"><a href="sub_rel_cad_container.jsp">Container</a>
                        </li>
                        <!--ROTAS-->
                        <% if (user != null && user.getAcesso("cadrota") >= NivelAcessoUsuario.LER.getNivel()) {%>
                        <li><a class="openWindow" href="./relrotas.jsp?acao=iniciar&modulo=webtrans" id="rota_relatorio">Rotas</a></li>
                            <%} else if (user != null && !user.isIsOcultarMenuSemPermissao()) {%>
                        <li style=" cursor: pointer;" title="Você não tem privilégios suficientes para executar essa ação." class="showTitle">
                             <a style="background-color: silver;color: black;" class="openWindow" href="" id="" onclick="javascript: semPrivilegio('<%= permissoes.get("cadrota")%>')">Rotas
                            </a>
                        </li>
                        <%}%>

                        <li class="inside"><a href="sub_rel_cad_produtos.jsp">Produtos</a>
                        </li>        
                        <!--OBSERVAÇÕES-->
                        <% if (user != null && user.getAcesso("cadobservacao") > NivelAcessoUsuario.SEM_ACESSO.getNivel()) {%>
                        <li><a class="openWindow" href="./relobservacao.jsp?acao=iniciar&modulo=webtrans" id="observacao_relatorio">Observações</a></li>        
                            <%} else if (user != null && !user.isIsOcultarMenuSemPermissao()) {%>
                        <li style=" cursor: pointer;" title="Você não tem privilégios suficientes para executar essa ação." class="showTitle">
                             <a style="background-color: silver;color: black;" class="openWindow" href="" id="" onclick="javascript: semPrivilegio('<%= permissoes.get("cadobservacao")%>')">Observações
                            </a>
                        </li>
                        <%}%>
                        <!--CFOPS-->
                        <% if (user != null && user.getAcesso("cadcfop") > NivelAcessoUsuario.SEM_ACESSO.getNivel()) {%>
                        <li><a class="openWindow" href="./relcfop.jsp?acao=iniciar&modulo=webtrans" id="cfop_relatorio">CFOPs</a></li>        
                            <%} else if (user != null && !user.isIsOcultarMenuSemPermissao()) {%>
                        <li style=" cursor: pointer;" title="Você não tem privilégios suficientes para executar essa ação." class="showTitle">
                             <a style="background-color: silver;color: black;" class="openWindow" href="" id="" onclick="javascript: semPrivilegio('<%= permissoes.get("cadcfop")%>')">CFOPs
                            </a>
                        </li>
                        <%}%>
                        <!--OCORRENCIAS(EDI)-->
                        <% if (user != null && user.getAcesso("cadocorrencia") > NivelAcessoUsuario.SEM_ACESSO.getNivel()) {%>
                        <li><a class="openWindow" href="./relocorrencia.jsp?acao=iniciar&modulo=webtrans" id="ocorrenciaEdi_relatorio">Ocorrências (EDI)</a></li>        
                            <%} else if (user != null && !user.isIsOcultarMenuSemPermissao()) {%>
                        <li style=" cursor: pointer;" title="Você não tem privilégios suficientes para executar essa ação." class="showTitle">
                             <a style="background-color: silver;color: black;" class="openWindow" href="" id="" onclick="javascript: semPrivilegio('<%= permissoes.get("cadocorrencia")%>')">Ocorrências (EDI)
                            </a>
                        </li>
                        <%}%>
                        <!--TIPOS DE PALLETS-->
                        <% if (user != null && user.getAcesso("cadtipopallettransp") > NivelAcessoUsuario.SEM_ACESSO.getNivel()) {%>
                        <li><a class="openWindow" href="./reltipopallet.jsp?acao=iniciar&modulo=webtrans" id="tipoPallet_relatorio">Tipos de Pallets</a></li>        
                            <%} else if (user != null && !user.isIsOcultarMenuSemPermissao()) {%>
                        <li style=" cursor: pointer;" title="Você não tem privilégios suficientes para executar essa ação." class="showTitle">
                             <a style="background-color: silver;color: black;" class="openWindow" href="" id="" onclick="javascript: semPrivilegio('<%= permissoes.get("cadtipopallettransp")%>')">Tipos de Pallets
                            </a>
                        </li>
                        <%}%>
                        <!--AEROPORTOS-->
                        <% if (user != null && user.getAcesso("cadaeroporto") > NivelAcessoUsuario.SEM_ACESSO.getNivel()) {%>
                        <li><a class="openWindow" href="./relaeroporto.jsp?acao=iniciar&modulo=webtrans" id="aeroporto_relatorio">Aeroportos</a></li>        
                            <%} else if (user != null && !user.isIsOcultarMenuSemPermissao()) {%>
                        <li style=" cursor: pointer;" title="Você não tem privilégios suficientes para executar essa ação." class="showTitle">
                             <a style="background-color: silver;color: black;" class="openWindow" href="" id="" onclick="javascript: semPrivilegio('<%= permissoes.get("cadaeroporto")%>')">Aeroportos
                            </a>
                        </li>
                        <%}%>
                        <!--PORTOS-->
                        <% if (user != null && user.getAcesso("cadporto") > NivelAcessoUsuario.SEM_ACESSO.getNivel()) {%>
                        <li><a class="openWindow" href="./relporto.jsp?acao=iniciar&modulo=webtrans" id="porto_relatorio">Portos</a></li>        
                            <%} else if (user != null && !user.isIsOcultarMenuSemPermissao()) {%>
                        <li style=" cursor: pointer;" title="Você não tem privilégios suficientes para executar essa ação." class="showTitle">
                             <a style="background-color: silver;color: black;" class="openWindow" href="" id="" onclick="javascript: semPrivilegio('<%= permissoes.get("cadporto")%>')">Portos
                            </a>
                        </li>
                        <%}%>
                    </ul>
