<%-- 
    Document   : sub_rel_operacional
    Created on : 25/05/2016, 12:08:05
    Author     : Mateus
--%>
...
<header role="banner" class="header-top">
	...
	<div class="content-mobile">
		...
		<nav class="btn-menu-mobile">
			...
			<!--ORÇAMENTO-->
                     <% if (user != null && user.getAcesso("relcoleta") > NivelAcessoUsuario.SEM_ACESSO.getNivel()) {%>
                    <li><a class="openWindow" href="./relorcamento.jsp?acao=iniciar&modulo=webtrans" id="orcamento_relatorio">Orçamento</a></li>
                    ...
                    <li style=" cursor: pointer;" title="Você não tem privilégios suficientes para executar essa ação." class="showTitle">
                         <a style="background-color: silver;color: black;" class="openWindow" href="" id="" onclick="javascript: semPrivilegio('<%= permissoes.get("relcoleta")%>')">Orçamento
                        </a>
                    </li>
                    <%}%>
                    <!--COLETAS-->
                     <% if (user != null && user.getAcesso("relcoleta") > NivelAcessoUsuario.SEM_ACESSO.getNivel()) {%>
                    <li><a class="openWindow" href="./relcoleta.jsp?acao=iniciar&modulo=webtrans" id="coleta_relatorio">Coletas</a></li>
                    <%} else if (user != null && !user.isIsOcultarMenuSemPermissao()) {%>
                    <li style=" cursor: pointer;" title="Você não tem privilégios suficientes para executar essa ação." class="showTitle">
                         <a style="background-color: silver;color: black;" class="openWindow" href="" id="" onclick="javascript: semPrivilegio('<%= permissoes.get("relcoleta")%>')">Coletas
                        </a>
                    </li>
                    <%}%>
                    <!--NOTAS FISCAIS DE CLIENTES-->
                     <% if (user != null && user.getAcesso("relnfcliente") > NivelAcessoUsuario.SEM_ACESSO.getNivel()) {%>
                    <li><a class="openWindow" href="./relnotafiscalcliente.jsp?acao=iniciar&modulo=webtrans" id="notaFiscal_relatorio">Notas Fiscais de Clientes</a></li>
                    <%} else if (user != null && !user.isIsOcultarMenuSemPermissao()) {%>
                    <li style=" cursor: pointer;" title="Você não tem privilégios suficientes para executar essa ação." class="showTitle">
                         <a style="background-color: silver;color: black;" class="openWindow" href="" id="" onclick="javascript: semPrivilegio('<%= permissoes.get("relnfcliente")%>')">Notas Fiscais de Clientes
                        </a>
                    </li>
                    <%}%>
                    <!--CTRCS/ NOTAS DE SERVIÇO-->
                     <% if (user != null && user.getAcesso("relctrc") > NivelAcessoUsuario.SEM_ACESSO.getNivel()) {%>
                    <li><a class="openWindow" href="./relctrc?acao=iniciar&modulo=webtrans" id="notaServico_relatorio">CTRCs / Notas de Serviço</a></li>
                    <%} else if (user != null && !user.isIsOcultarMenuSemPermissao()) {%>
                    <li style=" cursor: pointer;" title="Você não tem privilégios suficientes para executar essa ação." class="showTitle">
                         <a style="background-color: silver;color: black;" class="openWindow" href="" id="" onclick="javascript: semPrivilegio('<%= permissoes.get("relctrc")%>')">CTRCs / Notas de Serviço
                        </a>
                    </li>
                    <%}%>
                    <!--MANIFESTO-->
                     <% if (user != null && user.getAcesso("relmanifesto") > NivelAcessoUsuario.SEM_ACESSO.getNivel()) {%>
                    <li><a class="openWindow" href="./relmanifesto.jsp?acao=iniciar&modulo=webtrans" id="manifesto_relatorio">Manifesto</a></li>
                    <%} else if (user != null && !user.isIsOcultarMenuSemPermissao()) {%>
                    <li style=" cursor: pointer;" title="Você não tem privilégios suficientes para executar essa ação." class="showTitle">
                         <a style="background-color: silver;color: black;" class="openWindow" href="" id="" onclick="javascript: semPrivilegio('<%= permissoes.get("relmanifesto")%>')">Manifesto
                        </a>
                    </li>
                    <%}%>
                    <!--CONTRATO DE FRETES-->
                     <% if (user != null && user.getAcesso("relcartafrete") > NivelAcessoUsuario.SEM_ACESSO.getNivel()) {%>
                    <li><a class="openWindow" href="./relcartafrete.jsp?acao=iniciar&modulo=webtrans" id="contratoFrete_relatorio">Contrato de Fretes</a></li>
                    <%} else if (user != null && !user.isIsOcultarMenuSemPermissao()) {%>
                    <li style=" cursor: pointer;" title="Você não tem privilégios suficientes para executar essa ação." class="showTitle">
                         <a style="background-color: silver;color: black;" class="openWindow" href="" id="" onclick="javascript: semPrivilegio('<%= permissoes.get("relcartafrete")%>')">Contrato de Fretes
                        </a>
                    </li>
                    <%}%>
                    <!--VIAGENS-->
                     <% if (user != null && user.getAcesso("relviagenstrans") > NivelAcessoUsuario.SEM_ACESSO.getNivel()) {%>
                    <li><a class="openWindow" href="./relviagens.jsp?acao=iniciar&modulo=webtrans" id="advViagem_relatorio">Viagens</a></li>
                    <%} else if (user != null && !user.isIsOcultarMenuSemPermissao()) {%>
                    <li style=" cursor: pointer;" title="Você não tem privilégios suficientes para executar essa ação." class="showTitle">
                         <a style="background-color: silver;color: black;" class="openWindow" href="" id="" onclick="javascript: semPrivilegio('<%= permissoes.get("relviagenstrans")%>')">Viagens
                        </a>
                    </li>
                    <%}%>
                    <!--TOMANEIO-->
                     <% if (user != null && user.getAcesso("relromaneio") > NivelAcessoUsuario.SEM_ACESSO.getNivel()) {%>
                    <li><a class="openWindow" href="./relromaneio.jsp?acao=iniciar&modulo=webtrans" id="romaneio_relatorio">Romaneio</a></li>
                    <%} else if (user != null && !user.isIsOcultarMenuSemPermissao()) {%>
                    <li style=" cursor: pointer;" title="Você não tem privilégios suficientes para executar essa ação." class="showTitle">
                         <a style="background-color: silver;color: black;" class="openWindow" href="" id="" onclick="javascript: semPrivilegio('<%= permissoes.get("relromaneio")%>')">Romaneio
                        </a>
                    </li>
                    <%}%>
                    <!--PALLETS-->
                     <% if (user != null && user.getAcesso("lancamentomovimentacaopallets") > NivelAcessoUsuario.SEM_ACESSO.getNivel()) {%>
                    <li><a class="openWindow" href="./ContratoFreteControlador?acao=iniciarImprimirMovimentacaoPallets&modulo=webtrans" id="movimentacaoPallet_relatorio">Pallets</a></li>
                    <%} else if (user != null && !user.isIsOcultarMenuSemPermissao()) {%>
                    <li style=" cursor: pointer;" title="Você não tem privilégios suficientes para executar essa ação." class="showTitle">
                         <a style="background-color: silver;color: black;" class="openWindow" href="" id="" onclick="javascript: semPrivilegio('<%= permissoes.get("lancamentomovimentacaopallets")%>')">Pallets
                        </a>
                    </li>
                    <%}%>
                    </ul>
