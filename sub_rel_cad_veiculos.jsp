<%-- 
    Document   : sub_rel_cad_veiculos
    Created on : 25/05/2016, 11:52:11
    Author     : Mateus
--%>
...
<head>
	...
	<title>GW Sistemas - Relatórios Veículos</title>
...
<header role="banner" class="header-top">
	...
	<div class="start-secion-page-mobile">
		...
		<h1 class="mobile-title-page">Relatórios Veículos</h1>
		...
		<nav class="btn-menu-mobile">
                    <ul class="btn-menu-mobile-list-top">
                           <!--VEICULOS-->
                                ...
                                <li><a class="openWindow" href="./relveiculos.jsp?acao=iniciar&modulo=webtrans" id="veiculo_relatorio"> Veículos</a></li>
                                ...
                                <li style=" cursor: pointer;" title="Você não tem privilégios suficientes para executar essa ação." class="showTitle">
                                     <a style="background-color: silver;color: black;" class="openWindow" href="" id="" onclick="javascript: semPrivilegio('<%= permissoes.get("cadveiculo")%>')"> Veículos
                                    </a>
                                </li>
                                <%}%>
                                <!--MARCAS-->
                                <% if (user != null && user.getAcesso("cadmarca") > NivelAcessoUsuario.SEM_ACESSO.getNivel()) {%>
                                <li><a class="openWindow" href="./relmarca.jsp?acao=iniciar&modulo=webtrans" id="marca_relatorio"> Marcas</a></li>
                                    <%} else if (user != null && !user.isIsOcultarMenuSemPermissao()) {%>
                                <li style=" cursor: pointer;" title="Você não tem privilégios suficientes para executar essa ação." class="showTitle">
                                     <a style="background-color: silver;color: black;" class="openWindow" href="" id="" onclick="javascript: semPrivilegio('<%= permissoes.get("cadmarca")%>')"> Marcas
                                    </a>
                                </li>
                                <%}%>
                                <!--TIPO DE VEICULOS-->
                                <% if (user != null && user.getAcesso("cadtipoveiculo") > NivelAcessoUsuario.SEM_ACESSO.getNivel()) {%>
                                <li><a class="openWindow" href="./reltipoveiculo.jsp?acao=iniciar&modulo=webtrans" id="tipoVeiculo_relatorio"> Tipo de Veículos</a></li>
                                    <%} else if (user != null && !user.isIsOcultarMenuSemPermissao()) {%>
                                <li style=" cursor: pointer;" title="Você não tem privilégios suficientes para executar essa ação." class="showTitle">
                                     <a style="background-color: silver;color: black;" class="openWindow" href="" id="" onclick="javascript: semPrivilegio('<%= permissoes.get("cadtipoveiculo")%>')"> Tipo de Veículos
                                    </a>
                                </li>
                                <%}%>
                    </ul>
