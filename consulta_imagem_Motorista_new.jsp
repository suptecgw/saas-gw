...
<html>
    <head>
        ...
        <title>GW Trans - Visualização de Documentos de Motorista</title>
        ...
        <script>
            ...
            function createFormAndSubmit() {
                ...
                var action = '${homePath}/ImagemControlador?acao=cadastrar&idmotorista=' + idmotorista + '&nome=' + nome + '&cpf=' + cpf + '&isFoto=false&descricao=' + descricao;
    ...
    <body>
        <div class="gw-img-geral">
            <div class="gw-img-geral-A">
                ...
                <div class="gw-img-geral-A-titulo">Visualização de Documentos de Motorista</div>
                                            ...
                                            <td>
                                                <c:choose>
                                                    <c:when test="${imagem.getExtensao().trim().equalsIgnoreCase('jpg') || imagem.getExtensao().trim().equalsIgnoreCase('png') || imagem.getExtensao().trim().equalsIgnoreCase('gif')}">
                                                        <img width="50px" height="50px" src="${homePath}/img/motorista/${imagem.getMotoristaId()}_${imagem.getId()}.${imagem.getExtensao().trim()}" class="imagemLink2"
                                                             onclick="visualizaImagem('/img/motorista/${imagem.getMotoristaId()}_${imagem.getId()}.${imagem.getExtensao().trim()}');" style="cursor: pointer" alt="Documento">
                                                    </c:when>
