<%-- 
    Document   : ajuda
    Created on : 25/05/2016, 12:22:02
    Author     : Mateus
--%>
...
<header role="banner" class="header-top">
	...
	<div class="start-secion-page-mobile">
		...
		<h1 class="mobile-title-page">Ajuda</h1>
	...
	<div class="content-mobile">
		...
		<nav class="btn-menu-mobile">
                    <ul class="btn-menu-mobile-list-top">
                        <li class="inside"><a href="sub_novidade_versao.jsp">Novidades da Versão</a>
                        <li class="inside"><a href="sub_downloads.jsp">Downloads</a>
                        <li><a href="#" id="obterAjuda_">Obter Ajuda</a></li>
                        <li><a class="openWindow" href="./licenca.jsp" id="licenca_verificar">Licença...</a></li>
                    </ul>
		</nav>
