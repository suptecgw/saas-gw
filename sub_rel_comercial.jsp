<%-- 
    Document   : sub_rel_comercial
    Created on : 25/05/2016, 12:11:48
    Author     : Mateus
--%>
...
<head>
	...
	<title>GW Sistemas - Relatórios Comercial</title>
...
<header role="banner" class="header-top">
	...
	<div class="start-secion-page-mobile">
		...
		<h1 class="mobile-title-page">Relatórios Comercial</h1>
	...
	<div class="content-mobile">
		...
		<nav class="btn-menu-mobile">
                    <ul class="btn-menu-mobile-list-top">
                        <!--ANALISE DE VENDAS-->
                        <% if (user != null && user.getAcesso("relanalisevendasvendedor") > NivelAcessoUsuario.SEM_ACESSO.getNivel()) {%>
                        <li><a class="openWindow" href="./relanalisevendasvendedor.jsp" id="analiseVenda_relatorio">Ánalise de Vendas</a></li>
                        ...
                        <li style=" cursor: pointer;" title="Você não tem privilégios suficientes para executar essa ação." class="showTitle">
                             <a style="background-color: silver;color: black;" class="openWindow" href="" id="" onclick="javascript: semPrivilegio('<%= permissoes.get("relanalisevendasvendedor")%>')">Ánalise de Vendas
                            </a>
                        </li>
                        <%}%>
                    </ul>
