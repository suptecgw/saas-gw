<%-- 
    Document   : sub_rel_gerencial
    Created on : 25/05/2016, 12:09:39
    Author     : Mateus
--%>
...
<head>
	...
	<title>GW Sistemas - Relatórios Gerencial</title>
...
<header role="banner" class="header-top">
	...
	<div class="start-secion-page-mobile">
		...
		<h1 class="mobile-title-page">Relatórios Gerencial</h1>
	...
	<div class="content-mobile">
		...
		<nav class="btn-menu-mobile">
			...
			<!--ANALISE POR P. DE CUSTO-->
                        <% if (user != null && user.getAcesso("reldespesas") > NivelAcessoUsuario.SEM_ACESSO.getNivel()) {%>
                        <li><a class="openWindow" href="./relapropdespesa" id="analisePlanoCusto_relatorio">Análise por P. de Custo</a></li>
                        ...
                        <li style=" cursor: pointer;" title="Você não tem privilégios suficientes para executar essa ação." class="showTitle">
                             <a style="background-color: silver;color: black;" class="openWindow" href="" id="" onclick="javascript: semPrivilegio('<%= permissoes.get("reldespesas")%>')">Análise por P. de Custo
                            </a>
                        </li>
                        <%}%>
                        <!--ANALISE DE ORCAMENTACAO-->
                        <% if (user != null && user.getAcesso("relanaliseorcamentofinan") > NivelAcessoUsuario.SEM_ACESSO.getNivel()) {%>
                        <li><a class="openWindow" href="./OrcamentacaoControlador?acao=novoRelatorio" id="analiseReceita_relatorio">Análise de orçamentação</a></li>
                        <%} else if (user != null && !user.isIsOcultarMenuSemPermissao()) {%>
                        <li style=" cursor: pointer;" title="Você não tem privilégios suficientes para executar essa ação." class="showTitle">
                             <a style="background-color: silver;color: black;" class="openWindow" href="" id="" onclick="javascript: semPrivilegio('<%= permissoes.get("relanaliseorcamentofinan")%>')">Análise de orçamentação
                            </a>
                        </li>
                        <%}%>
                        <!--ANALISE DE RECEITAS-->
                        <% if (user != null && user.getAcesso("relanalisevenda") > NivelAcessoUsuario.SEM_ACESSO.getNivel()) {%>
                        <li><a class="openWindow" href="./relanalisevendas.jsp" id="analiseReceita_relatorio">Análise de Receitas</a></li>
                        <%} else if (user != null && !user.isIsOcultarMenuSemPermissao()) {%>
                        <li style=" cursor: pointer;" title="Você não tem privilégios suficientes para executar essa ação." class="showTitle">
                             <a style="background-color: silver;color: black;" class="openWindow" href="" id="" onclick="javascript: semPrivilegio('<%= permissoes.get("relanalisevenda")%>')">Análise de Receitas
                            </a>
                        </li>
                        <%}%>
                        <!--ANALISE DE ENTREGA-->
                        <% if (user != null && user.getAcesso("relanaliseentrega") > NivelAcessoUsuario.SEM_ACESSO.getNivel()) {%>
                        <li><a class="openWindow" href="./relanaliseentrega.jsp" id="analiseEntrega_relatorio">Análise de Entrega</a></li>
                        <%} else if (user != null && !user.isIsOcultarMenuSemPermissao()) {%>
                        <li style=" cursor: pointer;" title="Você não tem privilégios suficientes para executar essa ação." class="showTitle">
                             <a style="background-color: silver;color: black;" class="openWindow" href="" id="" onclick="javascript: semPrivilegio('<%= permissoes.get("relanaliseentrega")%>')">Análise de Entrega
                            </a>
                        </li>
                        <%}%>
                        <!--FLUXO DE CAIXA-->
                        <% if (user != null && user.getAcesso("relfluxocaixa") > NivelAcessoUsuario.SEM_ACESSO.getNivel()) {%>
                        <li><a class="openWindow" href="./relfluxocaixa.jsp" id="fluxoCaixa_Relatorio">Fluxo de Caixa</a></li>
                        <%} else if (user != null && !user.isIsOcultarMenuSemPermissao()) {%>
                        <li style=" cursor: pointer;" title="Você não tem privilégios suficientes para executar essa ação." class="showTitle">
                             <a style="background-color: silver;color: black;" class="openWindow" href="" id="" onclick="javascript: semPrivilegio('<%= permissoes.get("relfluxocaixa")%>')">Fluxo de Caixa
                            </a>
                        </li>
                        <%}%>
                    </ul>
