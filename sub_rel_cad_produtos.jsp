<%-- 
    Document   : sub_rel_cad_produtos
    Created on : 25/05/2016, 11:56:52
    Author     : Mateus
--%>
...
<head>
	...
	<title>GW Sistemas - Relatórios Produtos</title>
...
<header role="banner" class="header-top">
	...
	<div class="start-secion-page-mobile">
		...
		<h1 class="mobile-title-page">Relatórios Produtos</h1>
	...
	<div class="content-mobile">
		...
		<nav class="btn-menu-mobile">
                    <ul class="btn-menu-mobile-list-top">
                        ...
                        <li><a class="openWindow" href="./relprodutos.jsp?acao=iniciar&modulo=webtrans" id="produto_relatorio">Produtos</a></li>
                        ...
                        <li style=" cursor: pointer;" title="Você não tem privilégios suficientes para executar essa ação." class="showTitle">
                             <a style="background-color: silver;color: black;" class="openWindow" href="" id="" onclick="javascript: semPrivilegio('<%= permissoes.get("cadprodutotrans")%>')">Produtos
                            </a>
                        </li>
                        <%}%>
                        <!--UNIDADES DE MEDIDA-->
                        <% if (user != null && user.getAcesso("cadundtrans") > NivelAcessoUsuario.SEM_ACESSO.getNivel()) {%>
                        <li><a class="openWindow" href="./relunidademedida.jsp?acao=iniciar&modulo=webtrans" id="unidadeMedida_relatorio">Unidades de Medida</a></li>
                            <%} else if (user != null && !user.isIsOcultarMenuSemPermissao()) {%>
                        <li style=" cursor: pointer;" title="Você não tem privilégios suficientes para executar essa ação." class="showTitle">
                             <a style="background-color: silver;color: black;" class="openWindow" href="" id="" onclick="javascript: semPrivilegio('<%= permissoes.get("cadundtrans")%>')">Unidades de Medida
                            </a>
                        </li>
                        <%}%>
                        <!--EMBALAGEM-->
                        <% if (user != null && user.getAcesso("cadEmbalagem") > NivelAcessoUsuario.SEM_ACESSO.getNivel()) {%>
                        <li><a class="openWindow" href="./relembalagem.jsp?acao=iniciar&modulo=webtrans" id="embalagem_relatorio">Embalagem</a></li>
                            <%} else if (user != null && !user.isIsOcultarMenuSemPermissao()) {%>
                        <li style=" cursor: pointer;" title="Você não tem privilégios suficientes para executar essa ação." class="showTitle">
                             <a style="background-color: silver;color: black;" class="openWindow" href="" id="" onclick="javascript: semPrivilegio('<%= permissoes.get("cadEmbalagem")%>')">Embalagem
                            </a>
                        </li>
                        <%}%>
                    </ul>
