<%-- 
    Document   : sub_rel_cad_tabela_de_precos
    Created on : 25/05/2016, 11:35:22
    Author     : Mateus
--%>
...
<head>
	...
	<title>GW Sistemas - Relatórios Tabela de Preços</title>
...
<header role="banner" class="header-top">
	...
	<div class="start-secion-page-mobile">
		...
		<a href="sub_rel_cad_operacional.jsp" class="voltar"><</a>
		<h1 class="mobile-title-page">Relatórios Tabela de Preços</h1>
	...
	<div class="content-mobile">
		...
		<nav class="btn-menu-mobile">
			...
			<!--TABELA DE PREÇO-->
                        ...
                        <li> <a class="openWindow" href="./reltabelapreco.jsp?acao=iniciar&modulo=webtrans" id="tabelaPreco_relatorio"> Tabela de Preços</a></li>
                        ...
                        <li style=" cursor: pointer;" title="Você não tem privilégios suficientes para executar essa ação." class="showTitle">
                             <a style="background-color: silver;color: black;" class="openWindow" href="" id="" onclick="javascript: semPrivilegio('<%= permissoes.get("cadtabelacliente")%>')">Tabela de Preços  
                            </a>
                        </li>
                        <%}%>
                        <!--AREAS / CIDADES-->
                        <% if (user != null && user.getAcesso("cadarea") > NivelAcessoUsuario.SEM_ACESSO.getNivel()) {%>
                        <li> <a class="openWindow" href="./relareas.jsp?acao=iniciar&modulo=webtrans" id="area_relatorio"> Áreas / Cidades</a></li>
                            <%} else if (user != null && !user.isIsOcultarMenuSemPermissao()) {%>
                        <li style=" cursor: pointer;" title="Você não tem privilégios suficientes para executar essa ação." class="showTitle">
                             <a style="background-color: silver;color: black;" class="openWindow" href="" id="" onclick="javascript: semPrivilegio('<%= permissoes.get("cadarea")%>')"> Áreas / Cidades 
                            </a>
                        </li>
                        <%}%>
                        ...
                        <li> <a class="openWindow" href="./reltipoproduto.jsp?acao=iniciar&modulo=webtrans" id="tipoProdutoOperacao_relatorio"> Tipo de Produto</a></li>
                            <%} else if (user != null && !user.isIsOcultarMenuSemPermissao()) {%>
                        <li style=" cursor: pointer;" title="Você não tem privilégios suficientes para executar essa ação." class="showTitle">
                             <a style="background-color: silver;color: black;" class="openWindow" href="" id="" onclick="javascript: semPrivilegio('<%= permissoes.get("cadtipoproduto")%>')">Tipo de Produto 
                            </a>
                        </li>
                        <%}%>
                        ...
                        <li> <a class="openWindow" href="./relfaixapeso.jsp?acao=iniciar&modulo=webtrans" id="faixaPeso_relatorio"> Faixas de Peso</a></li>
                            <%} else if (user != null && !user.isIsOcultarMenuSemPermissao()) {%>
                        <li style=" cursor: pointer;" title="Você não tem privilégios suficientes para executar essa ação." class="showTitle">
                             <a style="background-color: silver;color: black;" class="openWindow" href="" id="" onclick="javascript: semPrivilegio('<%= permissoes.get("cadfaixa")%>')"> Faixas de Peso
                            </a>
                        </li>
                        <%}%>
                    </ul>
