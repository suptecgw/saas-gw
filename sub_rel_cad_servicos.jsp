<%-- 
    Document   : sub_rel_cad_servicos
    Created on : 25/05/2016, 11:46:22
    Author     : Mateus
--%>
...
<head>
	...
	<title>GW Sistemas - Relatórios Serviços</title>
...
<header role="banner" class="header-top">
	...
	<div class="start-secion-page-mobile">
		...
		<h1 class="mobile-title-page">Relatórios Serviços</h1>
	...
	<div class="content-mobile">
		...
		<nav class="btn-menu-mobile">
                    <ul class="btn-menu-mobile-list-top">
                            ...
                            <li><a class="openWindow"  href="./relservico.jsp?acao=iniciar&modulo=webtrans" id="servico_relatorio">Serviços</a></li>
                            ...
                            <li style=" cursor: pointer;" title="Você não tem privilégios suficientes para executar essa ação." class="showTitle">
                                 <a style="background-color: silver;color: black;" class="openWindow" href="" id="" onclick="javascript: semPrivilegio('<%= permissoes.get("cadtipo_servico")%>')"> Serviços
                                </a>
                            </li>
                            <%}%>
