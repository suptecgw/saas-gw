<%-- 
    Document   : sub_rel_cad_container
    Created on : 25/05/2016, 11:54:37
    Author     : Mateus
--%>
...
<head>
	...
	<title>GW Sistemas - Relatórios Container</title>
...
<header role="banner" class="header-top">
	...
	<div class="start-secion-page-mobile">
		...
		<h1 class="mobile-title-page">Relatórios Container</h1>
	...
	<div class="content-mobile">
		...
		<nav class="btn-menu-mobile">
                    <ul class="btn-menu-mobile-list-top">
                        ...
                        <li><a class="openWindow" href="./relnavio.jsp?acao=iniciar&modulo=webtrans" id="navio_relatorio">Navios</a></li>
                        ...
                        <li style=" cursor: pointer;" title="Você não tem privilégios suficientes para executar essa ação." class="showTitle">
                             <a style="background-color: silver;color: black;" class="openWindow" href="" id="" onclick="javascript: semPrivilegio('<%= permissoes.get("cadnavio")%>')"> Navios
                            </a>
                        </li>
                        <%}%>
                        ...
                        <li><a class="openWindow" href="./relterminal.jsp?acao=iniciar&modulo=webtrans" id="terminal_relatorio">Terminal</a></li>
                            <%} else if (user != null && !user.isIsOcultarMenuSemPermissao()) {%>
                        <li style=" cursor: pointer;" title="Você não tem privilégios suficientes para executar essa ação." class="showTitle">
                             <a style="background-color: silver;color: black;" class="openWindow" href="" id="" onclick="javascript: semPrivilegio('<%= permissoes.get("cadterminal")%>')"> Terminal
                            </a>
                        </li>
                        <%}%>
                        ...
                        <li><a class="openWindow" href="./reltipocontainer.jsp?acao=iniciar&modulo=webtrans" id="tipoContainer_relatorio">Tipo de Container</a></li>
                            <%} else if (user != null && !user.isIsOcultarMenuSemPermissao()) {%>
                        <li style=" cursor: pointer;" title="Você não tem privilégios suficientes para executar essa ação." class="showTitle">
                             <a style="background-color: silver;color: black;" class="openWindow" href="" id="" onclick="javascript: semPrivilegio('<%= permissoes.get("cadtipocontainer")%>')">Tipo de Container
                            </a>
                        </li>
                        <%}%>
                    </ul>
